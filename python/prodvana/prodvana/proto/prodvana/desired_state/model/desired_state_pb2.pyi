...
class RuntimeExtensionDebugDetails(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    class _StatusEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[RuntimeExtensionDebugDetails._Status.ValueType], builtins.type):  # noqa: F821
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        UNKNOWN: RuntimeExtensionDebugDetails._Status.ValueType  # 0
        CONVERGED: RuntimeExtensionDebugDetails._Status.ValueType  # 1
        FAILED: RuntimeExtensionDebugDetails._Status.ValueType  # 2

    class Status(_Status, metaclass=_StatusEnumTypeWrapper): ...
    UNKNOWN: RuntimeExtensionDebugDetails.Status.ValueType  # 0
    CONVERGED: RuntimeExtensionDebugDetails.Status.ValueType  # 1
    FAILED: RuntimeExtensionDebugDetails.Status.ValueType  # 2

    SYSTEM_MESSAGE_FIELD_NUMBER: builtins.int
    DEBUG_MESSAGE_BLOB_ID_FIELD_NUMBER: builtins.int
    STATUS_FIELD_NUMBER: builtins.int
    STARTED_TIMESTAMP_FIELD_NUMBER: builtins.int
    COMPLETED_TIMESTAMP_FIELD_NUMBER: builtins.int
    VERSION_FIELD_NUMBER: builtins.int
    ...
    debug_message_blob_id: builtins.str
    """blob id to the debug message from user process"""
    status: global___RuntimeExtensionDebugDetails.Status.ValueType
    @property
    def started_timestamp(self) -> google.protobuf.timestamp_pb2.Timestamp:
    ...
    def HasField(self, field_name: typing_extensions.Literal["completed_timestamp", b"completed_timestamp", "started_timestamp", b"started_timestamp"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["completed_timestamp", b"completed_timestamp", "debug_message_blob_id", b"debug_message_blob_id", "started_timestamp", b"started_timestamp", "status", b"status", "system_message", b"system_message", "version", b"version"]) -> None: ...

global___RuntimeExtensionDebugDetails = RuntimeExtensionDebugDetails

class RuntimeExtensionDebugOutput(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    DEBUG_DETAILS_FIELD_NUMBER: builtins.int
    @property
    def debug_details(self) -> global___RuntimeExtensionDebugDetails: ...
    def __init__(
        self,
        *,
        debug_details: global___RuntimeExtensionDebugDetails | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["debug_details", b"debug_details"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["debug_details", b"debug_details"]) -> None: ...

global___RuntimeExtensionDebugOutput = RuntimeExtensionDebugOutput
...
class RuntimeObject(google.protobuf.message.Message):
    ...
    class RuntimeExtension(google.protobuf.message.Message):
        ...
        DEBUG_INTERVAL_FIELD_NUMBER: builtins.int
        SERVICE_ID_FIELD_NUMBER: builtins.int
        RELEASE_CHANNEL_ID_FIELD_NUMBER: builtins.int
        ...
        DEBUG_RETRY_POLICY_FIELD_NUMBER: builtins.int
        ...
        @property
        def debug(self) -> prodvana.proto.prodvana.environment.clusters_pb2.CompiledExtensionCommand: ...
        @property
        ...
        @property
        def debug_interval(self) -> google.protobuf.duration_pb2.Duration: ...
        service_id: builtins.str
        release_channel_id: builtins.str
        @property
        ...
        @property
        def debug_output(self) -> global___RuntimeExtensionDebugOutput: ...
        @property
        ...
        @property
        def debug_retry_policy(self) -> prodvana.proto.prodvana.environment.clusters_pb2.RetryPolicy: ...
        @property
        ...
        def __init__(
            ...
            *,
            ...
            debug: prodvana.proto.prodvana.environment.clusters_pb2.CompiledExtensionCommand | None = ...,
            ...
            debug_interval: google.protobuf.duration_pb2.Duration | None = ...,
            service_id: builtins.str = ...,
            release_channel_id: builtins.str = ...,
            ...
            debug_output: global___RuntimeExtensionDebugOutput | None = ...,
            ...
            debug_retry_policy: prodvana.proto.prodvana.environment.clusters_pb2.RetryPolicy | None = ...,
            apply_retryable_exit_codes: collections.abc.Iterable[builtins.int] | None = ...,
        ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["apply", b"apply", "apply_output", b"apply_output", "apply_retry_policy", b"apply_retry_policy", "debug", b"debug", "debug_interval", b"debug_interval", "debug_output", b"debug_output", "debug_retry_policy", b"debug_retry_policy", "fetch", b"fetch", "fetch_interval", b"fetch_interval", "fetch_output", b"fetch_output", "fetch_retry_policy", b"fetch_retry_policy", "fetch_steady_state_interval", b"fetch_steady_state_interval"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["apply", b"apply", "apply_output", b"apply_output", "apply_retry_policy", b"apply_retry_policy", "apply_retryable_exit_codes", b"apply_retryable_exit_codes", "debug", b"debug", "debug_interval", b"debug_interval", "debug_output", b"debug_output", "debug_retry_policy", b"debug_retry_policy", "fetch", b"fetch", "fetch_interval", b"fetch_interval", "fetch_output", b"fetch_output", "fetch_retry_policy", b"fetch_retry_policy", "fetch_steady_state_interval", b"fetch_steady_state_interval", "parameter_values", b"parameter_values", "parameters", b"parameters", "release_channel_id", b"release_channel_id", "service_id", b"service_id", "type", b"type"]) -> None: ...
