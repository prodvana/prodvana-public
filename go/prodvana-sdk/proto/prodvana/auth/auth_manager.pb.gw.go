...
var (
	filter_AuthSessionManager_Logout_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)

func request_AuthSessionManager_Logout_0(ctx context.Context, marshaler runtime.Marshaler, client AuthSessionManagerClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_AuthSessionManager_Logout_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func local_request_AuthSessionManager_Logout_0(ctx context.Context, marshaler runtime.Marshaler, server AuthSessionManagerServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq LogoutReq
	var metadata runtime.ServerMetadata
...
func request_ApiTokenManager_CreateOrgApiToken2_0(ctx context.Context, marshaler runtime.Marshaler, client ApiTokenManagerClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CreateOrgApiTokenReq
	var metadata runtime.ServerMetadata
	...
	msg, err := client.CreateOrgApiToken2(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_ApiTokenManager_CreateOrgApiToken2_0(ctx context.Context, marshaler runtime.Marshaler, server ApiTokenManagerServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CreateOrgApiTokenReq
	var metadata runtime.ServerMetadata
	...
	msg, err := server.CreateOrgApiToken2(ctx, &protoReq)
	return msg, metadata, err

}

func request_ApiTokenManager_DeleteOrgApiToken_0(ctx context.Context, marshaler runtime.Marshaler, client ApiTokenManagerClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq DeleteOrgApiTokenReq
	var metadata runtime.ServerMetadata
	...
	msg, err := client.DeleteOrgApiToken(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_ApiTokenManager_DeleteOrgApiToken_0(ctx context.Context, marshaler runtime.Marshaler, server ApiTokenManagerServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq DeleteOrgApiTokenReq
	var metadata runtime.ServerMetadata
	...
	msg, err := server.DeleteOrgApiToken(ctx, &protoReq)
	return msg, metadata, err

}

func request_ApiTokenManager_ListOrgApiTokens_0(ctx context.Context, marshaler runtime.Marshaler, client ApiTokenManagerClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ListOrgApiTokensReq
	var metadata runtime.ServerMetadata

	msg, err := client.ListOrgApiTokens(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_ApiTokenManager_ListOrgApiTokens_0(ctx context.Context, marshaler runtime.Marshaler, server ApiTokenManagerServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ListOrgApiTokensReq
	var metadata runtime.ServerMetadata

	msg, err := server.ListOrgApiTokens(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterAuthSessionManagerHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AuthSessionManagerServer) error {
	...
	mux.Handle("POST", pattern_AuthSessionManager_Logout_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/prodvana.auth.AuthSessionManager/Logout", runtime.WithHTTPPathPattern("/v1/auth/session/logout"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_AuthSessionManager_Logout_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_AuthSessionManager_Logout_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterApiTokenManagerHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ApiTokenManagerServer) error {
	...
	mux.Handle("POST", pattern_ApiTokenManager_CreateOrgApiToken2_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/prodvana.auth.ApiTokenManager/CreateOrgApiToken2", runtime.WithHTTPPathPattern("/v1/auth/api/org_tokens/create"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ApiTokenManager_CreateOrgApiToken2_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_ApiTokenManager_CreateOrgApiToken2_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("DELETE", pattern_ApiTokenManager_DeleteOrgApiToken_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/prodvana.auth.ApiTokenManager/DeleteOrgApiToken", runtime.WithHTTPPathPattern("/v1/auth/api/org_tokens/{name=*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ApiTokenManager_DeleteOrgApiToken_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_ApiTokenManager_DeleteOrgApiToken_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("GET", pattern_ApiTokenManager_ListOrgApiTokens_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/prodvana.auth.ApiTokenManager/ListOrgApiTokens", runtime.WithHTTPPathPattern("/v1/auth/api/org_tokens"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ApiTokenManager_ListOrgApiTokens_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_ApiTokenManager_ListOrgApiTokens_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterAuthSessionManagerHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AuthSessionManagerClient) error {
	...
	mux.Handle("POST", pattern_AuthSessionManager_Logout_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/prodvana.auth.AuthSessionManager/Logout", runtime.WithHTTPPathPattern("/v1/auth/session/logout"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_AuthSessionManager_Logout_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_AuthSessionManager_Logout_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "auth", "session", "logout"}, ""))
)

var (
	forward_AuthSessionManager_Check_0 = runtime.ForwardResponseMessage

	forward_AuthSessionManager_Logout_0 = runtime.ForwardResponseMessage
)
...
func RegisterApiTokenManagerHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ApiTokenManagerClient) error {
	...
	mux.Handle("POST", pattern_ApiTokenManager_CreateOrgApiToken2_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/prodvana.auth.ApiTokenManager/CreateOrgApiToken2", runtime.WithHTTPPathPattern("/v1/auth/api/org_tokens/create"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ApiTokenManager_CreateOrgApiToken2_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("DELETE", pattern_ApiTokenManager_DeleteOrgApiToken_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/prodvana.auth.ApiTokenManager/DeleteOrgApiToken", runtime.WithHTTPPathPattern("/v1/auth/api/org_tokens/{name=*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ApiTokenManager_DeleteOrgApiToken_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_ApiTokenManager_ListOrgApiTokens_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/prodvana.auth.ApiTokenManager/ListOrgApiTokens", runtime.WithHTTPPathPattern("/v1/auth/api/org_tokens"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ApiTokenManager_ListOrgApiTokens_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_ApiTokenManager_CreateOrgApiToken2_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"v1", "auth", "api", "org_tokens", "create"}, ""))

	pattern_ApiTokenManager_DeleteOrgApiToken_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"v1", "auth", "api", "org_tokens", "name"}, ""))

	pattern_ApiTokenManager_ListOrgApiTokens_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "auth", "api", "org_tokens"}, ""))
)

var (
	forward_ApiTokenManager_CreateOrgApiToken_0 = runtime.ForwardResponseMessage

	forward_ApiTokenManager_CreateOrgApiToken2_0 = runtime.ForwardResponseMessage

	forward_ApiTokenManager_DeleteOrgApiToken_0 = runtime.ForwardResponseMessage

	forward_ApiTokenManager_ListOrgApiTokens_0 = runtime.ForwardResponseMessage
)
