...
func (m *PerReleaseChannelConfig) validate(all bool) error {
	...
	case *PerReleaseChannelConfig_AwsEcs:
		if v == nil {
			err := PerReleaseChannelConfigValidationError{
				field:  "ConfigOneof",
				reason: "oneof value cannot be a typed-nil",
	...
	case *PerReleaseChannelConfig_Fly:
		if v == nil {
			err := PerReleaseChannelConfigValidationError{
				field:  "ConfigOneof",
				reason: "oneof value cannot be a typed-nil",
		...
		if all {
			switch v := interface{}(m.GetFly()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, PerReleaseChannelConfigValidationError{
						field:  "Fly",
		...
		} else if v, ok := interface{}(m.GetFly()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return PerReleaseChannelConfigValidationError{
					field:  "Fly",
					reason: "embedded message failed validation",
	...
	case *PerReleaseChannelConfig_Terraform:
		if v == nil {
			err := PerReleaseChannelConfigValidationError{
				field:  "ConfigOneof",
				reason: "oneof value cannot be a typed-nil",
	...
	case *PerReleaseChannelConfig_Pulumi:
		if v == nil {
			err := PerReleaseChannelConfigValidationError{
				field:  "ConfigOneof",
				reason: "oneof value cannot be a typed-nil",
		...
		if all {
			switch v := interface{}(m.GetPulumi()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, PerReleaseChannelConfigValidationError{
						field:  "Pulumi",
		...
		} else if v, ok := interface{}(m.GetPulumi()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return PerReleaseChannelConfigValidationError{
					field:  "Pulumi",
					reason: "embedded message failed validation",
...
func (m *AwsEcsConfig) validate(all bool) error {
	...
	} else if v, ok := interface{}(m.GetTaskDefinition()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
	...
	if all {
		switch v := interface{}(m.GetServiceDefinition()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, AwsEcsConfigValidationError{
	...
	} else if v, ok := interface{}(m.GetServiceDefinition()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return AwsEcsConfigValidationError{
				field:  "ServiceDefinition",
				reason: "embedded message failed validation",
...
func (m *TerraformConfig) validate(all bool) error {
	...
	if utf8.RuneCountInString(m.GetImage()) < 1 {
		err := TerraformConfigValidationError{
			field:  "Image",
			reason: "value length must be at least 1 runes",
		}
		if !all {
	...
	// no validation rules for PvnWrapperPath

	// no validation rules for ShellPath
...
// Validate checks the field values on PulumiConfig with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
...
// ValidateAll checks the field values on PulumiConfig with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in PulumiConfigMultiError, or
// nil if none found.
func (m *PulumiConfig) ValidateAll() error {
	return m.validate(true)
}

func (m *PulumiConfig) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if utf8.RuneCountInString(m.GetImage()) < 1 {
		err := PulumiConfigValidationError{
			field:  "Image",
			reason: "value length must be at least 1 runes",
		}
		if !all {
	...
	if utf8.RuneCountInString(m.GetStack()) < 1 {
		err := PulumiConfigValidationError{
			field:  "Stack",
			reason: "value length must be at least 1 runes",
		}
	...
	if len(errors) > 0 {
		return PulumiConfigMultiError(errors)
	}

	return nil
}

// PulumiConfigMultiError is an error wrapping multiple validation errors
// returned by PulumiConfig.ValidateAll() if the designated constraints aren't met.
...
// AllErrors returns a list of validation violation errors.
func (m PulumiConfigMultiError) AllErrors() []error { return m }

// PulumiConfigValidationError is the validation error returned by
// PulumiConfig.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e PulumiConfigValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e PulumiConfigValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e PulumiConfigValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e PulumiConfigValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e PulumiConfigValidationError) ErrorName() string { return "PulumiConfigValidationError" }

// Error satisfies the builtin error interface
func (e PulumiConfigValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = PulumiConfigValidationError{}
...
func (m *CompiledServiceInstanceConfig) validate(all bool) error {
	...
	case *CompiledServiceInstanceConfig_AwsEcs:
		if v == nil {
			err := CompiledServiceInstanceConfigValidationError{
				field:  "ConfigOneof",
				reason: "oneof value cannot be a typed-nil",
	...
	case *CompiledServiceInstanceConfig_Fly:
		if v == nil {
			err := CompiledServiceInstanceConfigValidationError{
				field:  "ConfigOneof",
				reason: "oneof value cannot be a typed-nil",
	...
	case *CompiledServiceInstanceConfig_Terraform:
		if v == nil {
			err := CompiledServiceInstanceConfigValidationError{
				field:  "ConfigOneof",
				reason: "oneof value cannot be a typed-nil",
	...
	case *CompiledServiceInstanceConfig_Pulumi:
		if v == nil {
			err := CompiledServiceInstanceConfigValidationError{
				field:  "ConfigOneof",
				reason: "oneof value cannot be a typed-nil",
