...
var file_prodvana_service_service_config_proto_rawDesc = []byte{
	...
	0x5f, 0x6f, 0x6e, 0x65, 0x6f, 0x66, 0x22, 0xe8, 0x0b, 0x0a, 0x0d, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x42, 0x0e, 0x0a, 0x0c,
	0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x5f, 0x6f, 0x6e, 0x65, 0x6f, 0x66, 0x4a, 0x04, 0x08, 0x06,
	0x10, 0x07, 0x4a, 0x04, 0x08, 0x07, 0x10, 0x08, 0x4a, 0x04, 0x08, 0x08, 0x10, 0x09, 0x52, 0x08,
	...
	0x64, 0x22, 0xa4, 0x0c, 0x0a, 0x1d, 0x43, 0x6f, 0x6d, 0x70, 0x69, 0x6c, 0x65, 0x64, 0x53, 0x65,
	...
	0x67, 0x52, 0x07, 0x72, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x12, 0x4e, 0x0a, 0x0c, 0x63, 0x61,
	...
	0x10, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2a, 0x2e, 0x70, 0x72, 0x6f, 0x64, 0x76, 0x61, 0x6e, 0x61,
	...
	0x70, 0x65, 0x63, 0x69, 0x66, 0x69, 0x63, 0x12, 0x4f, 0x0a, 0x0b, 0x70, 0x72, 0x6f, 0x74, 0x65,
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x14, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2d, 0x2e, 0x70,
	...
	0x74, 0x61, 0x6e, 0x63, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x0b, 0x70, 0x72, 0x6f,
	...
	0x65, 0x72, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x12, 0x51, 0x0a, 0x0f, 0x67, 0x65, 0x6e, 0x65,
	...
	0x65, 0x72, 0x69, 0x63, 0x52, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x12, 0x4b, 0x0a, 0x0f, 0x65,
	...
	0x08, 0x09, 0x10, 0x0a, 0x4a, 0x04, 0x08, 0x15, 0x10, 0x16, 0x52, 0x0c, 0x72, 0x75, 0x6e, 0x74,
	0x69, 0x6d, 0x65, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x22, 0xf1, 0x01, 0x0a, 0x11, 0x43, 0x6f, 0x6d,
	...
	0x66, 0x69, 0x67, 0x52, 0x07, 0x72, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x42, 0x4c, 0x5a, 0x4a,
...
var file_prodvana_service_service_config_proto_goTypes = []interface{}{
	...
	(*LocalConfig)(nil),                                  // 15: prodvana.service.LocalConfig
	(*ExternalConfig)(nil),                               // 16: prodvana.service.ExternalConfig
	...
	(*protection.ProtectionInstanceConfig)(nil),          // 39: prodvana.protection.ProtectionInstanceConfig
...
var file_prodvana_service_service_config_proto_depIdxs = []int32{
	...
	35, // 40: prodvana.service.ServiceConfig.parameters:type_name -> prodvana.common_config.ParameterDefinition
	36, // 41: prodvana.service.ServiceConfig.parameter_values:type_name -> prodvana.service.ServiceParameterValues
	14, // 42: prodvana.service.ServiceConfig.generic_runtime:type_name -> prodvana.service.GenericRuntimeConfig
	16, // 43: prodvana.service.ServiceConfig.external_config:type_name -> prodvana.service.ExternalConfig
	...
	9,  // 50: prodvana.service.CompiledServiceInstanceConfig.capabilities:type_name -> prodvana.service.CompiledCapabilityConfig
	27, // 51: prodvana.service.CompiledServiceInstanceConfig.delivery_config:type_name -> prodvana.delivery.DeliveryConfig
	28, // 52: prodvana.service.CompiledServiceInstanceConfig.volumes:type_name -> prodvana.volumes.Volume
	33, // 53: prodvana.service.CompiledServiceInstanceConfig.deploy_annotations:type_name -> prodvana.workflow.AnnotationsConfig
	34, // 54: prodvana.service.CompiledServiceInstanceConfig.base_template:type_name -> prodvana.common_config.ServiceTemplateRef
	12, // 55: prodvana.service.CompiledServiceInstanceConfig.pre_push_tasks:type_name -> prodvana.service.TaskConfig
	13, // 56: prodvana.service.CompiledServiceInstanceConfig.runtime_specific:type_name -> prodvana.service.RuntimeSpecificConfig
	39, // 57: prodvana.service.CompiledServiceInstanceConfig.protections:type_name -> prodvana.protection.ProtectionInstanceConfig
	35, // 58: prodvana.service.CompiledServiceInstanceConfig.parameters:type_name -> prodvana.common_config.ParameterDefinition
	40, // 59: prodvana.service.CompiledServiceInstanceConfig.parameter_values:type_name -> prodvana.common_config.ParameterValue
	14, // 60: prodvana.service.CompiledServiceInstanceConfig.generic_runtime:type_name -> prodvana.service.GenericRuntimeConfig
	16, // 61: prodvana.service.CompiledServiceInstanceConfig.external_config:type_name -> prodvana.service.ExternalConfig
	31, // 62: prodvana.service.CompiledJobConfig.programs:type_name -> prodvana.common_config.ProgramConfig
	38, // 63: prodvana.service.CompiledJobConfig.runtime:type_name -> prodvana.release_channel.ReleaseChannelRuntimeConfig
	24, // 64: prodvana.service.MetricAnalysis.LatencyConfig.max_latency:type_name -> google.protobuf.Duration
	23, // 65: prodvana.service.RuntimeSpecificConfig.K8SConfig.service_annotations:type_name -> prodvana.service.RuntimeSpecificConfig.K8SConfig.ServiceAnnotationsEntry
