...
func (m *PerReleaseChannelConfig_Terraform) CloneVT() isPerReleaseChannelConfig_ConfigOneof {
	if m == nil {
		return (*PerReleaseChannelConfig_Terraform)(nil)
	}
	r := new(PerReleaseChannelConfig_Terraform)
	r.Terraform = m.Terraform.CloneVT()
	return r
}

func (m *PerReleaseChannelConfig_Pulumi) CloneVT() isPerReleaseChannelConfig_ConfigOneof {
	if m == nil {
		return (*PerReleaseChannelConfig_Pulumi)(nil)
	}
	r := new(PerReleaseChannelConfig_Pulumi)
	r.Pulumi = m.Pulumi.CloneVT()
	return r
}
...
func (m *TerraformConfig) CloneVT() *TerraformConfig {
	if m == nil {
		return (*TerraformConfig)(nil)
	}
	r := new(TerraformConfig)
	r.Image = m.Image
	r.Path = m.Path
	r.PvnWrapperPath = m.PvnWrapperPath
	r.ShellPath = m.ShellPath
	if rhs := m.BackendConfig; rhs != nil {
		tmpContainer := make(map[string]string, len(rhs))
		for k, v := range rhs {
			tmpContainer[k] = v
		}
		r.BackendConfig = tmpContainer
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *TerraformConfig) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *PulumiConfig) CloneVT() *PulumiConfig {
	if m == nil {
	...
	r.PvnWrapperPath = m.PvnWrapperPath
	r.ShellPath = m.ShellPath
	if rhs := m.PulumiCommandPrefix; rhs != nil {
		tmpContainer := make([]string, len(rhs))
		copy(tmpContainer, rhs)
		r.PulumiCommandPrefix = tmpContainer
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *PulumiConfig) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (m *ServiceConfig_Terraform) CloneVT() isServiceConfig_ConfigOneof {
	if m == nil {
		return (*ServiceConfig_Terraform)(nil)
	}
	r := new(ServiceConfig_Terraform)
	r.Terraform = m.Terraform.CloneVT()
	return r
}

func (m *ServiceConfig_Pulumi) CloneVT() isServiceConfig_ConfigOneof {
	if m == nil {
		return (*ServiceConfig_Pulumi)(nil)
	}
	r := new(ServiceConfig_Pulumi)
	r.Pulumi = m.Pulumi.CloneVT()
	return r
}
...
func (m *CompiledServiceInstanceConfig_Terraform) CloneVT() isCompiledServiceInstanceConfig_ConfigOneof {
	if m == nil {
		return (*CompiledServiceInstanceConfig_Terraform)(nil)
	}
	r := new(CompiledServiceInstanceConfig_Terraform)
	r.Terraform = m.Terraform.CloneVT()
	return r
}

func (m *CompiledServiceInstanceConfig_Pulumi) CloneVT() isCompiledServiceInstanceConfig_ConfigOneof {
	if m == nil {
		return (*CompiledServiceInstanceConfig_Pulumi)(nil)
	}
	r := new(CompiledServiceInstanceConfig_Pulumi)
	r.Pulumi = m.Pulumi.CloneVT()
	return r
}
...
func (this *PerReleaseChannelConfig_Terraform) StableEqualVT(thatIface isPerReleaseChannelConfig_ConfigOneof) bool {
	that, ok := thatIface.(*PerReleaseChannelConfig_Terraform)
	if !ok {
		return false
	}
	if this == that {
	...
	if p, q := this.Terraform, that.Terraform; p != q {
		if p == nil {
			p = &TerraformConfig{}
		}
		if q == nil {
...
func (this *PerReleaseChannelConfig_Pulumi) StableEqualVT(thatIface isPerReleaseChannelConfig_ConfigOneof) bool {
	that, ok := thatIface.(*PerReleaseChannelConfig_Pulumi)
	if !ok {
		return false
	}
	if this == that {
	...
	if p, q := this.Pulumi, that.Pulumi; p != q {
		if p == nil {
			p = &PulumiConfig{}
		}
		if q == nil {
...
func (this *PerReleaseChannelConfig_Terraform) EqualVT(thatIface isPerReleaseChannelConfig_ConfigOneof) bool {
	that, ok := thatIface.(*PerReleaseChannelConfig_Terraform)
	if !ok {
		return false
	}
...
func (this *PerReleaseChannelConfig_Pulumi) EqualVT(thatIface isPerReleaseChannelConfig_ConfigOneof) bool {
	that, ok := thatIface.(*PerReleaseChannelConfig_Pulumi)
	if !ok {
		return false
	}
...
func (this *TerraformConfig) StableEqualVT(that *TerraformConfig) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
	...
	if this.PvnWrapperPath != that.PvnWrapperPath {
		return false
	}
	if this.ShellPath != that.ShellPath {
		return false
	}
	if len(this.BackendConfig) != len(that.BackendConfig) {
		return false
	}
	for i, vx := range this.BackendConfig {
		vy, ok := that.BackendConfig[i]
		if !ok {
			return false
		}
		if vx != vy {
...
func (this *TerraformConfig) StableEqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*TerraformConfig)
	if !ok {
		return false
	}
	return this.StableEqualVT(that)
}
func (this *TerraformConfig) EqualVT(that *TerraformConfig) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *TerraformConfig) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*TerraformConfig)
	if !ok {
		return false
	}
...
func (this *PulumiConfig) StableEqualVT(that *PulumiConfig) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
	...
	if len(this.PulumiCommandPrefix) != len(that.PulumiCommandPrefix) {
		return false
	}
	for i, vx := range this.PulumiCommandPrefix {
		vy := that.PulumiCommandPrefix[i]
		if vx != vy {
			return false
		}
	}
...
func (this *PulumiConfig) StableEqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*PulumiConfig)
	if !ok {
		return false
	}
	return this.StableEqualVT(that)
}
func (this *PulumiConfig) EqualVT(that *PulumiConfig) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *PulumiConfig) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*PulumiConfig)
	if !ok {
		return false
	}
...
func (this *ServiceConfig_Terraform) StableEqualVT(thatIface isServiceConfig_ConfigOneof) bool {
	that, ok := thatIface.(*ServiceConfig_Terraform)
	if !ok {
		return false
	}
	if this == that {
...
func (this *ServiceConfig_Pulumi) StableEqualVT(thatIface isServiceConfig_ConfigOneof) bool {
	that, ok := thatIface.(*ServiceConfig_Pulumi)
	if !ok {
		return false
	}
	if this == that {
...
func (this *ServiceConfig_Terraform) EqualVT(thatIface isServiceConfig_ConfigOneof) bool {
	that, ok := thatIface.(*ServiceConfig_Terraform)
	if !ok {
		return false
	}
...
func (this *ServiceConfig_Pulumi) EqualVT(thatIface isServiceConfig_ConfigOneof) bool {
	that, ok := thatIface.(*ServiceConfig_Pulumi)
	if !ok {
		return false
	}
...
func (this *CompiledServiceInstanceConfig_Terraform) StableEqualVT(thatIface isCompiledServiceInstanceConfig_ConfigOneof) bool {
	that, ok := thatIface.(*CompiledServiceInstanceConfig_Terraform)
	if !ok {
		return false
	}
	if this == that {
...
func (this *CompiledServiceInstanceConfig_Pulumi) StableEqualVT(thatIface isCompiledServiceInstanceConfig_ConfigOneof) bool {
	that, ok := thatIface.(*CompiledServiceInstanceConfig_Pulumi)
	if !ok {
		return false
	}
	if this == that {
...
func (this *CompiledServiceInstanceConfig_Terraform) EqualVT(thatIface isCompiledServiceInstanceConfig_ConfigOneof) bool {
	that, ok := thatIface.(*CompiledServiceInstanceConfig_Terraform)
	if !ok {
		return false
	}
...
func (this *CompiledServiceInstanceConfig_Pulumi) EqualVT(thatIface isCompiledServiceInstanceConfig_ConfigOneof) bool {
	that, ok := thatIface.(*CompiledServiceInstanceConfig_Pulumi)
	if !ok {
		return false
	}
