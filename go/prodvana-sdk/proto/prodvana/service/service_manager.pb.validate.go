...
// Validate checks the field values on PushHistoryReq with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *PushHistoryReq) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on PushHistoryReq with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in PushHistoryReqMultiError,
// or nil if none found.
func (m *PushHistoryReq) ValidateAll() error {
	return m.validate(true)
}

func (m *PushHistoryReq) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if utf8.RuneCountInString(m.GetService()) < 1 {
		err := PushHistoryReqValidationError{
			field:  "Service",
	...
	if len(errors) > 0 {
		return PushHistoryReqMultiError(errors)
	}

	return nil
}

// PushHistoryReqMultiError is an error wrapping multiple validation errors
// returned by PushHistoryReq.ValidateAll() if the designated constraints
// aren't met.
type PushHistoryReqMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m PushHistoryReqMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m PushHistoryReqMultiError) AllErrors() []error { return m }

// PushHistoryReqValidationError is the validation error returned by
// PushHistoryReq.Validate if the designated constraints aren't met.
type PushHistoryReqValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e PushHistoryReqValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e PushHistoryReqValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e PushHistoryReqValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e PushHistoryReqValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e PushHistoryReqValidationError) ErrorName() string { return "PushHistoryReqValidationError" }

// Error satisfies the builtin error interface
func (e PushHistoryReqValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = PushHistoryReqValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = PushHistoryReqValidationError{}

// Validate checks the field values on PushHistoryResp with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *PushHistoryResp) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on PushHistoryResp with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// PushHistoryRespMultiError, or nil if none found.
func (m *PushHistoryResp) ValidateAll() error {
	return m.validate(true)
}

func (m *PushHistoryResp) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	for idx, item := range m.GetPushes() {
		_, _ = idx, item
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, PushHistoryRespValidationError{
						field:  fmt.Sprintf("Pushes[%v]", idx),
						reason: "embedded message failed validation",
						cause:  err,
					})
				}
			...
			if err := v.Validate(); err != nil {
				return PushHistoryRespValidationError{
					field:  fmt.Sprintf("Pushes[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return PushHistoryRespMultiError(errors)
	}

	return nil
}

// PushHistoryRespMultiError is an error wrapping multiple validation errors
// returned by PushHistoryResp.ValidateAll() if the designated constraints
// aren't met.
type PushHistoryRespMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m PushHistoryRespMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m PushHistoryRespMultiError) AllErrors() []error { return m }

// PushHistoryRespValidationError is the validation error returned by
// PushHistoryResp.Validate if the designated constraints aren't met.
type PushHistoryRespValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e PushHistoryRespValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e PushHistoryRespValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e PushHistoryRespValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e PushHistoryRespValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e PushHistoryRespValidationError) ErrorName() string { return "PushHistoryRespValidationError" }

// Error satisfies the builtin error interface
func (e PushHistoryRespValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sPushHistoryResp.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = PushHistoryRespValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = PushHistoryRespValidationError{}

// Validate checks the field values on GetPushReq with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *GetPushReq) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetPushReq with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in GetPushReqMultiError, or
// nil if none found.
func (m *GetPushReq) ValidateAll() error {
	return m.validate(true)
}

func (m *GetPushReq) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, GetPushReqValidationError{
		...
		if err := v.Validate(); err != nil {
			return GetPushReqValidationError{
				field:  "CreationTimestamp",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return GetPushReqMultiError(errors)
	}

	return nil
}

// GetPushReqMultiError is an error wrapping multiple validation errors
// returned by GetPushReq.ValidateAll() if the designated constraints aren't met.
type GetPushReqMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetPushReqMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetPushReqMultiError) AllErrors() []error { return m }

// GetPushReqValidationError is the validation error returned by
// GetPushReq.Validate if the designated constraints aren't met.
type GetPushReqValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetPushReqValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetPushReqValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetPushReqValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetPushReqValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetPushReqValidationError) ErrorName() string { return "GetPushReqValidationError" }

// Error satisfies the builtin error interface
func (e GetPushReqValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = GetPushReqValidationError{}
