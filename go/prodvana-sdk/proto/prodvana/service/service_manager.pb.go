...
var file_prodvana_service_service_manager_proto_rawDesc = []byte{
	...
	0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x77, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x53, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x32, 0x52, 0x65, 0x73, 0x70, 0x12, 0x37,
	...
	0x0d, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x32, 0x86,
...
var file_prodvana_service_service_manager_proto_depIdxs = []int32{
	...
	41, // 37: prodvana.service.ListServiceConfigVersionsResp.VersionMetadata.source:type_name -> prodvana.version.Source
	42, // 38: prodvana.service.ListServiceConfigVersionsResp.VersionMetadata.source_metadata:type_name -> prodvana.version.SourceMetadata
	30, // 39: prodvana.service.ServiceManager.ConfigureService2:input_type -> prodvana.service.ConfigureService2Req
	32, // 40: prodvana.service.ServiceManager.ListServiceConfigVersions:input_type -> prodvana.service.ListServiceConfigVersionsReq
	34, // 41: prodvana.service.ServiceManager.GetServiceConfig2:input_type -> prodvana.service.GetServiceConfig2Req
	1,  // 42: prodvana.service.ServiceManager.ConfigureService:input_type -> prodvana.service.ConfigureServiceReq
	1,  // 43: prodvana.service.ServiceManager.ValidateConfigureService:input_type -> prodvana.service.ConfigureServiceReq
	4,  // 44: prodvana.service.ServiceManager.GetServiceConfig:input_type -> prodvana.service.GetServiceConfigReq
	28, // 45: prodvana.service.ServiceManager.ListServiceVersions:input_type -> prodvana.service.ListServiceVersionsReq
	6,  // 46: prodvana.service.ServiceManager.DeleteService:input_type -> prodvana.service.DeleteServiceReq
	8,  // 47: prodvana.service.ServiceManager.ListServices:input_type -> prodvana.service.ListServicesReq
	8,  // 48: prodvana.service.ServiceManager.ListServicesV2:input_type -> prodvana.service.ListServicesReq
	19, // 49: prodvana.service.ServiceManager.ListCommits:input_type -> prodvana.service.ListCommitsReq
	10, // 50: prodvana.service.ServiceManager.GetService:input_type -> prodvana.service.GetServiceReq
	10, // 51: prodvana.service.ServiceManager.GetServiceV2:input_type -> prodvana.service.GetServiceReq
	12, // 52: prodvana.service.ServiceManager.ListServiceInstances:input_type -> prodvana.service.ListServiceInstancesReq
	12, // 53: prodvana.service.ServiceManager.ListServiceInstancesV2:input_type -> prodvana.service.ListServiceInstancesReq
	14, // 54: prodvana.service.ServiceManager.GetServiceInstance:input_type -> prodvana.service.GetServiceInstanceReq
	14, // 55: prodvana.service.ServiceManager.GetServiceInstanceV2:input_type -> prodvana.service.GetServiceInstanceReq
	...
	31, // 61: prodvana.service.ServiceManager.ConfigureService2:output_type -> prodvana.service.ConfigureService2Resp
	...
	35, // 63: prodvana.service.ServiceManager.GetServiceConfig2:output_type -> prodvana.service.GetServiceConfig2Resp
	2,  // 64: prodvana.service.ServiceManager.ConfigureService:output_type -> prodvana.service.ConfigureServiceResp
	3,  // 65: prodvana.service.ServiceManager.ValidateConfigureService:output_type -> prodvana.service.ValidateConfigureServiceResp
	5,  // 66: prodvana.service.ServiceManager.GetServiceConfig:output_type -> prodvana.service.GetServiceConfigResp
	29, // 67: prodvana.service.ServiceManager.ListServiceVersions:output_type -> prodvana.service.ListServiceVersionsResp
	...
	9,  // 70: prodvana.service.ServiceManager.ListServicesV2:output_type -> prodvana.service.ListServicesResp
	20, // 71: prodvana.service.ServiceManager.ListCommits:output_type -> prodvana.service.ListCommitsResp
	11, // 72: prodvana.service.ServiceManager.GetService:output_type -> prodvana.service.GetServiceResp
	11, // 73: prodvana.service.ServiceManager.GetServiceV2:output_type -> prodvana.service.GetServiceResp
	13, // 74: prodvana.service.ServiceManager.ListServiceInstances:output_type -> prodvana.service.ListServiceInstancesResp
	13, // 75: prodvana.service.ServiceManager.ListServiceInstancesV2:output_type -> prodvana.service.ListServiceInstancesResp
	15, // 76: prodvana.service.ServiceManager.GetServiceInstance:output_type -> prodvana.service.GetServiceInstanceResp
	15, // 77: prodvana.service.ServiceManager.GetServiceInstanceV2:output_type -> prodvana.service.GetServiceInstanceResp
	17, // 78: prodvana.service.ServiceManager.GetServiceMetrics:output_type -> prodvana.service.GetServiceMetricsResp
	21, // 79: prodvana.service.ServiceManager.GetServiceInsights:output_type -> prodvana.service.GetServiceInsightsResp
	23, // 80: prodvana.service.ServiceManager.SnoozeServiceInsight:output_type -> prodvana.service.SnoozeServiceInsightResp
	25, // 81: prodvana.service.ServiceManager.GetServiceMetadata:output_type -> prodvana.service.GetServiceMetadataResp
	27, // 82: prodvana.service.ServiceManager.SetServiceMetadata:output_type -> prodvana.service.SetServiceMetadataResp
