...
var file_prodvana_service_object_proto_rawDesc = []byte{
	...
	,
	...
	0x6e, 0x74, 0x49, 0x64, 0x22, 0xa6, 0x01, 0x0a, 0x0c, 0x45, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61,
	0x6c, 0x41, 0x64, 0x64, 0x72, 0x12, 0x12, 0x0a, 0x04, 0x61, 0x64, 0x64, 0x72, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x04, 0x61, 0x64, 0x64, 0x72, 0x12, 0x37, 0x0a, 0x04, 0x74, 0x79, 0x70,
	0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x23, 0x2e, 0x70, 0x72, 0x6f, 0x64, 0x76, 0x61,
	0x6e, 0x61, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x45, 0x78, 0x74, 0x65, 0x72,
	0x6e, 0x61, 0x6c, 0x41, 0x64, 0x64, 0x72, 0x2e, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79,
	0x70, 0x65, 0x22, 0x49, 0x0a, 0x04, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0b, 0x0a, 0x07, 0x55, 0x4e,
	...
	0x0a, 0x0a, 0x06, 0x52, 0x41, 0x57, 0x5f, 0x49, 0x50, 0x10, 0x03, 0x12, 0x10, 0x0a, 0x0c, 0x52,
	0x41, 0x57, 0x5f, 0x48, 0x4f, 0x53, 0x54, 0x4e, 0x41, 0x4d, 0x45, 0x10, 0x04, 0x22, 0x38, 0x0a,
	0x0c, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x53, 0x74, 0x61, 0x74, 0x65, 0x4a, 0x04, 0x08,
...
var file_prodvana_service_object_proto_goTypes = []interface{}{
	...
	(*object.ObjectMeta)(nil),                       // 7: prodvana.object.ObjectMeta
	(*ServiceConfig)(nil),                           // 8: prodvana.service.ServiceConfig
	(*ServiceUserMetadata)(nil),                     // 9: prodvana.service.ServiceUserMetadata
	(*common_config.ServiceInstanceObjectMeta)(nil), // 10: prodvana.common_config.ServiceInstanceObjectMeta
	(*CompiledServiceInstanceConfig)(nil),           // 11: prodvana.service.CompiledServiceInstanceConfig
}
var file_prodvana_service_object_proto_depIdxs = []int32{
	...
	7,  // 1: prodvana.service.Service.meta:type_name -> prodvana.object.ObjectMeta
	8,  // 2: prodvana.service.Service.config:type_name -> prodvana.service.ServiceConfig
	3,  // 3: prodvana.service.Service.state:type_name -> prodvana.service.ServiceState
	9,  // 4: prodvana.service.Service.user_metadata:type_name -> prodvana.service.ServiceUserMetadata
	2,  // 5: prodvana.service.ServiceInstanceState.external_addrs:type_name -> prodvana.service.ExternalAddr
	1,  // 6: prodvana.service.ServiceInstanceState.protection_attachments:type_name -> prodvana.service.ServiceInstanceProtectionAttachment
	10, // 7: prodvana.service.ServiceInstance.meta:type_name -> prodvana.common_config.ServiceInstanceObjectMeta
	11, // 8: prodvana.service.ServiceInstance.config:type_name -> prodvana.service.CompiledServiceInstanceConfig
	5,  // 9: prodvana.service.ServiceInstance.state:type_name -> prodvana.service.ServiceInstanceState
