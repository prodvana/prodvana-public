...
func (m *TerraformRunnerConfig) validate(all bool) error {
	...
	// no validation rules for DisableDriftDetection

	if all {
		switch v := interface{}(m.GetTaskResources()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, TerraformRunnerConfigValidationError{
					field:  "TaskResources",
	...
	} else if v, ok := interface{}(m.GetTaskResources()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return TerraformRunnerConfigValidationError{
				field:  "TaskResources",
				reason: "embedded message failed validation",
...
func (m *AwsEcsConfig) validate(all bool) error {
	...
	case *AwsEcsConfig_InheritRoleFromRuntimeEnv:
		if v == nil {
			err := AwsEcsConfigValidationError{
				field:  "Credentials",
				reason: "oneof value cannot be a typed-nil",
		...
		if all {
			switch v := interface{}(m.GetInheritRoleFromRuntimeEnv()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, AwsEcsConfigValidationError{
						field:  "InheritRoleFromRuntimeEnv",
						reason: "embedded message failed validation",
						cause:  err,
					})
				}
		...
		} else if v, ok := interface{}(m.GetInheritRoleFromRuntimeEnv()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return AwsEcsConfigValidationError{
					field:  "InheritRoleFromRuntimeEnv",
					reason: "embedded message failed validation",
...
func (m *FlyConfig) validate(all bool) error {
	...
	case *FlyConfig_FlyApiToken:
		...
		if all {
			switch v := interface{}(m.GetFlyApiToken()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
		...
		} else if v, ok := interface{}(m.GetFlyApiToken()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
...
// Validate checks the field values on AwsEcsConfig_InheritRole with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
...
// ValidateAll checks the field values on AwsEcsConfig_InheritRole with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// AwsEcsConfig_InheritRoleMultiError, or nil if none found.
func (m *AwsEcsConfig_InheritRole) ValidateAll() error {
	return m.validate(true)
}

func (m *AwsEcsConfig_InheritRole) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return AwsEcsConfig_InheritRoleMultiError(errors)
	}

	return nil
}

// AwsEcsConfig_InheritRoleMultiError is an error wrapping multiple validation
// errors returned by AwsEcsConfig_InheritRole.ValidateAll() if the designated
// constraints aren't met.
type AwsEcsConfig_InheritRoleMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m AwsEcsConfig_InheritRoleMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m AwsEcsConfig_InheritRoleMultiError) AllErrors() []error { return m }

// AwsEcsConfig_InheritRoleValidationError is the validation error returned by
// AwsEcsConfig_InheritRole.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e AwsEcsConfig_InheritRoleValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e AwsEcsConfig_InheritRoleValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e AwsEcsConfig_InheritRoleValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e AwsEcsConfig_InheritRoleValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e AwsEcsConfig_InheritRoleValidationError) ErrorName() string {
	return "AwsEcsConfig_InheritRoleValidationError"
}

// Error satisfies the builtin error interface
func (e AwsEcsConfig_InheritRoleValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sAwsEcsConfig_InheritRole.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = AwsEcsConfig_InheritRoleValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = AwsEcsConfig_InheritRoleValidationError{}
