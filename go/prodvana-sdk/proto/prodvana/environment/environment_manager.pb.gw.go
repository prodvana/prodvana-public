...
func request_EnvironmentManager_GetClusterAgentApiToken_0(ctx context.Context, marshaler runtime.Marshaler, client EnvironmentManagerClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetClusterAgentApiTokenReq
	...
	msg, err := client.GetClusterAgentApiToken(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_EnvironmentManager_GetClusterAgentApiToken_0(ctx context.Context, marshaler runtime.Marshaler, server EnvironmentManagerServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetClusterAgentApiTokenReq
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetClusterAgentApiToken(ctx, &protoReq)
	return msg, metadata, err
...
func request_EnvironmentManager_GetCluster_0(ctx context.Context, marshaler runtime.Marshaler, client EnvironmentManagerClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	val, ok = pathParams["runtime"]
	if !ok {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "missing parameter %s", "runtime")
	}
...
func local_request_EnvironmentManager_GetCluster_0(ctx context.Context, marshaler runtime.Marshaler, server EnvironmentManagerServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetClusterReq
	var metadata runtime.ServerMetadata
...
func request_EnvironmentManager_PauseCluster_0(ctx context.Context, marshaler runtime.Marshaler, client EnvironmentManagerClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq PauseClusterReq
	var metadata runtime.ServerMetadata
	...
	msg, err := client.PauseCluster(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_EnvironmentManager_PauseCluster_0(ctx context.Context, marshaler runtime.Marshaler, server EnvironmentManagerServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq PauseClusterReq
	var metadata runtime.ServerMetadata
	...
	msg, err := server.PauseCluster(ctx, &protoReq)
	return msg, metadata, err

}

func request_EnvironmentManager_ResumeCluster_0(ctx context.Context, marshaler runtime.Marshaler, client EnvironmentManagerClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ResumeClusterReq
	var metadata runtime.ServerMetadata
	...
	msg, err := client.ResumeCluster(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_EnvironmentManager_ResumeCluster_0(ctx context.Context, marshaler runtime.Marshaler, server EnvironmentManagerServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ResumeClusterReq
	var metadata runtime.ServerMetadata
	...
	msg, err := server.ResumeCluster(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterEnvironmentManagerHandlerServer(ctx context.Context, mux *runtime.ServeMux, server EnvironmentManagerServer) error {
	...
	mux.Handle("GET", pattern_EnvironmentManager_GetClusterAgentApiToken_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/prodvana.environment.EnvironmentManager/GetClusterAgentApiToken", runtime.WithHTTPPathPattern("/v1/clusters/{name=*}/token"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_EnvironmentManager_GetClusterAgentApiToken_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_EnvironmentManager_GetClusterAgentApiToken_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("GET", pattern_EnvironmentManager_GetCluster_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/prodvana.environment.EnvironmentManager/GetCluster", runtime.WithHTTPPathPattern("/v1/clusters/{runtime=*}/get"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_EnvironmentManager_GetCluster_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_EnvironmentManager_GetCluster_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("POST", pattern_EnvironmentManager_PauseCluster_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/prodvana.environment.EnvironmentManager/PauseCluster", runtime.WithHTTPPathPattern("/v1/clusters/pause"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_EnvironmentManager_PauseCluster_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_EnvironmentManager_PauseCluster_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("POST", pattern_EnvironmentManager_ResumeCluster_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/prodvana.environment.EnvironmentManager/ResumeCluster", runtime.WithHTTPPathPattern("/v1/clusters/resume"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_EnvironmentManager_ResumeCluster_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_EnvironmentManager_ResumeCluster_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterEnvironmentManagerHandlerClient(ctx context.Context, mux *runtime.ServeMux, client EnvironmentManagerClient) error {
	...
	mux.Handle("GET", pattern_EnvironmentManager_GetClusterAgentApiToken_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/prodvana.environment.EnvironmentManager/GetClusterAgentApiToken", runtime.WithHTTPPathPattern("/v1/clusters/{name=*}/token"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_EnvironmentManager_GetClusterAgentApiToken_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_EnvironmentManager_GetCluster_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/prodvana.environment.EnvironmentManager/GetCluster", runtime.WithHTTPPathPattern("/v1/clusters/{runtime=*}/get"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_EnvironmentManager_GetCluster_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_EnvironmentManager_PauseCluster_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/prodvana.environment.EnvironmentManager/PauseCluster", runtime.WithHTTPPathPattern("/v1/clusters/pause"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_EnvironmentManager_PauseCluster_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_EnvironmentManager_ResumeCluster_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/prodvana.environment.EnvironmentManager/ResumeCluster", runtime.WithHTTPPathPattern("/v1/clusters/resume"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_EnvironmentManager_ResumeCluster_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_EnvironmentManager_GetClusterAgentApiToken_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"v1", "clusters", "name", "token"}, ""))
	...
	pattern_EnvironmentManager_GetCluster_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"v1", "clusters", "runtime", "get"}, ""))
	...
	pattern_EnvironmentManager_PauseCluster_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "clusters", "pause"}, ""))

	pattern_EnvironmentManager_ResumeCluster_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "clusters", "resume"}, ""))
)

var (
	forward_EnvironmentManager_GetClusterAgentApiToken_0 = runtime.ForwardResponseMessage
	...
	forward_EnvironmentManager_GetCluster_0 = runtime.ForwardResponseMessage
	...
	forward_EnvironmentManager_PauseCluster_0 = runtime.ForwardResponseMessage

	forward_EnvironmentManager_ResumeCluster_0 = runtime.ForwardResponseMessage
)
