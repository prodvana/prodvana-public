...
func (ClusterConfig_ArgoRollouts_AnalysisTemplate_ArgValue) EnumDescriptor() ([]byte, []int) {
	return file_prodvana_environment_clusters_proto_rawDescGZIP(), []int{13, 3, 0, 0}
}
...
type ExtensionClusterConfig struct {
	...
	// Defaults to 10m.
	ConvergenceGracePeriod *durationpb.Duration `protobuf:"bytes,7,opt,name=convergence_grace_period,json=convergenceGracePeriod,proto3" json:"convergence_grace_period,omitempty"`
}
...
func (*ClusterConfig_ALBIngress) Descriptor() ([]byte, []int) {
	return file_prodvana_environment_clusters_proto_rawDescGZIP(), []int{13, 2}
}
...
func (*ClusterConfig_ArgoRollouts) Descriptor() ([]byte, []int) {
	return file_prodvana_environment_clusters_proto_rawDescGZIP(), []int{13, 3}
}
...
func (*ClusterConfig_GKEIngress) Descriptor() ([]byte, []int) {
	return file_prodvana_environment_clusters_proto_rawDescGZIP(), []int{13, 4}
}
...
func (*ClusterConfig_ArgoRollouts_AnalysisTemplate) Descriptor() ([]byte, []int) {
	return file_prodvana_environment_clusters_proto_rawDescGZIP(), []int{13, 3, 0}
}
...
var file_prodvana_environment_clusters_proto_rawDesc = []byte{
	...
	0x42, 0x01, 0x4a, 0x04, 0x08, 0x03, 0x10, 0x04, 0x4a, 0x04, 0x08, 0x06, 0x10, 0x07, 0x22, 0xb9,
	0x04, 0x0a, 0x16, 0x45, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x43, 0x6c, 0x75, 0x73,
	...
	0x6e, 0x64, 0x52, 0x05, 0x66, 0x65, 0x74, 0x63, 0x68, 0x12, 0x5a, 0x0a, 0x0a, 0x70, 0x61, 0x72,
...
var file_prodvana_environment_clusters_proto_msgTypes = make([]protoimpl.MessageInfo, 31)
var file_prodvana_environment_clusters_proto_goTypes = []interface{}{
	...
	(*ExtensionApplyCommand)(nil),                     // 9: prodvana.environment.ExtensionApplyCommand
	(*ExtensionClusterConfig)(nil),                    // 10: prodvana.environment.ExtensionClusterConfig
	(*CompiledExtensionCommand)(nil),                  // 11: prodvana.environment.CompiledExtensionCommand
	(*IacRunnerCommand)(nil),                          // 12: prodvana.environment.IacRunnerCommand
	(*TerraformRunnerConfig)(nil),                     // 13: prodvana.environment.TerraformRunnerConfig
	(*PulumiRunnerConfig)(nil),                        // 14: prodvana.environment.PulumiRunnerConfig
	...
	(*ClusterConfig)(nil),                             // 17: prodvana.environment.ClusterConfig
	(*ClusterAuth_ECSAuth)(nil),                       // 18: prodvana.environment.ClusterAuth.ECSAuth
	(*ClusterAuth_K8SAuth)(nil),                       // 19: prodvana.environment.ClusterAuth.K8sAuth
	nil,                                               // 20: prodvana.environment.ClusterAuth.K8sAuth.AgentEnvEntry
	(*FakeClusterConfig_CrashingProgramPatterns)(nil), // 21: prodvana.environment.FakeClusterConfig.CrashingProgramPatterns
	nil, // 22: prodvana.environment.ExtensionFetchCommand.EnvEntry
	nil, // 23: prodvana.environment.ExtensionApplyCommand.EnvEntry
	(*CompiledExtensionCommand_CompiledExtensionCommandExec)(nil), // 24: prodvana.environment.CompiledExtensionCommand.CompiledExtensionCommandExec
	nil,                                // 25: prodvana.environment.CompiledExtensionCommand.EnvEntry
	nil,                                // 26: prodvana.environment.TerraformRunnerConfig.EnvEntry
	nil,                                // 27: prodvana.environment.PulumiRunnerConfig.EnvEntry
	(*ClusterConfig_Kubecost)(nil),     // 28: prodvana.environment.ClusterConfig.Kubecost
	(*ClusterConfig_Datadog)(nil),      // 29: prodvana.environment.ClusterConfig.Datadog
	(*ClusterConfig_ALBIngress)(nil),   // 30: prodvana.environment.ClusterConfig.ALBIngress
	(*ClusterConfig_ArgoRollouts)(nil), // 31: prodvana.environment.ClusterConfig.ArgoRollouts
	(*ClusterConfig_GKEIngress)(nil),   // 32: prodvana.environment.ClusterConfig.GKEIngress
	(*ClusterConfig_ArgoRollouts_AnalysisTemplate)(nil), // 33: prodvana.environment.ClusterConfig.ArgoRollouts.AnalysisTemplate
	nil,                                       // 34: prodvana.environment.ClusterConfig.ArgoRollouts.AnalysisTemplate.ArgMappingEntry
	(*timestamppb.Timestamp)(nil),             // 35: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),               // 36: google.protobuf.Duration
	(*common_config.TaskConfig)(nil),          // 37: prodvana.common_config.TaskConfig
	(*common_config.KubernetesConfig)(nil),    // 38: prodvana.common_config.KubernetesConfig
	(*common_config.ParameterDefinition)(nil), // 39: prodvana.common_config.ParameterDefinition
	(*runtimes.RuntimeExecutionConfig)(nil),   // 40: prodvana.runtimes.RuntimeExecutionConfig
	(*volumes.Volume)(nil),                    // 41: prodvana.volumes.Volume
	(*labels.LabelDefinition)(nil),            // 42: prodvana.labels.LabelDefinition
	(*common_config.EnvValue)(nil),            // 43: prodvana.common_config.EnvValue
}
var file_prodvana_environment_clusters_proto_depIdxs = []int32{
	18, // 0: prodvana.environment.ClusterAuth.ecs:type_name -> prodvana.environment.ClusterAuth.ECSAuth
	19, // 1: prodvana.environment.ClusterAuth.k8s:type_name -> prodvana.environment.ClusterAuth.K8sAuth
	...
	17, // 4: prodvana.environment.Cluster.config:type_name -> prodvana.environment.ClusterConfig
	35, // 5: prodvana.environment.Cluster.last_heartbeat_timestamp:type_name -> google.protobuf.Timestamp
	21, // 6: prodvana.environment.FakeClusterConfig.crashing_programs:type_name -> prodvana.environment.FakeClusterConfig.CrashingProgramPatterns
	36, // 7: prodvana.environment.RetryPolicy.base_interval:type_name -> google.protobuf.Duration
	36, // 8: prodvana.environment.RetryPolicy.max_interval:type_name -> google.protobuf.Duration
	37, // 9: prodvana.environment.ExtensionFetchCommand.task_config:type_name -> prodvana.common_config.TaskConfig
	38, // 10: prodvana.environment.ExtensionFetchCommand.kubernetes_config:type_name -> prodvana.common_config.KubernetesConfig
	36, // 11: prodvana.environment.ExtensionFetchCommand.poll_interval:type_name -> google.protobuf.Duration
	36, // 12: prodvana.environment.ExtensionFetchCommand.steady_state_poll_interval:type_name -> google.protobuf.Duration
	36, // 13: prodvana.environment.ExtensionFetchCommand.timeout:type_name -> google.protobuf.Duration
	7,  // 14: prodvana.environment.ExtensionFetchCommand.retry_policy:type_name -> prodvana.environment.RetryPolicy
	22, // 15: prodvana.environment.ExtensionFetchCommand.env:type_name -> prodvana.environment.ExtensionFetchCommand.EnvEntry
	37, // 16: prodvana.environment.ExtensionApplyCommand.task_config:type_name -> prodvana.common_config.TaskConfig
	38, // 17: prodvana.environment.ExtensionApplyCommand.kubernetes_config:type_name -> prodvana.common_config.KubernetesConfig
	36, // 18: prodvana.environment.ExtensionApplyCommand.timeout:type_name -> google.protobuf.Duration
	23, // 19: prodvana.environment.ExtensionApplyCommand.env:type_name -> prodvana.environment.ExtensionApplyCommand.EnvEntry
	7,  // 20: prodvana.environment.ExtensionApplyCommand.retry_policy:type_name -> prodvana.environment.RetryPolicy
	9,  // 21: prodvana.environment.ExtensionClusterConfig.apply:type_name -> prodvana.environment.ExtensionApplyCommand
	8,  // 22: prodvana.environment.ExtensionClusterConfig.fetch:type_name -> prodvana.environment.ExtensionFetchCommand
	39, // 23: prodvana.environment.ExtensionClusterConfig.parameters:type_name -> prodvana.common_config.ParameterDefinition
	40, // 24: prodvana.environment.ExtensionClusterConfig.proxy_runtime:type_name -> prodvana.runtimes.RuntimeExecutionConfig
	1,  // 25: prodvana.environment.ExtensionClusterConfig.type:type_name -> prodvana.environment.ExtensionType
	36, // 26: prodvana.environment.ExtensionClusterConfig.convergence_grace_period:type_name -> google.protobuf.Duration
	24, // 27: prodvana.environment.CompiledExtensionCommand.command:type_name -> prodvana.environment.CompiledExtensionCommand.CompiledExtensionCommandExec
	40, // 28: prodvana.environment.CompiledExtensionCommand.runtime_execution:type_name -> prodvana.runtimes.RuntimeExecutionConfig
	25, // 29: prodvana.environment.CompiledExtensionCommand.env:type_name -> prodvana.environment.CompiledExtensionCommand.EnvEntry
	40, // 30: prodvana.environment.TerraformRunnerConfig.proxy_runtime:type_name -> prodvana.runtimes.RuntimeExecutionConfig
	26, // 31: prodvana.environment.TerraformRunnerConfig.env:type_name -> prodvana.environment.TerraformRunnerConfig.EnvEntry
	41, // 32: prodvana.environment.TerraformRunnerConfig.volumes:type_name -> prodvana.volumes.Volume
	12, // 33: prodvana.environment.TerraformRunnerConfig.pre_run:type_name -> prodvana.environment.IacRunnerCommand
	36, // 34: prodvana.environment.TerraformRunnerConfig.poll_interval:type_name -> google.protobuf.Duration
	36, // 35: prodvana.environment.TerraformRunnerConfig.steady_state_poll_interval:type_name -> google.protobuf.Duration
	36, // 36: prodvana.environment.TerraformRunnerConfig.convergence_grace_period:type_name -> google.protobuf.Duration
	7,  // 37: prodvana.environment.TerraformRunnerConfig.fetch_retry_policy:type_name -> prodvana.environment.RetryPolicy
	7,  // 38: prodvana.environment.TerraformRunnerConfig.apply_retry_policy:type_name -> prodvana.environment.RetryPolicy
	40, // 39: prodvana.environment.PulumiRunnerConfig.proxy_runtime:type_name -> prodvana.runtimes.RuntimeExecutionConfig
	27, // 40: prodvana.environment.PulumiRunnerConfig.env:type_name -> prodvana.environment.PulumiRunnerConfig.EnvEntry
	41, // 41: prodvana.environment.PulumiRunnerConfig.volumes:type_name -> prodvana.volumes.Volume
	12, // 42: prodvana.environment.PulumiRunnerConfig.pre_run:type_name -> prodvana.environment.IacRunnerCommand
	36, // 43: prodvana.environment.PulumiRunnerConfig.poll_interval:type_name -> google.protobuf.Duration
	36, // 44: prodvana.environment.PulumiRunnerConfig.convergence_grace_period:type_name -> google.protobuf.Duration
	7,  // 45: prodvana.environment.PulumiRunnerConfig.fetch_retry_policy:type_name -> prodvana.environment.RetryPolicy
	15, // 46: prodvana.environment.ClusterMetadata.gke:type_name -> prodvana.environment.GKEClusterMetadata
	28, // 47: prodvana.environment.ClusterConfig.kubecost:type_name -> prodvana.environment.ClusterConfig.Kubecost
	29, // 48: prodvana.environment.ClusterConfig.datadog:type_name -> prodvana.environment.ClusterConfig.Datadog
	30, // 49: prodvana.environment.ClusterConfig.alb_ingress:type_name -> prodvana.environment.ClusterConfig.ALBIngress
	31, // 50: prodvana.environment.ClusterConfig.argo_rollouts:type_name -> prodvana.environment.ClusterConfig.ArgoRollouts
	32, // 51: prodvana.environment.ClusterConfig.gke_ingress:type_name -> prodvana.environment.ClusterConfig.GKEIngress
	32, // 52: prodvana.environment.ClusterConfig.self_managed_gke_ingress:type_name -> prodvana.environment.ClusterConfig.GKEIngress
	2,  // 53: prodvana.environment.ClusterConfig.cloud_provider:type_name -> prodvana.environment.ClusterConfig.CloudProvider
	16, // 54: prodvana.environment.ClusterConfig.detected_cluster_metadata:type_name -> prodvana.environment.ClusterMetadata
	16, // 55: prodvana.environment.ClusterConfig.user_supplied_cluster_metadata:type_name -> prodvana.environment.ClusterMetadata
	6,  // 56: prodvana.environment.ClusterConfig.fake:type_name -> prodvana.environment.FakeClusterConfig
	10, // 57: prodvana.environment.ClusterConfig.extension:type_name -> prodvana.environment.ExtensionClusterConfig
	13, // 58: prodvana.environment.ClusterConfig.terraform_runner:type_name -> prodvana.environment.TerraformRunnerConfig
	13, // 59: prodvana.environment.ClusterConfig.pulumi_runner:type_name -> prodvana.environment.TerraformRunnerConfig
	42, // 60: prodvana.environment.ClusterConfig.labels:type_name -> prodvana.labels.LabelDefinition
	20, // 61: prodvana.environment.ClusterAuth.K8sAuth.agent_env:type_name -> prodvana.environment.ClusterAuth.K8sAuth.AgentEnvEntry
	43, // 62: prodvana.environment.ExtensionFetchCommand.EnvEntry.value:type_name -> prodvana.common_config.EnvValue
	43, // 63: prodvana.environment.ExtensionApplyCommand.EnvEntry.value:type_name -> prodvana.common_config.EnvValue
	37, // 64: prodvana.environment.CompiledExtensionCommand.CompiledExtensionCommandExec.task_config:type_name -> prodvana.common_config.TaskConfig
	38, // 65: prodvana.environment.CompiledExtensionCommand.CompiledExtensionCommandExec.kubernetes_config:type_name -> prodvana.common_config.KubernetesConfig
	43, // 66: prodvana.environment.CompiledExtensionCommand.EnvEntry.value:type_name -> prodvana.common_config.EnvValue
	43, // 67: prodvana.environment.TerraformRunnerConfig.EnvEntry.value:type_name -> prodvana.common_config.EnvValue
	43, // 68: prodvana.environment.PulumiRunnerConfig.EnvEntry.value:type_name -> prodvana.common_config.EnvValue
	33, // 69: prodvana.environment.ClusterConfig.ArgoRollouts.templates:type_name -> prodvana.environment.ClusterConfig.ArgoRollouts.AnalysisTemplate
	34, // 70: prodvana.environment.ClusterConfig.ArgoRollouts.AnalysisTemplate.arg_mapping:type_name -> prodvana.environment.ClusterConfig.ArgoRollouts.AnalysisTemplate.ArgMappingEntry
	3,  // 71: prodvana.environment.ClusterConfig.ArgoRollouts.AnalysisTemplate.ArgMappingEntry.value:type_name -> prodvana.environment.ClusterConfig.ArgoRollouts.AnalysisTemplate.ArgValue
...
func file_prodvana_environment_clusters_proto_init() {
	...
	file_prodvana_environment_clusters_proto_msgTypes[20].OneofWrappers = []interface{}{
