...
var file_prodvana_protection_protection_config_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x81, 0x02, 0x0a, 0x10, 0x50, 0x72, 0x6f, 0x74, 0x65, 0x63,
...
var file_prodvana_protection_protection_config_proto_depIdxs = []int32{
	...
	1, // 2: prodvana.protection.CompiledProtectionAttachmentConfig.config:type_name -> prodvana.protection.ProtectionConfig
	5, // 3: prodvana.protection.CompiledProtectionAttachmentConfig.attachment:type_name -> prodvana.protection.ProtectionAttachment
	8, // 4: prodvana.protection.CompiledProtectionAttachmentConfig.runtime_execution:type_name -> prodvana.runtimes.RuntimeExecutionConfig
	3, // 5: prodvana.protection.ProtectionAttachment.service_instance:type_name -> prodvana.protection.ServiceInstanceAttachment
	4, // 6: prodvana.protection.ProtectionAttachment.release_channel:type_name -> prodvana.protection.ReleaseChannelAttachment
