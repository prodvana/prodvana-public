...
func RegisterWorkflowManagerHandlerServer(ctx context.Context, mux *runtime.ServeMux, server WorkflowManagerServer) error {
	...
	mux.Handle("GET", pattern_WorkflowManager_ListContainerRegistryIntegrations_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/prodvana.workflow.WorkflowManager/ListContainerRegistryIntegrations", runtime.WithHTTPPathPattern("/v1/integrations/container-registry/list"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterWorkflowManagerHandlerClient(ctx context.Context, mux *runtime.ServeMux, client WorkflowManagerClient) error {
	...
	mux.Handle("GET", pattern_WorkflowManager_ListContainerRegistryIntegrations_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/prodvana.workflow.WorkflowManager/ListContainerRegistryIntegrations", runtime.WithHTTPPathPattern("/v1/integrations/container-registry/list"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_WorkflowManager_ListContainerRegistryIntegrations_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "integrations", "container-registry", "list"}, ""))
