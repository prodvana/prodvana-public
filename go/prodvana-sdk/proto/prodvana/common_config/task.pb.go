...
var file_prodvana_common_config_task_proto_goTypes = []interface{}{
	(*TaskConfig)(nil),    // 0: prodvana.common_config.TaskConfig
	(*ProgramConfig)(nil), // 1: prodvana.common_config.ProgramConfig
	(*RetryConfig)(nil),   // 2: prodvana.common_config.RetryConfig
}
var file_prodvana_common_config_task_proto_depIdxs = []int32{
	1, // 0: prodvana.common_config.TaskConfig.program:type_name -> prodvana.common_config.ProgramConfig
	2, // 1: prodvana.common_config.TaskConfig.retry_config:type_name -> prodvana.common_config.RetryConfig
