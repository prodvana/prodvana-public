...
var file_prodvana_common_config_parameters_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_prodvana_common_config_parameters_proto_goTypes = []interface{}{
	...
	(*ImageRegistryInfo)(nil),              // 6: prodvana.common_config.ImageRegistryInfo
}
var file_prodvana_common_config_parameters_proto_depIdxs = []int32{
	6, // 0: prodvana.common_config.DockerImageParameterDefinition.image_registry_info:type_name -> prodvana.common_config.ImageRegistryInfo
