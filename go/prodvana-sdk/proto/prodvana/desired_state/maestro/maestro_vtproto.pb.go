...
func (m *StatusWithDetails) CloneVT() *StatusWithDetails {
	if m == nil {
		return (*StatusWithDetails)(nil)
	}
	r := new(StatusWithDetails)
	r.Status = m.Status
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *StatusWithDetails) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (m *MaestroReleaseChannelState) CloneVT() *MaestroReleaseChannelState {
	...
	if rhs := m.ReleaseChannelDepStatuses; rhs != nil {
		tmpContainer := make(map[string]*StatusWithDetails, len(rhs))
		for k, v := range rhs {
			tmpContainer[k] = v.CloneVT()
		}
		r.ReleaseChannelDepStatuses = tmpContainer
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (this *StatusWithDetails) StableEqualVT(that *StatusWithDetails) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *StatusWithDetails) StableEqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*StatusWithDetails)
	if !ok {
		return false
	}
	return this.StableEqualVT(that)
}
func (this *StatusWithDetails) EqualVT(that *StatusWithDetails) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *StatusWithDetails) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*StatusWithDetails)
	if !ok {
		return false
	}
...
func (this *MaestroReleaseChannelState) StableEqualVT(that *MaestroReleaseChannelState) bool {
	...
	if len(this.ReleaseChannelDepStatuses) != len(that.ReleaseChannelDepStatuses) {
		return false
	}
	for i, vx := range this.ReleaseChannelDepStatuses {
		vy, ok := that.ReleaseChannelDepStatuses[i]
		if !ok {
			return false
		}
		if p, q := vx, vy; p != q {
