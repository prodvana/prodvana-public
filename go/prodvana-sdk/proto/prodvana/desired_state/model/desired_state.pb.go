...
var file_prodvana_desired_state_model_desired_state_proto_rawDesc = []byte{
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x70, 0x69, 0x63, 0x22, 0xe6, 0x05,
	...
	0x69, 0x6f, 0x6e, 0x4c, 0x69, 0x6e, 0x6b, 0x42, 0x0d, 0x0a, 0x0b, 0x73, 0x74, 0x61, 0x74, 0x65,
	...
	0x0b, 0x4a, 0x04, 0x08, 0x0b, 0x10, 0x0c, 0x22, 0x98, 0x01, 0x0a, 0x13, 0x50, 0x72, 0x6f, 0x74,
	...
	0x75, 0x73, 0x22, 0xdf, 0x01, 0x0a, 0x14, 0x50, 0x72, 0x6f, 0x74, 0x65, 0x63, 0x74, 0x69, 0x6f,
	...
	0x52, 0x08, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x23, 0x0a, 0x0d, 0x70, 0x72,
	...
	0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x4c, 0x49, 0x4e, 0x4b, 0x10, 0x08, 0x2a, 0x8e, 0x01, 0x0a, 0x0e,
...
var file_prodvana_desired_state_model_desired_state_proto_goTypes = []interface{}{
	...
	(*ProtectionLinkState)(nil),                     // 33: prodvana.desired_state.model.ProtectionLinkState
...
var file_prodvana_desired_state_model_desired_state_proto_depIdxs = []int32{
	43, // 0: prodvana.desired_state.model.ProtectionLink.lifecycle:type_name -> prodvana.protection.ProtectionLifecycle
	37, // 1: prodvana.desired_state.model.Condition.rc_cond:type_name -> prodvana.desired_state.model.Condition.ReleaseChannelStableCondition
	38, // 2: prodvana.desired_state.model.Condition.manual_approval:type_name -> prodvana.desired_state.model.Condition.ManualApproval
	39, // 3: prodvana.desired_state.model.Condition.custom_task:type_name -> prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition
	...
	34, // 9: prodvana.desired_state.model.Metadata.protections:type_name -> prodvana.desired_state.model.ProtectionAttachment
	...
	44, // 12: prodvana.desired_state.model.ActionExplanation.ts:type_name -> google.protobuf.Timestamp
	5,  // 13: prodvana.desired_state.model.ActionExplanation.action_type:type_name -> prodvana.desired_state.model.ActionType
	44, // 14: prodvana.desired_state.model.Version.push_timestamp:type_name -> google.protobuf.Timestamp
	...
	45, // 26: prodvana.desired_state.model.CanaryProgressState.duration:type_name -> google.protobuf.Duration
	44, // 27: prodvana.desired_state.model.CanaryProgressState.pause_start_timestamp:type_name -> google.protobuf.Timestamp
	...
	34, // 48: prodvana.desired_state.model.State.protection_attachment:type_name -> prodvana.desired_state.model.ProtectionAttachment
	33, // 49: prodvana.desired_state.model.State.protection_link:type_name -> prodvana.desired_state.model.ProtectionLinkState
	41, // 50: prodvana.desired_state.model.Annotations.annotations:type_name -> prodvana.desired_state.model.Annotations.Annotation
	...
	44, // 52: prodvana.desired_state.model.CustomTaskExecutionState.latest_attempt_end_timestamp:type_name -> google.protobuf.Timestamp
	16, // 53: prodvana.desired_state.model.CustomTaskState.meta:type_name -> prodvana.desired_state.model.Metadata
	46, // 54: prodvana.desired_state.model.CustomTaskState.program:type_name -> prodvana.common_config.ProgramConfig
	31, // 55: prodvana.desired_state.model.CustomTaskState.task_state:type_name -> prodvana.desired_state.model.CustomTaskExecutionState
	47, // 56: prodvana.desired_state.model.CustomTaskState.retry_config:type_name -> prodvana.common_config.RetryConfig
	16, // 57: prodvana.desired_state.model.ProtectionLinkState.meta:type_name -> prodvana.desired_state.model.Metadata
	...
	9,  // 61: prodvana.desired_state.model.Signal.type:type_name -> prodvana.desired_state.model.SignalType
	42, // 62: prodvana.desired_state.model.Signal.delivery_promotion:type_name -> prodvana.desired_state.model.Signal.DeliveryPromotionConfig
	44, // 63: prodvana.desired_state.model.DebugLog.ts:type_name -> google.protobuf.Timestamp
	40, // 64: prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition.protection:type_name -> prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition.Protection
	1,  // 65: prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition.Protection.task_type:type_name -> prodvana.desired_state.model.CustomTaskType
