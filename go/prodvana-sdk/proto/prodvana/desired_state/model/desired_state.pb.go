...
var file_prodvana_desired_state_model_desired_state_proto_rawDesc = []byte{
	...
	0x43, 0x4b, 0x5f, 0x45, 0x4e, 0x54, 0x49, 0x54, 0x59, 0x10, 0x09, 0x2a, 0x96, 0x01, 0x0a, 0x0f,
	...
	0x4b, 0x5f, 0x54, 0x49, 0x4d, 0x45, 0x44, 0x5f, 0x4f, 0x55, 0x54, 0x10, 0x03, 0x2a, 0x38, 0x0a,
...
var file_prodvana_desired_state_model_desired_state_proto_msgTypes = make([]protoimpl.MessageInfo, 26)
var file_prodvana_desired_state_model_desired_state_proto_goTypes = []interface{}{
	...
	(*DebugLog)(nil),                                // 30: prodvana.desired_state.model.DebugLog
	(*Condition_ReleaseChannelStableCondition)(nil), // 31: prodvana.desired_state.model.Condition.ReleaseChannelStableCondition
	(*Condition_ManualApproval)(nil),                // 32: prodvana.desired_state.model.Condition.ManualApproval
	(*Condition_CustomTaskSuccessfulCondition)(nil), // 33: prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition
	(*Condition_CustomTaskSuccessfulCondition_Protection)(nil), // 34: prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition.Protection
	(*Annotations_Annotation)(nil),                             // 35: prodvana.desired_state.model.Annotations.Annotation
	(*Signal_DeliveryPromotionConfig)(nil),                     // 36: prodvana.desired_state.model.Signal.DeliveryPromotionConfig
...
var file_prodvana_desired_state_model_desired_state_proto_depIdxs = []int32{
	31, // 0: prodvana.desired_state.model.Condition.rc_cond:type_name -> prodvana.desired_state.model.Condition.ReleaseChannelStableCondition
	32, // 1: prodvana.desired_state.model.Condition.manual_approval:type_name -> prodvana.desired_state.model.Condition.ManualApproval
	33, // 2: prodvana.desired_state.model.Condition.custom_task:type_name -> prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition
	...
	37, // 9: prodvana.desired_state.model.Version.push_timestamp:type_name -> google.protobuf.Timestamp
	...
	38, // 21: prodvana.desired_state.model.CanaryProgressState.duration:type_name -> google.protobuf.Duration
	37, // 22: prodvana.desired_state.model.CanaryProgressState.pause_start_timestamp:type_name -> google.protobuf.Timestamp
	...
	35, // 39: prodvana.desired_state.model.Annotations.annotations:type_name -> prodvana.desired_state.model.Annotations.Annotation
	...
	37, // 41: prodvana.desired_state.model.CustomTaskExecutionState.latest_attempt_end_timestamp:type_name -> google.protobuf.Timestamp
	13, // 42: prodvana.desired_state.model.CustomTaskState.meta:type_name -> prodvana.desired_state.model.Metadata
	39, // 43: prodvana.desired_state.model.CustomTaskState.program:type_name -> prodvana.common_config.ProgramConfig
	...
	40, // 45: prodvana.desired_state.model.CustomTaskState.retry_config:type_name -> prodvana.common_config.RetryConfig
	7,  // 46: prodvana.desired_state.model.Signal.type:type_name -> prodvana.desired_state.model.SignalType
	36, // 47: prodvana.desired_state.model.Signal.delivery_promotion:type_name -> prodvana.desired_state.model.Signal.DeliveryPromotionConfig
	37, // 48: prodvana.desired_state.model.DebugLog.ts:type_name -> google.protobuf.Timestamp
	34, // 49: prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition.protection:type_name -> prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition.Protection
	1,  // 50: prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition.Protection.task_type:type_name -> prodvana.desired_state.model.CustomTaskType
