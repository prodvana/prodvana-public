...
var file_prodvana_desired_state_model_desired_state_proto_rawDesc = []byte{
	...
	0x09, 0x66, 0x65, 0x74, 0x63, 0x68, 0x4d, 0x6f, 0x64, 0x65, 0x22, 0xb6, 0x08, 0x0a, 0x07, 0x54,
	...
	0x6e, 0x73, 0x12, 0x47, 0x0a, 0x11, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x5f, 0x74, 0x69,
	...
	0x53, 0x74, 0x61, 0x72, 0x74, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x22, 0x25, 0x0a, 0x05,
	...
	0x44, 0x10, 0x01, 0x22, 0xfd, 0x01, 0x0a, 0x11, 0x54, 0x61, 0x73, 0x6b, 0x45, 0x6e, 0x74, 0x69,
	...
	0x01, 0x28, 0x08, 0x52, 0x08, 0x69, 0x73, 0x41, 0x63, 0x74, 0x69, 0x76, 0x65, 0x4a, 0x04, 0x08,
	0x04, 0x10, 0x05, 0x4a, 0x04, 0x08, 0x05, 0x10, 0x06, 0x52, 0x10, 0x6d, 0x69, 0x73, 0x73, 0x69,
...
var file_prodvana_desired_state_model_desired_state_proto_depIdxs = []int32{
	...
	76,  // 134: prodvana.desired_state.model.TaskRun.created_timestamp:type_name -> google.protobuf.Timestamp
	76,  // 135: prodvana.desired_state.model.TaskRun.started_timestamp:type_name -> google.protobuf.Timestamp
	76,  // 136: prodvana.desired_state.model.TaskRun.completed_timestamp:type_name -> google.protobuf.Timestamp
	23,  // 137: prodvana.desired_state.model.TaskRun.task_entities:type_name -> prodvana.desired_state.model.Identifier
	18,  // 138: prodvana.desired_state.model.TaskRun.phase:type_name -> prodvana.desired_state.model.TaskRun.Phase
	34,  // 139: prodvana.desired_state.model.TaskRun.fetch_details:type_name -> prodvana.desired_state.model.FetchDetails
	59,  // 140: prodvana.desired_state.model.TaskRun.fetch_task_start_details:type_name -> prodvana.desired_state.model.FetchTaskStartDetails
	60,  // 141: prodvana.desired_state.model.TaskEntityContext.last_completed_run:type_name -> prodvana.desired_state.model.TaskRun
	60,  // 142: prodvana.desired_state.model.TaskEntityContext.last_run:type_name -> prodvana.desired_state.model.TaskRun
	66,  // 143: prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition.protection:type_name -> prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition.Protection
	1,   // 144: prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition.Protection.task_type:type_name -> prodvana.desired_state.model.CustomTaskType
	83,  // 145: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.apply:type_name -> prodvana.environment.CompiledExtensionCommand
	83,  // 146: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.fetch:type_name -> prodvana.environment.CompiledExtensionCommand
	83,  // 147: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.get_info:type_name -> prodvana.environment.CompiledExtensionCommand
	75,  // 148: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.fetch_interval:type_name -> google.protobuf.Duration
	75,  // 149: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.fetch_steady_state_interval:type_name -> google.protobuf.Duration
	75,  // 150: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.get_info_interval:type_name -> google.protobuf.Duration
	84,  // 151: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.parameters:type_name -> prodvana.common_config.ParameterDefinition
	85,  // 152: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.parameter_values:type_name -> prodvana.common_config.ParameterValue
	86,  // 153: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.type:type_name -> prodvana.environment.ExtensionType
	35,  // 154: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.fetch_output:type_name -> prodvana.desired_state.model.RuntimeExtensionFetchOutput
	38,  // 155: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.get_info_output:type_name -> prodvana.desired_state.model.RuntimeExtensionGetInfoOutput
	40,  // 156: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.apply_output:type_name -> prodvana.desired_state.model.RuntimeExtensionApplyOutput
	87,  // 157: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.fetch_retry_policy:type_name -> prodvana.environment.RetryPolicy
	87,  // 158: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.apply_retry_policy:type_name -> prodvana.environment.RetryPolicy
	87,  // 159: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.get_info_retry_policy:type_name -> prodvana.environment.RetryPolicy
	77,  // 160: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.fetch_mode:type_name -> prodvana.runtimes.extensions.FetchMode
	76,  // 161: prodvana.desired_state.model.Signal.RuntimeExtensionApproval.timestamp:type_name -> google.protobuf.Timestamp
	9,   // 162: prodvana.desired_state.model.ApplyConditionUnsatisfied.InternalMissingApproval.signal_type:type_name -> prodvana.desired_state.model.SignalType
	55,  // 163: prodvana.desired_state.model.ApplyConditionUnsatisfied.InternalMissingApproval.runtime_extension:type_name -> prodvana.desired_state.model.RuntimeExtensionMetadata
