...
type Protection struct {
	...
	Ref       *protection.ProtectionReference `protobuf:"bytes,1,opt,name=ref,proto3" json:"ref,omitempty"`
	Lifecycle CustomTaskType                  `protobuf:"varint,2,opt,name=lifecycle,proto3,enum=prodvana.desired_state.model.CustomTaskType" json:"lifecycle,omitempty"`
	// Types that are assignable to Strategy:
	//
	//	*Protection_MustNotFail_
	//	*Protection_MustSucceedOnce_
	Strategy isProtection_Strategy `protobuf_oneof:"strategy"`
}
...
func (x *Protection) GetRef() *protection.ProtectionReference {
	if x != nil {
		return x.Ref
	}
	return nil
...
func (x *Protection) GetLifecycle() CustomTaskType {
	if x != nil {
		return x.Lifecycle
	}
...
func (m *Protection) GetStrategy() isProtection_Strategy {
	if m != nil {
		return m.Strategy
	}
	return nil
...
func (x *Protection) GetMustNotFail() *Protection_MustNotFail {
	if x, ok := x.GetStrategy().(*Protection_MustNotFail_); ok {
		return x.MustNotFail
	}
	return nil
}

func (x *Protection) GetMustSucceedOnce() *Protection_MustSucceedOnce {
	if x, ok := x.GetStrategy().(*Protection_MustSucceedOnce_); ok {
		return x.MustSucceedOnce
	}
	return nil
}

type isProtection_Strategy interface {
	isProtection_Strategy()
}

type Protection_MustNotFail_ struct {
	MustNotFail *Protection_MustNotFail `protobuf:"bytes,3,opt,name=must_not_fail,json=mustNotFail,proto3,oneof"`
}

type Protection_MustSucceedOnce_ struct {
	MustSucceedOnce *Protection_MustSucceedOnce `protobuf:"bytes,4,opt,name=must_succeed_once,json=mustSucceedOnce,proto3,oneof"`
}

func (*Protection_MustNotFail_) isProtection_Strategy() {}

func (*Protection_MustSucceedOnce_) isProtection_Strategy() {}
...
type Metadata struct {
	...
	Protections        []*Protection `protobuf:"bytes,6,rep,name=protections,proto3" json:"protections,omitempty"`
}
...
func (x *Metadata) GetProtections() []*Protection {
	if x != nil {
...
type Version struct {
	...
	UnhealthyReasons  []string               `protobuf:"bytes,7,rep,name=unhealthy_reasons,json=unhealthyReasons,proto3" json:"unhealthy_reasons,omitempty"` // if unhealthy is true, this will contain at least one message
...
func (x *Version) GetUnhealthyReasons() []string {
	if x != nil {
...
type Protection_MustNotFail struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// How long after the lifecycle begins should we start checking status?
	...
	// If underlying protection returns failure, treat it as pending instead of failed (keep trying again).
	SoftFail bool `protobuf:"varint,3,opt,name=soft_fail,json=softFail,proto3" json:"soft_fail,omitempty"`
}

func (x *Protection_MustNotFail) Reset() {
	*x = Protection_MustNotFail{}
	if protoimpl.UnsafeEnabled {
...
func (x *Protection_MustNotFail) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Protection_MustNotFail) ProtoMessage() {}

func (x *Protection_MustNotFail) ProtoReflect() protoreflect.Message {
	mi := &file_prodvana_desired_state_model_desired_state_proto_msgTypes[22]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Protection_MustNotFail.ProtoReflect.Descriptor instead.
func (*Protection_MustNotFail) Descriptor() ([]byte, []int) {
	return file_prodvana_desired_state_model_desired_state_proto_rawDescGZIP(), []int{0, 0}
}

func (x *Protection_MustNotFail) GetDelayCheckDuration() *durationpb.Duration {
	if x != nil {
...
func (x *Protection_MustNotFail) GetCheckDuration() *durationpb.Duration {
	if x != nil {
...
func (x *Protection_MustNotFail) GetSoftFail() bool {
	if x != nil {
		return x.SoftFail
	}
	return false
...
type Protection_MustSucceedOnce struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Deadline after starting when we declare this protection failed/timed out.
	Deadline *durationpb.Duration `protobuf:"bytes,1,opt,name=deadline,proto3" json:"deadline,omitempty"`
}

func (x *Protection_MustSucceedOnce) Reset() {
	*x = Protection_MustSucceedOnce{}
	if protoimpl.UnsafeEnabled {
...
func (x *Protection_MustSucceedOnce) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Protection_MustSucceedOnce) ProtoMessage() {}

func (x *Protection_MustSucceedOnce) ProtoReflect() protoreflect.Message {
	mi := &file_prodvana_desired_state_model_desired_state_proto_msgTypes[23]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Protection_MustSucceedOnce.ProtoReflect.Descriptor instead.
func (*Protection_MustSucceedOnce) Descriptor() ([]byte, []int) {
	return file_prodvana_desired_state_model_desired_state_proto_rawDescGZIP(), []int{0, 1}
}

func (x *Protection_MustSucceedOnce) GetDeadline() *durationpb.Duration {
	if x != nil {
		return x.Deadline
	}
	return nil
...
var file_prodvana_desired_state_model_desired_state_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xef, 0x04, 0x0a, 0x0a, 0x50, 0x72, 0x6f, 0x74, 0x65, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x12, 0x3a, 0x0a, 0x03, 0x72, 0x65, 0x66, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	...
	0x6e, 0x52, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x52, 0x03, 0x72, 0x65, 0x66, 0x12,
	0x4a, 0x0a, 0x09, 0x6c, 0x69, 0x66, 0x65, 0x63, 0x79, 0x63, 0x6c, 0x65, 0x18, 0x02, 0x20, 0x01,
	...
	,
	...
	0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x4d, 0x61, 0x6e, 0x75, 0x61, 0x6c, 0x41,
	0x70, 0x70, 0x72, 0x6f, 0x76, 0x61, 0x6c, 0x48, 0x00, 0x52, 0x0e, 0x6d, 0x61, 0x6e, 0x75, 0x61,
	0x6c, 0x41, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x61, 0x6c, 0x12, 0x68, 0x0a, 0x0b, 0x63, 0x75, 0x73,
	0x74, 0x6f, 0x6d, 0x5f, 0x74, 0x61, 0x73, 0x6b, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x45,
	...
	0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x54, 0x61,
	0x73, 0x6b, 0x53, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x66, 0x75, 0x6c, 0x43, 0x6f, 0x6e, 0x64,
	0x69, 0x74, 0x69, 0x6f, 0x6e, 0x48, 0x00, 0x52, 0x0a, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x54,
	0x61, 0x73, 0x6b, 0x12, 0x28, 0x0a, 0x10, 0x64, 0x65, 0x73, 0x69, 0x72, 0x65, 0x64, 0x5f, 0x73,
	0x74, 0x61, 0x74, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x64,
	0x65, 0x73, 0x69, 0x72, 0x65, 0x64, 0x53, 0x74, 0x61, 0x74, 0x65, 0x49, 0x64, 0x1a, 0xfa, 0x01,
	0x0a, 0x1d, 0x52, 0x65, 0x6c, 0x65, 0x61, 0x73, 0x65, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c,
	...
	0x69, 0x63, 0x65, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x1a, 0x26, 0x0a, 0x0e, 0x4d, 0x61,
	0x6e, 0x75, 0x61, 0x6c, 0x41, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x61, 0x6c, 0x12, 0x14, 0x0a, 0x05,
	0x74, 0x6f, 0x70, 0x69, 0x63, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x70,
	0x69, 0x63, 0x1a, 0xb4, 0x02, 0x0a, 0x1d, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x54, 0x61, 0x73,
	...
	,
	...
	0x64, 0x65, 0x6c, 0x2e, 0x43, 0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x0d, 0x70,
	0x72, 0x65, 0x63, 0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x47, 0x0a, 0x0a,
	0x69, 0x6e, 0x76, 0x61, 0x72, 0x69, 0x61, 0x6e, 0x74, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b,
	...
	0x43, 0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x0a, 0x69, 0x6e, 0x76, 0x61, 0x72,
	0x69, 0x61, 0x6e, 0x74, 0x73, 0x12, 0x3c, 0x0a, 0x04, 0x73, 0x65, 0x6c, 0x66, 0x18, 0x03, 0x20,
	...
	0x65, 0x6c, 0x2e, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x52, 0x04, 0x73,
	0x65, 0x6c, 0x66, 0x12, 0x28, 0x0a, 0x10, 0x64, 0x65, 0x73, 0x69, 0x72, 0x65, 0x64, 0x5f, 0x73,
	0x74, 0x61, 0x74, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x64,
	...
	0x61, 0x74, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x12, 0x72, 0x6f,
	0x6f, 0x74, 0x44, 0x65, 0x73, 0x69, 0x72, 0x65, 0x64, 0x53, 0x74, 0x61, 0x74, 0x65, 0x49, 0x64,
	0x12, 0x4a, 0x0a, 0x0b, 0x70, 0x72, 0x6f, 0x74, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18,
	0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x70, 0x72, 0x6f, 0x64, 0x76, 0x61, 0x6e, 0x61,
	0x2e, 0x64, 0x65, 0x73, 0x69, 0x72, 0x65, 0x64, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x2e, 0x6d,
	0x6f, 0x64, 0x65, 0x6c, 0x2e, 0x50, 0x72, 0x6f, 0x74, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52,
	...
	0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0xcc, 0x02, 0x0a, 0x07, 0x56, 0x65, 0x72, 0x73,
	0x69, 0x6f, 0x6e, 0x12, 0x27, 0x0a, 0x0f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x76,
	0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x73, 0x65,
	...
	0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x73, 0x12, 0x1c, 0x0a, 0x09, 0x75, 0x6e, 0x68, 0x65, 0x61,
	0x6c, 0x74, 0x68, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x09, 0x75, 0x6e, 0x68, 0x65,
	0x61, 0x6c, 0x74, 0x68, 0x79, 0x12, 0x2b, 0x0a, 0x11, 0x75, 0x6e, 0x68, 0x65, 0x61, 0x6c, 0x74,
	0x68, 0x79, 0x5f, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x73, 0x18, 0x07, 0x20, 0x03, 0x28, 0x09,
	0x52, 0x10, 0x75, 0x6e, 0x68, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x79, 0x52, 0x65, 0x61, 0x73, 0x6f,
	0x6e, 0x73, 0x12, 0x41, 0x0a, 0x0e, 0x70, 0x75, 0x73, 0x68, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x73,
	...
	0x70, 0x6c, 0x69, 0x63, 0x61, 0x73, 0x22, 0xfe, 0x03, 0x0a, 0x14, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x65, 0x6c, 0x69, 0x76, 0x65, 0x72, 0x79, 0x22, 0xdc, 0x02, 0x0a, 0x0c, 0x53, 0x65, 0x72, 0x76,
	...
	0x4a, 0x04, 0x08, 0x04, 0x10, 0x05, 0x22, 0xe9, 0x01, 0x0a, 0x11, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x6b, 0x73, 0x22, 0xdd, 0x02, 0x0a, 0x13, 0x43, 0x61, 0x6e, 0x61, 0x72, 0x79, 0x50, 0x72, 0x6f,
	...
	0x10, 0x03, 0x22, 0xdb, 0x03, 0x0a, 0x0d, 0x44, 0x65, 0x6c, 0x69, 0x76, 0x65, 0x72, 0x79, 0x53,
	...
	0x09, 0x52, 0x0a, 0x67, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x71, 0x0a,
	...
	0x22, 0xf4, 0x04, 0x0a, 0x0d, 0x52, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x4f, 0x62, 0x6a, 0x65,
	...
	0x6e, 0x6f, 0x73, 0x74, 0x69, 0x63, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x74, 0x61, 0x74, 0x65, 0x5f,
	0x68, 0x61, 0x73, 0x68, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x09, 0x73, 0x74, 0x61, 0x74,
	0x65, 0x48, 0x61, 0x73, 0x68, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	...
	0x02, 0x4a, 0x04, 0x08, 0x09, 0x10, 0x0a, 0x52, 0x0e, 0x75, 0x6e, 0x68, 0x65, 0x61, 0x6c, 0x74,
	0x68, 0x79, 0x5f, 0x70, 0x6f, 0x64, 0x73, 0x22, 0x57, 0x0a, 0x0e, 0x43, 0x6f, 0x6e, 0x64, 0x69,
	...
	0x74, 0x6f, 0x70, 0x69, 0x63, 0x22, 0x9d, 0x04, 0x0a, 0x05, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12,
	...
	0x6f, 0x6d, 0x54, 0x61, 0x73, 0x6b, 0x42, 0x0d, 0x0a, 0x0b, 0x73, 0x74, 0x61, 0x74, 0x65, 0x5f,
	...
	0x4a, 0x04, 0x08, 0x0b, 0x10, 0x0c, 0x22, 0x84, 0x02, 0x0a, 0x06, 0x53, 0x69, 0x67, 0x6e, 0x61,
	...
	0x69, 0x76, 0x65, 0x72, 0x79, 0x50, 0x72, 0x6f, 0x6d, 0x6f, 0x74, 0x69, 0x6f, 0x6e, 0x1a, 0x43,
	...
	0x75, 0x6c, 0x6c, 0x42, 0x08, 0x0a, 0x06, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0x48, 0x0a,
	...
	0x28, 0x09, 0x52, 0x03, 0x6c, 0x6f, 0x67, 0x2a, 0x83, 0x01, 0x0a, 0x04, 0x54, 0x79, 0x70, 0x65,
	...
	0x43, 0x55, 0x53, 0x54, 0x4f, 0x4d, 0x5f, 0x54, 0x41, 0x53, 0x4b, 0x10, 0x06, 0x2a, 0x8e, 0x01,
	...
	0x53, 0x54, 0x5f, 0x50, 0x55, 0x53, 0x48, 0x5f, 0x54, 0x41, 0x53, 0x4b, 0x10, 0x05, 0x2a, 0xdb,
	...
	0x4c, 0x4c, 0x45, 0x44, 0x5f, 0x42, 0x41, 0x43, 0x4b, 0x10, 0x05, 0x12, 0x0a, 0x0a, 0x06, 0x50,
	...
	0x0b, 0x0a, 0x07, 0x44, 0x45, 0x4c, 0x45, 0x54, 0x45, 0x44, 0x10, 0x0b, 0x2a, 0xec, 0x01, 0x0a,
	...
	0x03, 0x2a, 0x38, 0x0a, 0x0a, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x6c, 0x54, 0x79, 0x70, 0x65, 0x12,
	...
	0x50, 0x52, 0x4f, 0x4d, 0x4f, 0x54, 0x49, 0x4f, 0x4e, 0x10, 0x01, 0x42, 0x58, 0x5a, 0x56, 0x67,
...
var file_prodvana_desired_state_model_desired_state_proto_goTypes = []interface{}{
	...
	(*Protection)(nil),                              // 12: prodvana.desired_state.model.Protection
	(*Condition)(nil),                               // 13: prodvana.desired_state.model.Condition
	(*Identifier)(nil),                              // 14: prodvana.desired_state.model.Identifier
	(*Metadata)(nil),                                // 15: prodvana.desired_state.model.Metadata
	(*StatusExplanation)(nil),                       // 16: prodvana.desired_state.model.StatusExplanation
	(*ActionExplanation)(nil),                       // 17: prodvana.desired_state.model.ActionExplanation
	(*Version)(nil),                                 // 18: prodvana.desired_state.model.Version
	(*ServiceInstanceState)(nil),                    // 19: prodvana.desired_state.model.ServiceInstanceState
	(*ServiceState)(nil),                            // 20: prodvana.desired_state.model.ServiceState
	(*ServiceGroupState)(nil),                       // 21: prodvana.desired_state.model.ServiceGroupState
	(*CanaryProgressState)(nil),                     // 22: prodvana.desired_state.model.CanaryProgressState
	(*DeliveryState)(nil),                           // 23: prodvana.desired_state.model.DeliveryState
	(*RuntimeObject)(nil),                           // 24: prodvana.desired_state.model.RuntimeObject
	(*ConditionState)(nil),                          // 25: prodvana.desired_state.model.ConditionState
	(*ControlState)(nil),                            // 26: prodvana.desired_state.model.ControlState
	(*ManualApprovalState)(nil),                     // 27: prodvana.desired_state.model.ManualApprovalState
	(*State)(nil),                                   // 28: prodvana.desired_state.model.State
	(*Annotations)(nil),                             // 29: prodvana.desired_state.model.Annotations
	(*CustomTaskExecutionState)(nil),                // 30: prodvana.desired_state.model.CustomTaskExecutionState
	(*CustomTaskState)(nil),                         // 31: prodvana.desired_state.model.CustomTaskState
	(*Signal)(nil),                                  // 32: prodvana.desired_state.model.Signal
	(*DebugLog)(nil),                                // 33: prodvana.desired_state.model.DebugLog
	(*Protection_MustNotFail)(nil),                  // 34: prodvana.desired_state.model.Protection.MustNotFail
	(*Protection_MustSucceedOnce)(nil),              // 35: prodvana.desired_state.model.Protection.MustSucceedOnce
	(*Condition_ReleaseChannelStableCondition)(nil), // 36: prodvana.desired_state.model.Condition.ReleaseChannelStableCondition
	(*Condition_ManualApproval)(nil),                // 37: prodvana.desired_state.model.Condition.ManualApproval
	(*Condition_CustomTaskSuccessfulCondition)(nil), // 38: prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition
	(*Condition_CustomTaskSuccessfulCondition_Protection)(nil), // 39: prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition.Protection
	(*Annotations_Annotation)(nil),                             // 40: prodvana.desired_state.model.Annotations.Annotation
	(*Signal_DeliveryPromotionConfig)(nil),                     // 41: prodvana.desired_state.model.Signal.DeliveryPromotionConfig
...
var file_prodvana_desired_state_model_desired_state_proto_depIdxs = []int32{
	42, // 0: prodvana.desired_state.model.Protection.ref:type_name -> prodvana.protection.ProtectionReference
	1,  // 1: prodvana.desired_state.model.Protection.lifecycle:type_name -> prodvana.desired_state.model.CustomTaskType
	34, // 2: prodvana.desired_state.model.Protection.must_not_fail:type_name -> prodvana.desired_state.model.Protection.MustNotFail
	35, // 3: prodvana.desired_state.model.Protection.must_succeed_once:type_name -> prodvana.desired_state.model.Protection.MustSucceedOnce
	36, // 4: prodvana.desired_state.model.Condition.rc_cond:type_name -> prodvana.desired_state.model.Condition.ReleaseChannelStableCondition
	37, // 5: prodvana.desired_state.model.Condition.manual_approval:type_name -> prodvana.desired_state.model.Condition.ManualApproval
	38, // 6: prodvana.desired_state.model.Condition.custom_task:type_name -> prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition
	0,  // 7: prodvana.desired_state.model.Identifier.type:type_name -> prodvana.desired_state.model.Type
	13, // 8: prodvana.desired_state.model.Metadata.preconditions:type_name -> prodvana.desired_state.model.Condition
	13, // 9: prodvana.desired_state.model.Metadata.invariants:type_name -> prodvana.desired_state.model.Condition
	14, // 10: prodvana.desired_state.model.Metadata.self:type_name -> prodvana.desired_state.model.Identifier
	12, // 11: prodvana.desired_state.model.Metadata.protections:type_name -> prodvana.desired_state.model.Protection
	14, // 12: prodvana.desired_state.model.StatusExplanation.subject:type_name -> prodvana.desired_state.model.Identifier
	3,  // 13: prodvana.desired_state.model.StatusExplanation.reason:type_name -> prodvana.desired_state.model.StatusReason
	43, // 14: prodvana.desired_state.model.ActionExplanation.ts:type_name -> google.protobuf.Timestamp
	4,  // 15: prodvana.desired_state.model.ActionExplanation.action_type:type_name -> prodvana.desired_state.model.ActionType
	43, // 16: prodvana.desired_state.model.Version.push_timestamp:type_name -> google.protobuf.Timestamp
	15, // 17: prodvana.desired_state.model.ServiceInstanceState.meta:type_name -> prodvana.desired_state.model.Metadata
	18, // 18: prodvana.desired_state.model.ServiceInstanceState.versions:type_name -> prodvana.desired_state.model.Version
	18, // 19: prodvana.desired_state.model.ServiceInstanceState.rollback_version:type_name -> prodvana.desired_state.model.Version
	23, // 20: prodvana.desired_state.model.ServiceInstanceState.delivery:type_name -> prodvana.desired_state.model.DeliveryState
	15, // 21: prodvana.desired_state.model.ServiceState.meta:type_name -> prodvana.desired_state.model.Metadata
	19, // 22: prodvana.desired_state.model.ServiceState.release_channels:type_name -> prodvana.desired_state.model.ServiceInstanceState
	31, // 23: prodvana.desired_state.model.ServiceState.custom_tasks:type_name -> prodvana.desired_state.model.CustomTaskState
	15, // 24: prodvana.desired_state.model.ServiceGroupState.meta:type_name -> prodvana.desired_state.model.Metadata
	20, // 25: prodvana.desired_state.model.ServiceGroupState.services:type_name -> prodvana.desired_state.model.ServiceState
	31, // 26: prodvana.desired_state.model.ServiceGroupState.custom_tasks:type_name -> prodvana.desired_state.model.CustomTaskState
	9,  // 27: prodvana.desired_state.model.CanaryProgressState.status:type_name -> prodvana.desired_state.model.CanaryProgressState.Status
	44, // 28: prodvana.desired_state.model.CanaryProgressState.duration:type_name -> google.protobuf.Duration
	43, // 29: prodvana.desired_state.model.CanaryProgressState.pause_start_timestamp:type_name -> google.protobuf.Timestamp
	10, // 30: prodvana.desired_state.model.DeliveryState.status:type_name -> prodvana.desired_state.model.DeliveryState.Status
	22, // 31: prodvana.desired_state.model.DeliveryState.canary_progress:type_name -> prodvana.desired_state.model.CanaryProgressState
	15, // 32: prodvana.desired_state.model.RuntimeObject.meta:type_name -> prodvana.desired_state.model.Metadata
	18, // 33: prodvana.desired_state.model.RuntimeObject.versions:type_name -> prodvana.desired_state.model.Version
	11, // 34: prodvana.desired_state.model.RuntimeObject.status:type_name -> prodvana.desired_state.model.RuntimeObject.Status
	18, // 35: prodvana.desired_state.model.RuntimeObject.rollback_version:type_name -> prodvana.desired_state.model.Version
	23, // 36: prodvana.desired_state.model.RuntimeObject.delivery:type_name -> prodvana.desired_state.model.DeliveryState
	5,  // 37: prodvana.desired_state.model.ConditionState.status:type_name -> prodvana.desired_state.model.ConditionStatus
	25, // 38: prodvana.desired_state.model.ControlState.precondition_states:type_name -> prodvana.desired_state.model.ConditionState
	25, // 39: prodvana.desired_state.model.ControlState.invariant_states:type_name -> prodvana.desired_state.model.ConditionState
	16, // 40: prodvana.desired_state.model.ControlState.status_explanations:type_name -> prodvana.desired_state.model.StatusExplanation
	17, // 41: prodvana.desired_state.model.ControlState.action_explanation:type_name -> prodvana.desired_state.model.ActionExplanation
	15, // 42: prodvana.desired_state.model.ManualApprovalState.meta:type_name -> prodvana.desired_state.model.Metadata
	6,  // 43: prodvana.desired_state.model.ManualApprovalState.status:type_name -> prodvana.desired_state.model.ManualApprovalStatus
	20, // 44: prodvana.desired_state.model.State.service:type_name -> prodvana.desired_state.model.ServiceState
	19, // 45: prodvana.desired_state.model.State.service_instance:type_name -> prodvana.desired_state.model.ServiceInstanceState
	21, // 46: prodvana.desired_state.model.State.service_group:type_name -> prodvana.desired_state.model.ServiceGroupState
	24, // 47: prodvana.desired_state.model.State.runtime_object:type_name -> prodvana.desired_state.model.RuntimeObject
	27, // 48: prodvana.desired_state.model.State.manual_approval:type_name -> prodvana.desired_state.model.ManualApprovalState
	31, // 49: prodvana.desired_state.model.State.custom_task:type_name -> prodvana.desired_state.model.CustomTaskState
	40, // 50: prodvana.desired_state.model.Annotations.annotations:type_name -> prodvana.desired_state.model.Annotations.Annotation
	7,  // 51: prodvana.desired_state.model.CustomTaskExecutionState.status:type_name -> prodvana.desired_state.model.CustomTaskStatus
	43, // 52: prodvana.desired_state.model.CustomTaskExecutionState.latest_attempt_end_timestamp:type_name -> google.protobuf.Timestamp
	15, // 53: prodvana.desired_state.model.CustomTaskState.meta:type_name -> prodvana.desired_state.model.Metadata
	45, // 54: prodvana.desired_state.model.CustomTaskState.program:type_name -> prodvana.common_config.ProgramConfig
	30, // 55: prodvana.desired_state.model.CustomTaskState.task_state:type_name -> prodvana.desired_state.model.CustomTaskExecutionState
	46, // 56: prodvana.desired_state.model.CustomTaskState.retry_config:type_name -> prodvana.common_config.RetryConfig
	8,  // 57: prodvana.desired_state.model.Signal.type:type_name -> prodvana.desired_state.model.SignalType
	41, // 58: prodvana.desired_state.model.Signal.delivery_promotion:type_name -> prodvana.desired_state.model.Signal.DeliveryPromotionConfig
	43, // 59: prodvana.desired_state.model.DebugLog.ts:type_name -> google.protobuf.Timestamp
	44, // 60: prodvana.desired_state.model.Protection.MustNotFail.delay_check_duration:type_name -> google.protobuf.Duration
	44, // 61: prodvana.desired_state.model.Protection.MustNotFail.check_duration:type_name -> google.protobuf.Duration
	44, // 62: prodvana.desired_state.model.Protection.MustSucceedOnce.deadline:type_name -> google.protobuf.Duration
	39, // 63: prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition.protection:type_name -> prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition.Protection
	1,  // 64: prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition.Protection.task_type:type_name -> prodvana.desired_state.model.CustomTaskType
...
func file_prodvana_desired_state_model_desired_state_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_prodvana_desired_state_model_desired_state_proto_msgTypes[22].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Protection_MustNotFail); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_prodvana_desired_state_model_desired_state_proto_msgTypes[23].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Protection_MustSucceedOnce); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_prodvana_desired_state_model_desired_state_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*Protection_MustNotFail_)(nil),
		(*Protection_MustSucceedOnce_)(nil),
	}
	...
	file_prodvana_desired_state_model_desired_state_proto_msgTypes[20].OneofWrappers = []interface{}{
