...
func (CanaryProgressState_Status) EnumDescriptor() ([]byte, []int) {
	return file_prodvana_desired_state_model_desired_state_proto_rawDescGZIP(), []int{8, 0}
}
...
var file_prodvana_desired_state_model_desired_state_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0xc7, 0x01, 0x0a, 0x07, 0x56, 0x65, 0x72, 0x73, 0x69,
	0x6f, 0x6e, 0x12, 0x27, 0x0a, 0x0f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x76, 0x65,
	0x72, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x73, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x1a, 0x0a, 0x08, 0x72,
	...
	0x61, 0x6c, 0x74, 0x68, 0x79, 0x12, 0x41, 0x0a, 0x0e, 0x70, 0x75, 0x73, 0x68, 0x5f, 0x74, 0x69,
	...
	0x75, 0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0xdc, 0x02, 0x0a, 0x0c, 0x43,
	...
	0x6c, 0x61, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0xb3, 0x01, 0x0a, 0x13, 0x4d, 0x61,
	...
	0x67, 0x2a, 0x83, 0x01, 0x0a, 0x04, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0b, 0x0a, 0x07, 0x55, 0x4e,
	...
	0x5f, 0x54, 0x41, 0x53, 0x4b, 0x10, 0x06, 0x2a, 0x6b, 0x0a, 0x0e, 0x43, 0x75, 0x73, 0x74, 0x6f,
	...
	0x53, 0x4b, 0x10, 0x03, 0x2a, 0xdb, 0x01, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12,
	...
	0x05, 0x12, 0x0a, 0x0a, 0x06, 0x50, 0x41, 0x55, 0x53, 0x45, 0x44, 0x10, 0x06, 0x12, 0x10, 0x0a,
	...
	0x10, 0x0b, 0x2a, 0xda, 0x01, 0x0a, 0x0c, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x61,
	...
	0x4f, 0x56, 0x41, 0x4c, 0x5f, 0x52, 0x45, 0x4a, 0x45, 0x43, 0x54, 0x45, 0x44, 0x10, 0x08, 0x2a,
...
var file_prodvana_desired_state_model_desired_state_proto_enumTypes = make([]protoimpl.EnumInfo, 11)
var file_prodvana_desired_state_model_desired_state_proto_msgTypes = make([]protoimpl.MessageInfo, 25)
var file_prodvana_desired_state_model_desired_state_proto_goTypes = []interface{}{
	...
	(ConditionStatus)(0),                            // 4: prodvana.desired_state.model.ConditionStatus
	(ManualApprovalStatus)(0),                       // 5: prodvana.desired_state.model.ManualApprovalStatus
	(CustomTaskStatus)(0),                           // 6: prodvana.desired_state.model.CustomTaskStatus
	...
	(DeliveryState_Status)(0),                       // 9: prodvana.desired_state.model.DeliveryState.Status
	(RuntimeObject_Status)(0),                       // 10: prodvana.desired_state.model.RuntimeObject.Status
	(*Condition)(nil),                               // 11: prodvana.desired_state.model.Condition
	(*Identifier)(nil),                              // 12: prodvana.desired_state.model.Identifier
	(*Metadata)(nil),                                // 13: prodvana.desired_state.model.Metadata
	(*StatusExplanation)(nil),                       // 14: prodvana.desired_state.model.StatusExplanation
	(*Version)(nil),                                 // 15: prodvana.desired_state.model.Version
	(*ServiceInstanceState)(nil),                    // 16: prodvana.desired_state.model.ServiceInstanceState
	(*ServiceState)(nil),                            // 17: prodvana.desired_state.model.ServiceState
	(*ServiceGroupState)(nil),                       // 18: prodvana.desired_state.model.ServiceGroupState
	(*CanaryProgressState)(nil),                     // 19: prodvana.desired_state.model.CanaryProgressState
	(*DeliveryState)(nil),                           // 20: prodvana.desired_state.model.DeliveryState
	(*RuntimeObject)(nil),                           // 21: prodvana.desired_state.model.RuntimeObject
	(*ConditionState)(nil),                          // 22: prodvana.desired_state.model.ConditionState
	(*ControlState)(nil),                            // 23: prodvana.desired_state.model.ControlState
	(*ManualApprovalState)(nil),                     // 24: prodvana.desired_state.model.ManualApprovalState
	(*State)(nil),                                   // 25: prodvana.desired_state.model.State
	(*Annotations)(nil),                             // 26: prodvana.desired_state.model.Annotations
	(*CustomTaskExecutionState)(nil),                // 27: prodvana.desired_state.model.CustomTaskExecutionState
	(*CustomTaskState)(nil),                         // 28: prodvana.desired_state.model.CustomTaskState
	(*Signal)(nil),                                  // 29: prodvana.desired_state.model.Signal
	(*Condition_ReleaseChannelStableCondition)(nil), // 30: prodvana.desired_state.model.Condition.ReleaseChannelStableCondition
	(*Condition_ManualApproval)(nil),                // 31: prodvana.desired_state.model.Condition.ManualApproval
	(*Condition_CustomTaskSuccessfulCondition)(nil), // 32: prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition
	(*Condition_CustomTaskSuccessfulCondition_Protection)(nil), // 33: prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition.Protection
	(*Annotations_Annotation)(nil),                             // 34: prodvana.desired_state.model.Annotations.Annotation
	(*Signal_DeliveryPromotionConfig)(nil),                     // 35: prodvana.desired_state.model.Signal.DeliveryPromotionConfig
...
var file_prodvana_desired_state_model_desired_state_proto_depIdxs = []int32{
	30, // 0: prodvana.desired_state.model.Condition.rc_cond:type_name -> prodvana.desired_state.model.Condition.ReleaseChannelStableCondition
	31, // 1: prodvana.desired_state.model.Condition.manual_approval:type_name -> prodvana.desired_state.model.Condition.ManualApproval
	32, // 2: prodvana.desired_state.model.Condition.custom_task:type_name -> prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition
	0,  // 3: prodvana.desired_state.model.Identifier.type:type_name -> prodvana.desired_state.model.Type
	11, // 4: prodvana.desired_state.model.Metadata.preconditions:type_name -> prodvana.desired_state.model.Condition
	11, // 5: prodvana.desired_state.model.Metadata.invariants:type_name -> prodvana.desired_state.model.Condition
	12, // 6: prodvana.desired_state.model.Metadata.self:type_name -> prodvana.desired_state.model.Identifier
	12, // 7: prodvana.desired_state.model.StatusExplanation.subject:type_name -> prodvana.desired_state.model.Identifier
	3,  // 8: prodvana.desired_state.model.StatusExplanation.reason:type_name -> prodvana.desired_state.model.StatusReason
	36, // 9: prodvana.desired_state.model.Version.push_timestamp:type_name -> google.protobuf.Timestamp
	13, // 10: prodvana.desired_state.model.ServiceInstanceState.meta:type_name -> prodvana.desired_state.model.Metadata
	15, // 11: prodvana.desired_state.model.ServiceInstanceState.versions:type_name -> prodvana.desired_state.model.Version
	15, // 12: prodvana.desired_state.model.ServiceInstanceState.rollback_version:type_name -> prodvana.desired_state.model.Version
	20, // 13: prodvana.desired_state.model.ServiceInstanceState.delivery:type_name -> prodvana.desired_state.model.DeliveryState
	13, // 14: prodvana.desired_state.model.ServiceState.meta:type_name -> prodvana.desired_state.model.Metadata
	16, // 15: prodvana.desired_state.model.ServiceState.release_channels:type_name -> prodvana.desired_state.model.ServiceInstanceState
	28, // 16: prodvana.desired_state.model.ServiceState.custom_tasks:type_name -> prodvana.desired_state.model.CustomTaskState
	13, // 17: prodvana.desired_state.model.ServiceGroupState.meta:type_name -> prodvana.desired_state.model.Metadata
	17, // 18: prodvana.desired_state.model.ServiceGroupState.services:type_name -> prodvana.desired_state.model.ServiceState
	28, // 19: prodvana.desired_state.model.ServiceGroupState.custom_tasks:type_name -> prodvana.desired_state.model.CustomTaskState
	8,  // 20: prodvana.desired_state.model.CanaryProgressState.status:type_name -> prodvana.desired_state.model.CanaryProgressState.Status
	37, // 21: prodvana.desired_state.model.CanaryProgressState.duration:type_name -> google.protobuf.Duration
	36, // 22: prodvana.desired_state.model.CanaryProgressState.pause_start_timestamp:type_name -> google.protobuf.Timestamp
	9,  // 23: prodvana.desired_state.model.DeliveryState.status:type_name -> prodvana.desired_state.model.DeliveryState.Status
	19, // 24: prodvana.desired_state.model.DeliveryState.canary_progress:type_name -> prodvana.desired_state.model.CanaryProgressState
	13, // 25: prodvana.desired_state.model.RuntimeObject.meta:type_name -> prodvana.desired_state.model.Metadata
	15, // 26: prodvana.desired_state.model.RuntimeObject.versions:type_name -> prodvana.desired_state.model.Version
	10, // 27: prodvana.desired_state.model.RuntimeObject.status:type_name -> prodvana.desired_state.model.RuntimeObject.Status
	15, // 28: prodvana.desired_state.model.RuntimeObject.rollback_version:type_name -> prodvana.desired_state.model.Version
	20, // 29: prodvana.desired_state.model.RuntimeObject.delivery:type_name -> prodvana.desired_state.model.DeliveryState
	4,  // 30: prodvana.desired_state.model.ConditionState.status:type_name -> prodvana.desired_state.model.ConditionStatus
	22, // 31: prodvana.desired_state.model.ControlState.precondition_states:type_name -> prodvana.desired_state.model.ConditionState
	22, // 32: prodvana.desired_state.model.ControlState.invariant_states:type_name -> prodvana.desired_state.model.ConditionState
	14, // 33: prodvana.desired_state.model.ControlState.status_explanations:type_name -> prodvana.desired_state.model.StatusExplanation
	13, // 34: prodvana.desired_state.model.ManualApprovalState.meta:type_name -> prodvana.desired_state.model.Metadata
	5,  // 35: prodvana.desired_state.model.ManualApprovalState.status:type_name -> prodvana.desired_state.model.ManualApprovalStatus
	17, // 36: prodvana.desired_state.model.State.service:type_name -> prodvana.desired_state.model.ServiceState
	16, // 37: prodvana.desired_state.model.State.service_instance:type_name -> prodvana.desired_state.model.ServiceInstanceState
	18, // 38: prodvana.desired_state.model.State.service_group:type_name -> prodvana.desired_state.model.ServiceGroupState
	34, // 39: prodvana.desired_state.model.Annotations.annotations:type_name -> prodvana.desired_state.model.Annotations.Annotation
	6,  // 40: prodvana.desired_state.model.CustomTaskExecutionState.status:type_name -> prodvana.desired_state.model.CustomTaskStatus
	36, // 41: prodvana.desired_state.model.CustomTaskExecutionState.latest_attempt_end_timestamp:type_name -> google.protobuf.Timestamp
	13, // 42: prodvana.desired_state.model.CustomTaskState.meta:type_name -> prodvana.desired_state.model.Metadata
	38, // 43: prodvana.desired_state.model.CustomTaskState.program:type_name -> prodvana.common_config.ProgramConfig
	27, // 44: prodvana.desired_state.model.CustomTaskState.task_state:type_name -> prodvana.desired_state.model.CustomTaskExecutionState
	39, // 45: prodvana.desired_state.model.CustomTaskState.retry_config:type_name -> prodvana.common_config.RetryConfig
	7,  // 46: prodvana.desired_state.model.Signal.type:type_name -> prodvana.desired_state.model.SignalType
	35, // 47: prodvana.desired_state.model.Signal.delivery_promotion:type_name -> prodvana.desired_state.model.Signal.DeliveryPromotionConfig
	33, // 48: prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition.protection:type_name -> prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition.Protection
	1,  // 49: prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition.Protection.task_type:type_name -> prodvana.desired_state.model.CustomTaskType
...
func file_prodvana_desired_state_model_desired_state_proto_init() {
	...
	file_prodvana_desired_state_model_desired_state_proto_msgTypes[14].OneofWrappers = []interface{}{
		(*State_Service)(nil),
