...
func (x *ProtectionAttachment) GetVersion() string {
	if x != nil {
		return x.Version
	}
	return ""
...
var file_prodvana_desired_state_model_desired_state_proto_rawDesc = []byte{
	...
	0x0b, 0x4a, 0x04, 0x08, 0x0b, 0x10, 0x0c, 0x22, 0x85, 0x02, 0x0a, 0x14, 0x50, 0x72, 0x6f, 0x74,
	...
	0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x52, 0x04, 0x6d, 0x65, 0x74, 0x61, 0x12, 0x18, 0x0a, 0x07,
	...
	0x12, 0x4d, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0xb3, 0x01, 0x0a, 0x19, 0x50, 0x72, 0x6f, 0x74, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x41, 0x74,
	0x74, 0x61, 0x63, 0x68, 0x6d, 0x65, 0x6e, 0x74, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x46, 0x0a,
	...
	0x09, 0x52, 0x03, 0x6c, 0x6f, 0x67, 0x2a, 0x9e, 0x01, 0x0a, 0x04, 0x54, 0x79, 0x70, 0x65, 0x12,
	...
	0x48, 0x4d, 0x45, 0x4e, 0x54, 0x10, 0x07, 0x2a, 0x8e, 0x01, 0x0a, 0x0e, 0x43, 0x75, 0x73, 0x74,
	...
	0x41, 0x53, 0x4b, 0x10, 0x03, 0x12, 0x0d, 0x0a, 0x09, 0x50, 0x55, 0x53, 0x48, 0x5f, 0x54, 0x41,
	0x53, 0x4b, 0x10, 0x04, 0x12, 0x12, 0x0a, 0x0e, 0x50, 0x4f, 0x53, 0x54, 0x5f, 0x50, 0x55, 0x53,
	0x48, 0x5f, 0x54, 0x41, 0x53, 0x4b, 0x10, 0x05, 0x2a, 0xdb, 0x01, 0x0a, 0x06, 0x53, 0x74, 0x61,
	...
	0x41, 0x43, 0x4b, 0x10, 0x05, 0x12, 0x0a, 0x0a, 0x06, 0x50, 0x41, 0x55, 0x53, 0x45, 0x44, 0x10,
	...
	0x45, 0x54, 0x45, 0x44, 0x10, 0x0b, 0x2a, 0xec, 0x01, 0x0a, 0x0c, 0x53, 0x74, 0x61, 0x74, 0x75,
	...
	0x54, 0x49, 0x4d, 0x45, 0x44, 0x5f, 0x4f, 0x55, 0x54, 0x10, 0x03, 0x2a, 0x5c, 0x0a, 0x10, 0x50,
	0x72, 0x6f, 0x74, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12,
	0x16, 0x0a, 0x12, 0x50, 0x52, 0x4f, 0x54, 0x45, 0x43, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x50, 0x45,
	0x4e, 0x44, 0x49, 0x4e, 0x47, 0x10, 0x00, 0x12, 0x19, 0x0a, 0x15, 0x50, 0x52, 0x4f, 0x54, 0x45,
	0x43, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x53, 0x55, 0x43, 0x43, 0x45, 0x53, 0x53, 0x46, 0x55, 0x4c,
	0x10, 0x01, 0x12, 0x15, 0x0a, 0x11, 0x50, 0x52, 0x4f, 0x54, 0x45, 0x43, 0x54, 0x49, 0x4f, 0x4e,
	0x5f, 0x46, 0x41, 0x49, 0x4c, 0x45, 0x44, 0x10, 0x02, 0x2a, 0x38, 0x0a, 0x0a, 0x53, 0x69, 0x67,
	...
	0x4e, 0x10, 0x01, 0x42, 0x58, 0x5a, 0x56, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_prodvana_desired_state_model_desired_state_proto_depIdxs = []int32{
	...
	34, // 60: prodvana.desired_state.model.ProtectionAttachment.state:type_name -> prodvana.desired_state.model.ProtectionAttachmentState
	8,  // 61: prodvana.desired_state.model.ProtectionAttachmentState.status:type_name -> prodvana.desired_state.model.ProtectionStatus
	45, // 62: prodvana.desired_state.model.ProtectionAttachmentState.last_update_timestamp:type_name -> google.protobuf.Timestamp
	9,  // 63: prodvana.desired_state.model.Signal.type:type_name -> prodvana.desired_state.model.SignalType
	42, // 64: prodvana.desired_state.model.Signal.delivery_promotion:type_name -> prodvana.desired_state.model.Signal.DeliveryPromotionConfig
	45, // 65: prodvana.desired_state.model.DebugLog.ts:type_name -> google.protobuf.Timestamp
	40, // 66: prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition.protection:type_name -> prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition.Protection
	1,  // 67: prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition.Protection.task_type:type_name -> prodvana.desired_state.model.CustomTaskType
