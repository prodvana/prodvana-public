...
type FetchDetails struct {
	...
	FetchMode extensions.FetchMode `protobuf:"varint,9,opt,name=fetch_mode,json=fetchMode,proto3,enum=prodvana.runtimes.extensions.FetchMode" json:"fetch_mode,omitempty"` // next tag: 13
}
...
var file_prodvana_desired_state_model_desired_state_proto_rawDesc = []byte{
	...
	0x0a, 0x4a, 0x04, 0x08, 0x0a, 0x10, 0x0b, 0x22, 0x91, 0x07, 0x0a, 0x0c, 0x46, 0x65, 0x74, 0x63,
	...
	0x74, 0x63, 0x68, 0x4d, 0x6f, 0x64, 0x65, 0x22, 0x42, 0x0a, 0x0b, 0x46, 0x65, 0x74, 0x63, 0x68,
	...
	0xff, 0x03, 0x0a, 0x0c, 0x41, 0x70, 0x70, 0x6c, 0x79, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73,
	...
	0x57, 0x6f, 0x72, 0x6b, 0x52, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x22, 0x44, 0x0a, 0x0b, 0x41, 0x70,
...
var file_prodvana_desired_state_model_desired_state_proto_depIdxs = []int32{
	...
	38,  // 49: prodvana.desired_state.model.RuntimeExtensionFetchOutput.ongoing_fetch:type_name -> prodvana.desired_state.model.FetchDetails
	38,  // 50: prodvana.desired_state.model.RuntimeExtensionFetchOutput.last_successful_fetch:type_name -> prodvana.desired_state.model.FetchDetails
	38,  // 51: prodvana.desired_state.model.RuntimeExtensionFetchOutput.last_failed_fetch:type_name -> prodvana.desired_state.model.FetchDetails
	40,  // 52: prodvana.desired_state.model.RuntimeExtensionGetInfoDetails.contents:type_name -> prodvana.desired_state.model.RuntimeExtensionGetInfoOutputContent
	14,  // 53: prodvana.desired_state.model.RuntimeExtensionGetInfoDetails.status:type_name -> prodvana.desired_state.model.RuntimeExtensionGetInfoDetails.Status
	86,  // 54: prodvana.desired_state.model.RuntimeExtensionGetInfoDetails.started_timestamp:type_name -> google.protobuf.Timestamp
	86,  // 55: prodvana.desired_state.model.RuntimeExtensionGetInfoDetails.completed_timestamp:type_name -> google.protobuf.Timestamp
	41,  // 56: prodvana.desired_state.model.RuntimeExtensionGetInfoOutput.get_info_details:type_name -> prodvana.desired_state.model.RuntimeExtensionGetInfoDetails
	86,  // 57: prodvana.desired_state.model.ApplyDetails.started_timestamp:type_name -> google.protobuf.Timestamp
	86,  // 58: prodvana.desired_state.model.ApplyDetails.completed_timestamp:type_name -> google.protobuf.Timestamp
	15,  // 59: prodvana.desired_state.model.ApplyDetails.apply_status:type_name -> prodvana.desired_state.model.ApplyDetails.ApplyStatus
	38,  // 60: prodvana.desired_state.model.ApplyDetails.fetch_details:type_name -> prodvana.desired_state.model.FetchDetails
	43,  // 61: prodvana.desired_state.model.RuntimeExtensionApplyOutput.ongoing_apply:type_name -> prodvana.desired_state.model.ApplyDetails
	43,  // 62: prodvana.desired_state.model.RuntimeExtensionApplyOutput.last_apply:type_name -> prodvana.desired_state.model.ApplyDetails
	27,  // 63: prodvana.desired_state.model.RuntimeObject.meta:type_name -> prodvana.desired_state.model.Metadata
	30,  // 64: prodvana.desired_state.model.RuntimeObject.versions:type_name -> prodvana.desired_state.model.Version
	30,  // 65: prodvana.desired_state.model.RuntimeObject.fetch_version:type_name -> prodvana.desired_state.model.Version
	16,  // 66: prodvana.desired_state.model.RuntimeObject.status:type_name -> prodvana.desired_state.model.RuntimeObject.Status
	30,  // 67: prodvana.desired_state.model.RuntimeObject.rollback_version:type_name -> prodvana.desired_state.model.Version
	37,  // 68: prodvana.desired_state.model.RuntimeObject.delivery:type_name -> prodvana.desired_state.model.DeliveryState
	89,  // 69: prodvana.desired_state.model.RuntimeObject.debug_events:type_name -> prodvana.runtimes.DebugEvent
	75,  // 70: prodvana.desired_state.model.RuntimeObject.runtime_extension:type_name -> prodvana.desired_state.model.RuntimeObject.RuntimeExtension
	85,  // 71: prodvana.desired_state.model.RuntimeObject.interval:type_name -> google.protobuf.Duration
	85,  // 72: prodvana.desired_state.model.RuntimeObject.steady_state_interval:type_name -> google.protobuf.Duration
	17,  // 73: prodvana.desired_state.model.RuntimeObject.management_status:type_name -> prodvana.desired_state.model.RuntimeObject.ManagementStatus
	68,  // 74: prodvana.desired_state.model.RuntimeObject.last_completed_task_run:type_name -> prodvana.desired_state.model.TaskRun
	90,  // 75: prodvana.desired_state.model.RuntimeObject.external_links:type_name -> prodvana.common_config.ExternalLink
	87,  // 76: prodvana.desired_state.model.RuntimeObject.external_objects:type_name -> prodvana.runtimes.extensions.ExternalObject
	6,   // 77: prodvana.desired_state.model.ConditionState.status:type_name -> prodvana.desired_state.model.ConditionStatus
	86,  // 78: prodvana.desired_state.model.NotificationInfo.most_recent_failure:type_name -> google.protobuf.Timestamp
	47,  // 79: prodvana.desired_state.model.NotificationInfo.runtime_fetch_invoke_error:type_name -> prodvana.desired_state.model.ApplyError
	47,  // 80: prodvana.desired_state.model.NotificationInfo.runtime_apply_invoke_error:type_name -> prodvana.desired_state.model.ApplyError
	64,  // 81: prodvana.desired_state.model.NotificationInfo.concurrency_limit_exceeded_errors:type_name -> prodvana.desired_state.model.ConcurrencyLimitExceeded
	46,  // 82: prodvana.desired_state.model.ControlState.precondition_states:type_name -> prodvana.desired_state.model.ConditionState
	46,  // 83: prodvana.desired_state.model.ControlState.invariant_states:type_name -> prodvana.desired_state.model.ConditionState
	28,  // 84: prodvana.desired_state.model.ControlState.status_explanations:type_name -> prodvana.desired_state.model.StatusExplanation
	29,  // 85: prodvana.desired_state.model.ControlState.action_explanation:type_name -> prodvana.desired_state.model.ActionExplanation
	86,  // 86: prodvana.desired_state.model.ControlState.last_fetched_timestamp:type_name -> google.protobuf.Timestamp
	86,  // 87: prodvana.desired_state.model.ControlState.last_applied_timestamp:type_name -> google.protobuf.Timestamp
	86,  // 88: prodvana.desired_state.model.ControlState.expected_next_apply_timestamp:type_name -> google.protobuf.Timestamp
	63,  // 89: prodvana.desired_state.model.ControlState.missing_approval:type_name -> prodvana.desired_state.model.MissingApproval
	47,  // 90: prodvana.desired_state.model.ControlState.apply_error:type_name -> prodvana.desired_state.model.ApplyError
	48,  // 91: prodvana.desired_state.model.ControlState.notification_info:type_name -> prodvana.desired_state.model.NotificationInfo
	27,  // 92: prodvana.desired_state.model.ManualApprovalState.meta:type_name -> prodvana.desired_state.model.Metadata
	7,   // 93: prodvana.desired_state.model.ManualApprovalState.status:type_name -> prodvana.desired_state.model.ManualApprovalStatus
	76,  // 94: prodvana.desired_state.model.ManualApprovalState.approvers:type_name -> prodvana.desired_state.model.ManualApprovalState.Approver
	32,  // 95: prodvana.desired_state.model.State.service:type_name -> prodvana.desired_state.model.ServiceState
	31,  // 96: prodvana.desired_state.model.State.service_instance:type_name -> prodvana.desired_state.model.ServiceInstanceState
	34,  // 97: prodvana.desired_state.model.State.service_group:type_name -> prodvana.desired_state.model.ServiceGroupState
	45,  // 98: prodvana.desired_state.model.State.runtime_object:type_name -> prodvana.desired_state.model.RuntimeObject
	50,  // 99: prodvana.desired_state.model.State.manual_approval:type_name -> prodvana.desired_state.model.ManualApprovalState
	54,  // 100: prodvana.desired_state.model.State.custom_task:type_name -> prodvana.desired_state.model.CustomTaskState
	57,  // 101: prodvana.desired_state.model.State.protection_attachment:type_name -> prodvana.desired_state.model.ProtectionAttachment
	55,  // 102: prodvana.desired_state.model.State.protection_link:type_name -> prodvana.desired_state.model.ProtectionLinkState
	58,  // 103: prodvana.desired_state.model.State.delivery_extension:type_name -> prodvana.desired_state.model.DeliveryExtensionState
	77,  // 104: prodvana.desired_state.model.Annotations.annotations:type_name -> prodvana.desired_state.model.Annotations.Annotation
	8,   // 105: prodvana.desired_state.model.CustomTaskExecutionState.status:type_name -> prodvana.desired_state.model.CustomTaskStatus
	86,  // 106: prodvana.desired_state.model.CustomTaskExecutionState.latest_attempt_end_timestamp:type_name -> google.protobuf.Timestamp
	27,  // 107: prodvana.desired_state.model.CustomTaskState.meta:type_name -> prodvana.desired_state.model.Metadata
	91,  // 108: prodvana.desired_state.model.CustomTaskState.program:type_name -> prodvana.common_config.ProgramConfig
	53,  // 109: prodvana.desired_state.model.CustomTaskState.task_state:type_name -> prodvana.desired_state.model.CustomTaskExecutionState
	92,  // 110: prodvana.desired_state.model.CustomTaskState.retry_config:type_name -> prodvana.common_config.RetryConfig
	27,  // 111: prodvana.desired_state.model.ProtectionLinkState.meta:type_name -> prodvana.desired_state.model.Metadata
	2,   // 112: prodvana.desired_state.model.ProtectionLinkState.last_seen_attachment_status:type_name -> prodvana.desired_state.model.Status
	56,  // 113: prodvana.desired_state.model.ProtectionLinkState.last_seen_attachment_result:type_name -> prodvana.desired_state.model.ProtectionAttachmentResult
	6,   // 114: prodvana.desired_state.model.ProtectionLinkState.status:type_name -> prodvana.desired_state.model.ConditionStatus
	21,  // 115: prodvana.desired_state.model.ProtectionLinkState.link:type_name -> prodvana.desired_state.model.ProtectionLink
	86,  // 116: prodvana.desired_state.model.ProtectionLinkState.started_timestamp:type_name -> google.protobuf.Timestamp
	86,  // 117: prodvana.desired_state.model.ProtectionLinkState.stopped_timestamp:type_name -> google.protobuf.Timestamp
	18,  // 118: prodvana.desired_state.model.ProtectionLinkState.stopped_reason:type_name -> prodvana.desired_state.model.ProtectionLinkState.StopReason
	86,  // 119: prodvana.desired_state.model.ProtectionLinkState.first_success_timestamp:type_name -> google.protobuf.Timestamp
	19,  // 120: prodvana.desired_state.model.ProtectionAttachmentResult.status:type_name -> prodvana.desired_state.model.ProtectionAttachmentResult.Status
	86,  // 121: prodvana.desired_state.model.ProtectionAttachmentResult.execution_timestamp:type_name -> google.protobuf.Timestamp
	27,  // 122: prodvana.desired_state.model.ProtectionAttachment.meta:type_name -> prodvana.desired_state.model.Metadata
	30,  // 123: prodvana.desired_state.model.ProtectionAttachment.versions:type_name -> prodvana.desired_state.model.Version
	30,  // 124: prodvana.desired_state.model.ProtectionAttachment.last_completed_versions:type_name -> prodvana.desired_state.model.Version
	86,  // 125: prodvana.desired_state.model.ProtectionAttachment.last_completed_timestamp:type_name -> google.protobuf.Timestamp
	3,   // 126: prodvana.desired_state.model.ProtectionAttachment.last_completed_status:type_name -> prodvana.desired_state.model.SimpleStatus
	28,  // 127: prodvana.desired_state.model.ProtectionAttachment.last_completed_status_explanations:type_name -> prodvana.desired_state.model.StatusExplanation
	56,  // 128: prodvana.desired_state.model.ProtectionAttachment.result:type_name -> prodvana.desired_state.model.ProtectionAttachmentResult
	27,  // 129: prodvana.desired_state.model.DeliveryExtensionState.meta:type_name -> prodvana.desired_state.model.Metadata
	30,  // 130: prodvana.desired_state.model.DeliveryExtensionState.versions:type_name -> prodvana.desired_state.model.Version
	84,  // 131: prodvana.desired_state.model.DeliveryExtensionState.lifecycle:type_name -> prodvana.common_config.TaskLifecycle
	86,  // 132: prodvana.desired_state.model.DeliveryExtensionState.last_completed_timestamp:type_name -> google.protobuf.Timestamp
	3,   // 133: prodvana.desired_state.model.DeliveryExtensionState.last_completed_status:type_name -> prodvana.desired_state.model.SimpleStatus
	28,  // 134: prodvana.desired_state.model.DeliveryExtensionState.last_completed_status_explanations:type_name -> prodvana.desired_state.model.StatusExplanation
	25,  // 135: prodvana.desired_state.model.DeliveryExtensionState.references:type_name -> prodvana.desired_state.model.Identifier
	9,   // 136: prodvana.desired_state.model.Signal.type:type_name -> prodvana.desired_state.model.SignalType
	78,  // 137: prodvana.desired_state.model.Signal.delivery_promotion:type_name -> prodvana.desired_state.model.Signal.DeliveryPromotionConfig
	79,  // 138: prodvana.desired_state.model.Signal.protection_bypass:type_name -> prodvana.desired_state.model.Signal.ProtectionBypass
	80,  // 139: prodvana.desired_state.model.Signal.runtime_extension_approval:type_name -> prodvana.desired_state.model.Signal.RuntimeExtensionApproval
	86,  // 140: prodvana.desired_state.model.DebugLog.ts:type_name -> google.protobuf.Timestamp
	39,  // 141: prodvana.desired_state.model.RuntimeExtensionMetadata.output:type_name -> prodvana.desired_state.model.RuntimeExtensionFetchOutput
	61,  // 142: prodvana.desired_state.model.ManualApprovalConfig.runtime_extension:type_name -> prodvana.desired_state.model.RuntimeExtensionMetadata
	9,   // 143: prodvana.desired_state.model.MissingApproval.signal_type:type_name -> prodvana.desired_state.model.SignalType
	61,  // 144: prodvana.desired_state.model.MissingApproval.runtime_extension:type_name -> prodvana.desired_state.model.RuntimeExtensionMetadata
	25,  // 145: prodvana.desired_state.model.ConcurrencyLimitExceeded.entity_id:type_name -> prodvana.desired_state.model.Identifier
	81,  // 146: prodvana.desired_state.model.ConcurrencyLimitExceeded.blockers:type_name -> prodvana.desired_state.model.ConcurrencyLimitExceeded.Blocker
	82,  // 147: prodvana.desired_state.model.ApplyConditionUnsatisfied.missing_approval:type_name -> prodvana.desired_state.model.ApplyConditionUnsatisfied.InternalMissingApproval
	64,  // 148: prodvana.desired_state.model.ApplyConditionUnsatisfied.concurrency_limit_exceeded:type_name -> prodvana.desired_state.model.ConcurrencyLimitExceeded
	88,  // 149: prodvana.desired_state.model.FetchTaskStartDetails.fetch_mode:type_name -> prodvana.runtimes.extensions.FetchMode
	3,   // 150: prodvana.desired_state.model.TaskRun.status:type_name -> prodvana.desired_state.model.SimpleStatus
	28,  // 151: prodvana.desired_state.model.TaskRun.status_explanations:type_name -> prodvana.desired_state.model.StatusExplanation
	30,  // 152: prodvana.desired_state.model.TaskRun.seen_versions:type_name -> prodvana.desired_state.model.Version
	86,  // 153: prodvana.desired_state.model.TaskRun.created_timestamp:type_name -> google.protobuf.Timestamp
	86,  // 154: prodvana.desired_state.model.TaskRun.started_timestamp:type_name -> google.protobuf.Timestamp
	86,  // 155: prodvana.desired_state.model.TaskRun.completed_timestamp:type_name -> google.protobuf.Timestamp
	25,  // 156: prodvana.desired_state.model.TaskRun.task_entities:type_name -> prodvana.desired_state.model.Identifier
	20,  // 157: prodvana.desired_state.model.TaskRun.phase:type_name -> prodvana.desired_state.model.TaskRun.Phase
	38,  // 158: prodvana.desired_state.model.TaskRun.fetch_details:type_name -> prodvana.desired_state.model.FetchDetails
	66,  // 159: prodvana.desired_state.model.TaskRun.fetch_task_start_details:type_name -> prodvana.desired_state.model.FetchTaskStartDetails
	67,  // 160: prodvana.desired_state.model.TaskRun.concurrency_leases:type_name -> prodvana.desired_state.model.ConcurrencyLease
	68,  // 161: prodvana.desired_state.model.TaskEntityContext.last_completed_run:type_name -> prodvana.desired_state.model.TaskRun
	68,  // 162: prodvana.desired_state.model.TaskEntityContext.last_run:type_name -> prodvana.desired_state.model.TaskRun
	74,  // 163: prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition.protection:type_name -> prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition.Protection
	1,   // 164: prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition.Protection.task_type:type_name -> prodvana.desired_state.model.CustomTaskType
	93,  // 165: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.apply:type_name -> prodvana.environment.CompiledExtensionCommand
	93,  // 166: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.fetch:type_name -> prodvana.environment.CompiledExtensionCommand
	93,  // 167: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.get_info:type_name -> prodvana.environment.CompiledExtensionCommand
	85,  // 168: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.fetch_interval:type_name -> google.protobuf.Duration
	85,  // 169: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.fetch_steady_state_interval:type_name -> google.protobuf.Duration
	85,  // 170: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.get_info_interval:type_name -> google.protobuf.Duration
	94,  // 171: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.parameters:type_name -> prodvana.common_config.ParameterDefinition
	95,  // 172: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.parameter_values:type_name -> prodvana.common_config.ParameterValue
	96,  // 173: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.type:type_name -> prodvana.environment.ExtensionType
	39,  // 174: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.fetch_output:type_name -> prodvana.desired_state.model.RuntimeExtensionFetchOutput
	42,  // 175: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.get_info_output:type_name -> prodvana.desired_state.model.RuntimeExtensionGetInfoOutput
	44,  // 176: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.apply_output:type_name -> prodvana.desired_state.model.RuntimeExtensionApplyOutput
	97,  // 177: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.fetch_retry_policy:type_name -> prodvana.environment.RetryPolicy
	97,  // 178: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.apply_retry_policy:type_name -> prodvana.environment.RetryPolicy
	97,  // 179: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.get_info_retry_policy:type_name -> prodvana.environment.RetryPolicy
	88,  // 180: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.fetch_mode:type_name -> prodvana.runtimes.extensions.FetchMode
	98,  // 181: prodvana.desired_state.model.ManualApprovalState.Approver.source:type_name -> prodvana.version.Source
	99,  // 182: prodvana.desired_state.model.ManualApprovalState.Approver.source_metadata:type_name -> prodvana.version.SourceMetadata
	7,   // 183: prodvana.desired_state.model.ManualApprovalState.Approver.status:type_name -> prodvana.desired_state.model.ManualApprovalStatus
	86,  // 184: prodvana.desired_state.model.ManualApprovalState.Approver.timestamp:type_name -> google.protobuf.Timestamp
	86,  // 185: prodvana.desired_state.model.Signal.RuntimeExtensionApproval.timestamp:type_name -> google.protobuf.Timestamp
	25,  // 186: prodvana.desired_state.model.ConcurrencyLimitExceeded.Blocker.entity_id:type_name -> prodvana.desired_state.model.Identifier
	86,  // 187: prodvana.desired_state.model.ConcurrencyLimitExceeded.Blocker.held_since_timestamp:type_name -> google.protobuf.Timestamp
	9,   // 188: prodvana.desired_state.model.ApplyConditionUnsatisfied.InternalMissingApproval.signal_type:type_name -> prodvana.desired_state.model.SignalType
	61,  // 189: prodvana.desired_state.model.ApplyConditionUnsatisfied.InternalMissingApproval.runtime_extension:type_name -> prodvana.desired_state.model.RuntimeExtensionMetadata
