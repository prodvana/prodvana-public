...
type RuntimeObject_RuntimeExtension struct {
	...
	FetchPlan        *RuntimeExtensionFetchPlan            `protobuf:"bytes,10,opt,name=fetch_plan,json=fetchPlan,proto3" json:"fetch_plan,omitempty"` // next tag: 11
}
...
var file_prodvana_desired_state_model_desired_state_proto_rawDesc = []byte{
	...
	0x70, 0x52, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0xad, 0x0f, 0x0a,
	...
	0x65, 0x6e, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x1a, 0x9e, 0x05, 0x0a, 0x10, 0x52, 0x75,
	...
	0x65, 0x74, 0x63, 0x68, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x12, 0x3e, 0x0a, 0x0d,
	...
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0xeb, 0x04, 0x0a, 0x06, 0x53, 0x69, 0x67, 0x6e, 0x61,
	...
	0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x79, 0x70, 0x61, 0x73, 0x73, 0x1a, 0x6c, 0x0a, 0x18,
	...
	0x28, 0x08, 0x52, 0x06, 0x72, 0x65, 0x6a, 0x65, 0x63, 0x74, 0x42, 0x08, 0x0a, 0x06, 0x63, 0x6f,
	...
	0x6c, 0x6f, 0x67, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6c, 0x6f, 0x67, 0x22, 0x9c,
	0x01, 0x0a, 0x0f, 0x4d, 0x69, 0x73, 0x73, 0x69, 0x6e, 0x67, 0x41, 0x70, 0x70, 0x72, 0x6f, 0x76,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x70, 0x69, 0x63, 0x22, 0x75, 0x0a,
	...
	0x61, 0x73, 0x6f, 0x6e, 0x2a, 0xcb, 0x01, 0x0a, 0x04, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0b, 0x0a,
...
var file_prodvana_desired_state_model_desired_state_proto_msgTypes = make([]protoimpl.MessageInfo, 39)
var file_prodvana_desired_state_model_desired_state_proto_goTypes = []interface{}{
	...
	(*protection.ProtectionLifecycle)(nil),                     // 54: prodvana.protection.ProtectionLifecycle
	(common_config.TaskLifecycle)(0),                           // 55: prodvana.common_config.TaskLifecycle
	(*timestamppb.Timestamp)(nil),                              // 56: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),                                // 57: google.protobuf.Duration
	(*common_config.ProgramConfig)(nil),                        // 58: prodvana.common_config.ProgramConfig
	(*common_config.RetryConfig)(nil),                          // 59: prodvana.common_config.RetryConfig
	(*environment.CompiledExtensionCommand)(nil),               // 60: prodvana.environment.CompiledExtensionCommand
	(*common_config.ParameterDefinition)(nil),                  // 61: prodvana.common_config.ParameterDefinition
	(*common_config.ParameterValue)(nil),                       // 62: prodvana.common_config.ParameterValue
	(environment.ExtensionType)(0),                             // 63: prodvana.environment.ExtensionType
}
var file_prodvana_desired_state_model_desired_state_proto_depIdxs = []int32{
	54,  // 0: prodvana.desired_state.model.ProtectionLink.lifecycle:type_name -> prodvana.protection.ProtectionLifecycle
	...
	55,  // 4: prodvana.desired_state.model.DeliveryExtension.lifecycle:type_name -> prodvana.common_config.TaskLifecycle
	...
	56,  // 14: prodvana.desired_state.model.ActionExplanation.ts:type_name -> google.protobuf.Timestamp
	5,   // 15: prodvana.desired_state.model.ActionExplanation.action_type:type_name -> prodvana.desired_state.model.ActionType
	56,  // 16: prodvana.desired_state.model.Version.push_timestamp:type_name -> google.protobuf.Timestamp
	...
	57,  // 30: prodvana.desired_state.model.CanaryProgressState.duration:type_name -> google.protobuf.Duration
	56,  // 31: prodvana.desired_state.model.CanaryProgressState.pause_start_timestamp:type_name -> google.protobuf.Timestamp
	...
	56,  // 34: prodvana.desired_state.model.RuntimeExtensionFetchPlan.timestamp:type_name -> google.protobuf.Timestamp
	...
	57,  // 41: prodvana.desired_state.model.RuntimeObject.interval:type_name -> google.protobuf.Duration
	57,  // 42: prodvana.desired_state.model.RuntimeObject.timeout:type_name -> google.protobuf.Duration
	13,  // 43: prodvana.desired_state.model.RuntimeObject.management_status:type_name -> prodvana.desired_state.model.RuntimeObject.ManagementStatus
	6,   // 44: prodvana.desired_state.model.ConditionState.status:type_name -> prodvana.desired_state.model.ConditionStatus
	31,  // 45: prodvana.desired_state.model.ControlState.precondition_states:type_name -> prodvana.desired_state.model.ConditionState
	31,  // 46: prodvana.desired_state.model.ControlState.invariant_states:type_name -> prodvana.desired_state.model.ConditionState
	...
	56,  // 49: prodvana.desired_state.model.ControlState.last_fetched_timestamp:type_name -> google.protobuf.Timestamp
	56,  // 50: prodvana.desired_state.model.ControlState.last_applied_timestamp:type_name -> google.protobuf.Timestamp
	43,  // 51: prodvana.desired_state.model.ControlState.missing_approval:type_name -> prodvana.desired_state.model.MissingApproval
	19,  // 52: prodvana.desired_state.model.ManualApprovalState.meta:type_name -> prodvana.desired_state.model.Metadata
	7,   // 53: prodvana.desired_state.model.ManualApprovalState.status:type_name -> prodvana.desired_state.model.ManualApprovalStatus
	24,  // 54: prodvana.desired_state.model.State.service:type_name -> prodvana.desired_state.model.ServiceState
	23,  // 55: prodvana.desired_state.model.State.service_instance:type_name -> prodvana.desired_state.model.ServiceInstanceState
	25,  // 56: prodvana.desired_state.model.State.service_group:type_name -> prodvana.desired_state.model.ServiceGroupState
	30,  // 57: prodvana.desired_state.model.State.runtime_object:type_name -> prodvana.desired_state.model.RuntimeObject
	33,  // 58: prodvana.desired_state.model.State.manual_approval:type_name -> prodvana.desired_state.model.ManualApprovalState
	37,  // 59: prodvana.desired_state.model.State.custom_task:type_name -> prodvana.desired_state.model.CustomTaskState
	39,  // 60: prodvana.desired_state.model.State.protection_attachment:type_name -> prodvana.desired_state.model.ProtectionAttachment
	38,  // 61: prodvana.desired_state.model.State.protection_link:type_name -> prodvana.desired_state.model.ProtectionLinkState
	40,  // 62: prodvana.desired_state.model.State.delivery_extension:type_name -> prodvana.desired_state.model.DeliveryExtensionState
	50,  // 63: prodvana.desired_state.model.Annotations.annotations:type_name -> prodvana.desired_state.model.Annotations.Annotation
	8,   // 64: prodvana.desired_state.model.CustomTaskExecutionState.status:type_name -> prodvana.desired_state.model.CustomTaskStatus
	56,  // 65: prodvana.desired_state.model.CustomTaskExecutionState.latest_attempt_end_timestamp:type_name -> google.protobuf.Timestamp
	19,  // 66: prodvana.desired_state.model.CustomTaskState.meta:type_name -> prodvana.desired_state.model.Metadata
	58,  // 67: prodvana.desired_state.model.CustomTaskState.program:type_name -> prodvana.common_config.ProgramConfig
	36,  // 68: prodvana.desired_state.model.CustomTaskState.task_state:type_name -> prodvana.desired_state.model.CustomTaskExecutionState
	59,  // 69: prodvana.desired_state.model.CustomTaskState.retry_config:type_name -> prodvana.common_config.RetryConfig
	19,  // 70: prodvana.desired_state.model.ProtectionLinkState.meta:type_name -> prodvana.desired_state.model.Metadata
	6,   // 71: prodvana.desired_state.model.ProtectionLinkState.status:type_name -> prodvana.desired_state.model.ConditionStatus
	15,  // 72: prodvana.desired_state.model.ProtectionLinkState.link:type_name -> prodvana.desired_state.model.ProtectionLink
	56,  // 73: prodvana.desired_state.model.ProtectionLinkState.started_timestamp:type_name -> google.protobuf.Timestamp
	56,  // 74: prodvana.desired_state.model.ProtectionLinkState.stopped_timestamp:type_name -> google.protobuf.Timestamp
	14,  // 75: prodvana.desired_state.model.ProtectionLinkState.stopped_reason:type_name -> prodvana.desired_state.model.ProtectionLinkState.StopReason
	56,  // 76: prodvana.desired_state.model.ProtectionLinkState.first_success_timestamp:type_name -> google.protobuf.Timestamp
	19,  // 77: prodvana.desired_state.model.ProtectionAttachment.meta:type_name -> prodvana.desired_state.model.Metadata
	22,  // 78: prodvana.desired_state.model.ProtectionAttachment.versions:type_name -> prodvana.desired_state.model.Version
	22,  // 79: prodvana.desired_state.model.ProtectionAttachment.last_completed_versions:type_name -> prodvana.desired_state.model.Version
	56,  // 80: prodvana.desired_state.model.ProtectionAttachment.last_completed_timestamp:type_name -> google.protobuf.Timestamp
	3,   // 81: prodvana.desired_state.model.ProtectionAttachment.last_completed_status:type_name -> prodvana.desired_state.model.SimpleStatus
	20,  // 82: prodvana.desired_state.model.ProtectionAttachment.last_completed_status_explanations:type_name -> prodvana.desired_state.model.StatusExplanation
	19,  // 83: prodvana.desired_state.model.DeliveryExtensionState.meta:type_name -> prodvana.desired_state.model.Metadata
	22,  // 84: prodvana.desired_state.model.DeliveryExtensionState.versions:type_name -> prodvana.desired_state.model.Version
	55,  // 85: prodvana.desired_state.model.DeliveryExtensionState.lifecycle:type_name -> prodvana.common_config.TaskLifecycle
	56,  // 86: prodvana.desired_state.model.DeliveryExtensionState.last_completed_timestamp:type_name -> google.protobuf.Timestamp
	3,   // 87: prodvana.desired_state.model.DeliveryExtensionState.last_completed_status:type_name -> prodvana.desired_state.model.SimpleStatus
	20,  // 88: prodvana.desired_state.model.DeliveryExtensionState.last_completed_status_explanations:type_name -> prodvana.desired_state.model.StatusExplanation
	18,  // 89: prodvana.desired_state.model.DeliveryExtensionState.references:type_name -> prodvana.desired_state.model.Identifier
	6,   // 90: prodvana.desired_state.model.DeliveryExtensionState.status:type_name -> prodvana.desired_state.model.ConditionStatus
	9,   // 91: prodvana.desired_state.model.Signal.type:type_name -> prodvana.desired_state.model.SignalType
	51,  // 92: prodvana.desired_state.model.Signal.delivery_promotion:type_name -> prodvana.desired_state.model.Signal.DeliveryPromotionConfig
	52,  // 93: prodvana.desired_state.model.Signal.protection_bypass:type_name -> prodvana.desired_state.model.Signal.ProtectionBypass
	53,  // 94: prodvana.desired_state.model.Signal.runtime_extension_approval:type_name -> prodvana.desired_state.model.Signal.RuntimeExtensionApproval
	56,  // 95: prodvana.desired_state.model.DebugLog.ts:type_name -> google.protobuf.Timestamp
	9,   // 96: prodvana.desired_state.model.MissingApproval.signal_type:type_name -> prodvana.desired_state.model.SignalType
	43,  // 97: prodvana.desired_state.model.ApplyRejected.missing_approval:type_name -> prodvana.desired_state.model.MissingApproval
	48,  // 98: prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition.protection:type_name -> prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition.Protection
	1,   // 99: prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition.Protection.task_type:type_name -> prodvana.desired_state.model.CustomTaskType
	60,  // 100: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.apply:type_name -> prodvana.environment.CompiledExtensionCommand
	60,  // 101: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.fetch:type_name -> prodvana.environment.CompiledExtensionCommand
	57,  // 102: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.fetch_interval:type_name -> google.protobuf.Duration
	57,  // 103: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.fetch_timeout:type_name -> google.protobuf.Duration
	61,  // 104: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.parameters:type_name -> prodvana.common_config.ParameterDefinition
	62,  // 105: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.parameter_values:type_name -> prodvana.common_config.ParameterValue
	63,  // 106: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.type:type_name -> prodvana.environment.ExtensionType
	29,  // 107: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.fetch_plan:type_name -> prodvana.desired_state.model.RuntimeExtensionFetchPlan
	56,  // 108: prodvana.desired_state.model.Signal.RuntimeExtensionApproval.timestamp:type_name -> google.protobuf.Timestamp
