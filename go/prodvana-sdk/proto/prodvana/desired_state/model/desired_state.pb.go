...
var file_prodvana_desired_state_model_desired_state_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x69, 0x6f, 0x64, 0x2a, 0xcb, 0x01, 0x0a, 0x04, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0b,
...
var file_prodvana_desired_state_model_desired_state_proto_msgTypes = make([]protoimpl.MessageInfo, 52)
var file_prodvana_desired_state_model_desired_state_proto_goTypes = []interface{}{
	...
	(*Condition_ReleaseChannelStableCondition)(nil),            // 61: prodvana.desired_state.model.Condition.ReleaseChannelStableCondition
	(*Condition_ManualApproval)(nil),                           // 62: prodvana.desired_state.model.Condition.ManualApproval
	(*Condition_CustomTaskSuccessfulCondition)(nil),            // 63: prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition
	(*Condition_CustomTaskSuccessfulCondition_Protection)(nil), // 64: prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition.Protection
	(*RuntimeObject_RuntimeExtension)(nil),                     // 65: prodvana.desired_state.model.RuntimeObject.RuntimeExtension
	(*Annotations_Annotation)(nil),                             // 66: prodvana.desired_state.model.Annotations.Annotation
	(*Signal_DeliveryPromotionConfig)(nil),                     // 67: prodvana.desired_state.model.Signal.DeliveryPromotionConfig
	(*Signal_ProtectionBypass)(nil),                            // 68: prodvana.desired_state.model.Signal.ProtectionBypass
	(*Signal_RuntimeExtensionApproval)(nil),                    // 69: prodvana.desired_state.model.Signal.RuntimeExtensionApproval
	(*ApplyConditionUnsatisfied_InternalMissingApproval)(nil),  // 70: prodvana.desired_state.model.ApplyConditionUnsatisfied.InternalMissingApproval
	(*protection.ProtectionLifecycle)(nil),                     // 71: prodvana.protection.ProtectionLifecycle
	(common_config.TaskLifecycle)(0),                           // 72: prodvana.common_config.TaskLifecycle
	(*durationpb.Duration)(nil),                                // 73: google.protobuf.Duration
	(*timestamppb.Timestamp)(nil),                              // 74: google.protobuf.Timestamp
	(extensions.FetchMode)(0),                                  // 75: prodvana.runtimes.extensions.FetchMode
	(*common_config.ExternalLink)(nil),                         // 76: prodvana.common_config.ExternalLink
	(*extensions.ExternalObject)(nil),                          // 77: prodvana.runtimes.extensions.ExternalObject
	(*common_config.ProgramConfig)(nil),                        // 78: prodvana.common_config.ProgramConfig
	(*common_config.RetryConfig)(nil),                          // 79: prodvana.common_config.RetryConfig
	(*environment.CompiledExtensionCommand)(nil),               // 80: prodvana.environment.CompiledExtensionCommand
	(*common_config.ParameterDefinition)(nil),                  // 81: prodvana.common_config.ParameterDefinition
	(*common_config.ParameterValue)(nil),                       // 82: prodvana.common_config.ParameterValue
	(environment.ExtensionType)(0),                             // 83: prodvana.environment.ExtensionType
	(*environment.RetryPolicy)(nil),                            // 84: prodvana.environment.RetryPolicy
}
var file_prodvana_desired_state_model_desired_state_proto_depIdxs = []int32{
	71,  // 0: prodvana.desired_state.model.ProtectionLink.lifecycle:type_name -> prodvana.protection.ProtectionLifecycle
	61,  // 1: prodvana.desired_state.model.Condition.rc_cond:type_name -> prodvana.desired_state.model.Condition.ReleaseChannelStableCondition
	62,  // 2: prodvana.desired_state.model.Condition.manual_approval:type_name -> prodvana.desired_state.model.Condition.ManualApproval
	63,  // 3: prodvana.desired_state.model.Condition.custom_task:type_name -> prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition
	72,  // 4: prodvana.desired_state.model.DeliveryExtension.lifecycle:type_name -> prodvana.common_config.TaskLifecycle
	...
	73,  // 13: prodvana.desired_state.model.Metadata.convergence_grace_period:type_name -> google.protobuf.Duration
	...
	74,  // 16: prodvana.desired_state.model.ActionExplanation.ts:type_name -> google.protobuf.Timestamp
	5,   // 17: prodvana.desired_state.model.ActionExplanation.action_type:type_name -> prodvana.desired_state.model.ActionType
	74,  // 18: prodvana.desired_state.model.Version.push_timestamp:type_name -> google.protobuf.Timestamp
	...
	73,  // 35: prodvana.desired_state.model.CanaryProgressState.duration:type_name -> google.protobuf.Duration
	74,  // 36: prodvana.desired_state.model.CanaryProgressState.pause_start_timestamp:type_name -> google.protobuf.Timestamp
	...
	74,  // 39: prodvana.desired_state.model.FetchDetails.started_timestamp:type_name -> google.protobuf.Timestamp
	74,  // 40: prodvana.desired_state.model.FetchDetails.completed_timestamp:type_name -> google.protobuf.Timestamp
	...
	75,  // 42: prodvana.desired_state.model.FetchDetails.fetch_mode:type_name -> prodvana.runtimes.extensions.FetchMode
	...
	74,  // 48: prodvana.desired_state.model.RuntimeExtensionGetInfoDetails.started_timestamp:type_name -> google.protobuf.Timestamp
	74,  // 49: prodvana.desired_state.model.RuntimeExtensionGetInfoDetails.completed_timestamp:type_name -> google.protobuf.Timestamp
	...
	74,  // 51: prodvana.desired_state.model.ApplyDetails.started_timestamp:type_name -> google.protobuf.Timestamp
	74,  // 52: prodvana.desired_state.model.ApplyDetails.completed_timestamp:type_name -> google.protobuf.Timestamp
	...
	65,  // 63: prodvana.desired_state.model.RuntimeObject.runtime_extension:type_name -> prodvana.desired_state.model.RuntimeObject.RuntimeExtension
	73,  // 64: prodvana.desired_state.model.RuntimeObject.interval:type_name -> google.protobuf.Duration
	73,  // 65: prodvana.desired_state.model.RuntimeObject.steady_state_interval:type_name -> google.protobuf.Duration
	...
	76,  // 68: prodvana.desired_state.model.RuntimeObject.external_links:type_name -> prodvana.common_config.ExternalLink
	77,  // 69: prodvana.desired_state.model.RuntimeObject.external_objects:type_name -> prodvana.runtimes.extensions.ExternalObject
	...
	74,  // 75: prodvana.desired_state.model.ControlState.last_fetched_timestamp:type_name -> google.protobuf.Timestamp
	74,  // 76: prodvana.desired_state.model.ControlState.last_applied_timestamp:type_name -> google.protobuf.Timestamp
	...
	66,  // 89: prodvana.desired_state.model.Annotations.annotations:type_name -> prodvana.desired_state.model.Annotations.Annotation
	...
	74,  // 91: prodvana.desired_state.model.CustomTaskExecutionState.latest_attempt_end_timestamp:type_name -> google.protobuf.Timestamp
	24,  // 92: prodvana.desired_state.model.CustomTaskState.meta:type_name -> prodvana.desired_state.model.Metadata
	78,  // 93: prodvana.desired_state.model.CustomTaskState.program:type_name -> prodvana.common_config.ProgramConfig
	...
	79,  // 95: prodvana.desired_state.model.CustomTaskState.retry_config:type_name -> prodvana.common_config.RetryConfig
	...
	74,  // 100: prodvana.desired_state.model.ProtectionLinkState.started_timestamp:type_name -> google.protobuf.Timestamp
	74,  // 101: prodvana.desired_state.model.ProtectionLinkState.stopped_timestamp:type_name -> google.protobuf.Timestamp
	...
	74,  // 103: prodvana.desired_state.model.ProtectionLinkState.first_success_timestamp:type_name -> google.protobuf.Timestamp
	...
	74,  // 107: prodvana.desired_state.model.ProtectionAttachment.last_completed_timestamp:type_name -> google.protobuf.Timestamp
	...
	72,  // 112: prodvana.desired_state.model.DeliveryExtensionState.lifecycle:type_name -> prodvana.common_config.TaskLifecycle
	74,  // 113: prodvana.desired_state.model.DeliveryExtensionState.last_completed_timestamp:type_name -> google.protobuf.Timestamp
	...
	67,  // 119: prodvana.desired_state.model.Signal.delivery_promotion:type_name -> prodvana.desired_state.model.Signal.DeliveryPromotionConfig
	68,  // 120: prodvana.desired_state.model.Signal.protection_bypass:type_name -> prodvana.desired_state.model.Signal.ProtectionBypass
	69,  // 121: prodvana.desired_state.model.Signal.runtime_extension_approval:type_name -> prodvana.desired_state.model.Signal.RuntimeExtensionApproval
	74,  // 122: prodvana.desired_state.model.DebugLog.ts:type_name -> google.protobuf.Timestamp
	...
	70,  // 127: prodvana.desired_state.model.ApplyConditionUnsatisfied.missing_approval:type_name -> prodvana.desired_state.model.ApplyConditionUnsatisfied.InternalMissingApproval
	75,  // 128: prodvana.desired_state.model.FetchTaskStartDetails.fetch_mode:type_name -> prodvana.runtimes.extensions.FetchMode
	...
	74,  // 132: prodvana.desired_state.model.TaskRun.started_timestamp:type_name -> google.protobuf.Timestamp
	74,  // 133: prodvana.desired_state.model.TaskRun.completed_timestamp:type_name -> google.protobuf.Timestamp
	...
	64,  // 140: prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition.protection:type_name -> prodvana.desired_state.model.Condition.CustomTaskSuccessfulCondition.Protection
	...
	80,  // 142: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.apply:type_name -> prodvana.environment.CompiledExtensionCommand
	80,  // 143: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.fetch:type_name -> prodvana.environment.CompiledExtensionCommand
	80,  // 144: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.get_info:type_name -> prodvana.environment.CompiledExtensionCommand
	73,  // 145: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.fetch_interval:type_name -> google.protobuf.Duration
	73,  // 146: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.fetch_steady_state_interval:type_name -> google.protobuf.Duration
	73,  // 147: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.get_info_interval:type_name -> google.protobuf.Duration
	81,  // 148: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.parameters:type_name -> prodvana.common_config.ParameterDefinition
	82,  // 149: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.parameter_values:type_name -> prodvana.common_config.ParameterValue
	83,  // 150: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.type:type_name -> prodvana.environment.ExtensionType
	...
	84,  // 154: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.fetch_retry_policy:type_name -> prodvana.environment.RetryPolicy
	84,  // 155: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.apply_retry_policy:type_name -> prodvana.environment.RetryPolicy
	84,  // 156: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.get_info_retry_policy:type_name -> prodvana.environment.RetryPolicy
	75,  // 157: prodvana.desired_state.model.RuntimeObject.RuntimeExtension.fetch_mode:type_name -> prodvana.runtimes.extensions.FetchMode
	74,  // 158: prodvana.desired_state.model.Signal.RuntimeExtensionApproval.timestamp:type_name -> google.protobuf.Timestamp
