...
var file_prodvana_desired_state_model_entity_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x52, 0x02, 0x69, 0x64, 0x22, 0x97, 0x0f, 0x0a, 0x06,
	...
	0x69, 0x74, 0x69, 0x65, 0x73, 0x2a, 0xc4, 0x01, 0x0a, 0x0e, 0x44, 0x65, 0x70, 0x65, 0x6e, 0x64,
...
var file_prodvana_desired_state_model_entity_proto_depIdxs = []int32{
	...
	12, // 23: prodvana.desired_state.model.Entity.dependencies:type_name -> prodvana.desired_state.model.Identifier
	12, // 24: prodvana.desired_state.model.Entity.direct_dependencies:type_name -> prodvana.desired_state.model.Identifier
	3,  // 25: prodvana.desired_state.model.Entity.dependencies_with_type:type_name -> prodvana.desired_state.model.Dependency
	22, // 26: prodvana.desired_state.model.Entity.lifecycle:type_name -> prodvana.common_config.TaskLifecycle
	23, // 27: prodvana.desired_state.model.Entity.missing_approval:type_name -> prodvana.desired_state.model.MissingApproval
	24, // 28: prodvana.desired_state.model.Entity.apply_error:type_name -> prodvana.desired_state.model.ApplyError
	2,  // 29: prodvana.desired_state.model.Entity.notifications:type_name -> prodvana.desired_state.model.Notifications
	12, // 30: prodvana.desired_state.model.EntityGraph.root:type_name -> prodvana.desired_state.model.Identifier
	4,  // 31: prodvana.desired_state.model.EntityGraph.entities:type_name -> prodvana.desired_state.model.Entity
	21, // 32: prodvana.desired_state.model.Notifications.ProgramFailures.most_recent_failure:type_name -> google.protobuf.Timestamp
	1,  // 33: prodvana.desired_state.model.Notifications.RuntimeFailure.failure_type:type_name -> prodvana.desired_state.model.Notifications.RuntimeFailure.FailureType
	12, // 34: prodvana.desired_state.model.Notifications.ProtectionFailure.protection_id:type_name -> prodvana.desired_state.model.Identifier
	12, // 35: prodvana.desired_state.model.Notifications.ConvergenceExtensionFailure.extension_id:type_name -> prodvana.desired_state.model.Identifier
