...
type Entity struct {
	...
	ApplyError           *ApplyError                 `protobuf:"bytes,21,opt,name=apply_error,json=applyError,proto3" json:"apply_error,omitempty"` // next tag: 22
}
...
var file_prodvana_desired_state_model_entity_proto_rawDesc = []byte{
	...
	0xb3, 0x0c, 0x0a, 0x06, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x12, 0x38, 0x0a, 0x02, 0x69, 0x64,
	...
	0x6e, 0x67, 0x41, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x61, 0x6c, 0x12, 0x49, 0x0a, 0x0b, 0x61, 0x70,
	0x70, 0x6c, 0x79, 0x5f, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x18, 0x15, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x45, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x8d, 0x01, 0x0a, 0x0b, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x79,
...
var file_prodvana_desired_state_model_entity_proto_goTypes = []interface{}{
	...
	(*ApplyError)(nil),               // 14: prodvana.desired_state.model.ApplyError
}
var file_prodvana_desired_state_model_entity_proto_depIdxs = []int32{
	...
	14, // 18: prodvana.desired_state.model.Entity.apply_error:type_name -> prodvana.desired_state.model.ApplyError
	2,  // 19: prodvana.desired_state.model.EntityGraph.root:type_name -> prodvana.desired_state.model.Identifier
	0,  // 20: prodvana.desired_state.model.EntityGraph.entities:type_name -> prodvana.desired_state.model.Entity
