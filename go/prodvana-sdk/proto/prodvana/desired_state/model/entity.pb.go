...
type Entity struct {
	...
	Dependencies         []*Identifier          `protobuf:"bytes,16,rep,name=dependencies,proto3" json:"dependencies,omitempty"`                                               // next tag: 18
}
...
var file_prodvana_desired_state_model_entity_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x81, 0x0a, 0x0a,
...
var file_prodvana_desired_state_model_entity_proto_depIdxs = []int32{
	...
	2,  // 15: prodvana.desired_state.model.EntityGraph.root:type_name -> prodvana.desired_state.model.Identifier
	0,  // 16: prodvana.desired_state.model.EntityGraph.entities:type_name -> prodvana.desired_state.model.Entity
