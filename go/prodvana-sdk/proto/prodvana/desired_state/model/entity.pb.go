...
type Entity struct {
	...
	Lifecycle            common_config.TaskLifecycle `protobuf:"varint,18,opt,name=lifecycle,proto3,enum=prodvana.common_config.TaskLifecycle" json:"lifecycle,omitempty"` // next tag: 20
}
...
var file_prodvana_desired_state_model_entity_proto_rawDesc = []byte{
	...
	0x8e, 0x0b, 0x0a, 0x06, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x12, 0x38, 0x0a, 0x02, 0x69, 0x64,
...
var file_prodvana_desired_state_model_entity_proto_depIdxs = []int32{
	...
	2,  // 17: prodvana.desired_state.model.EntityGraph.root:type_name -> prodvana.desired_state.model.Identifier
	0,  // 18: prodvana.desired_state.model.EntityGraph.entities:type_name -> prodvana.desired_state.model.Entity
