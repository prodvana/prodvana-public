...
func (m *Condition) validate(all bool) error {
	...
	case *Condition_ServiceStable:
		...
		if all {
			switch v := interface{}(m.GetServiceStable()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, ConditionValidationError{
						field:  "ServiceStable",
		...
		} else if v, ok := interface{}(m.GetServiceStable()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return ConditionValidationError{
					field:  "ServiceStable",
					reason: "embedded message failed validation",
...
func (m *RuntimeObject) validate(all bool) error {
	...
	if all {
		switch v := interface{}(m.GetLastTaskRun()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, RuntimeObjectValidationError{
					field:  "LastTaskRun",
	...
	} else if v, ok := interface{}(m.GetLastTaskRun()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return RuntimeObjectValidationError{
				field:  "LastTaskRun",
				reason: "embedded message failed validation",
...
// Validate checks the field values on ProtectionFailure with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *ProtectionFailure) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on ProtectionFailure with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// ProtectionFailureMultiError, or nil if none found.
func (m *ProtectionFailure) ValidateAll() error {
	return m.validate(true)
}

func (m *ProtectionFailure) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		switch v := interface{}(m.GetLinkId()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, ProtectionFailureValidationError{
					field:  "LinkId",
					reason: "embedded message failed validation",
					cause:  err,
				})
	...
	} else if v, ok := interface{}(m.GetLinkId()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return ProtectionFailureValidationError{
				field:  "LinkId",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return ProtectionFailureMultiError(errors)
	}

	return nil
}

// ProtectionFailureMultiError is an error wrapping multiple validation errors
// returned by ProtectionFailure.ValidateAll() if the designated constraints
// aren't met.
type ProtectionFailureMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m ProtectionFailureMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m ProtectionFailureMultiError) AllErrors() []error { return m }

// ProtectionFailureValidationError is the validation error returned by
// ProtectionFailure.Validate if the designated constraints aren't met.
type ProtectionFailureValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e ProtectionFailureValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ProtectionFailureValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ProtectionFailureValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ProtectionFailureValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ProtectionFailureValidationError) ErrorName() string {
	return "ProtectionFailureValidationError"
}

// Error satisfies the builtin error interface
func (e ProtectionFailureValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sProtectionFailure.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = ProtectionFailureValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = ProtectionFailureValidationError{}
...
func (m *NotificationInfo) validate(all bool) error {
	...
	for idx, item := range m.GetProtectionFailures() {
		_, _ = idx, item
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, NotificationInfoValidationError{
						field:  fmt.Sprintf("ProtectionFailures[%v]", idx),
						reason: "embedded message failed validation",
						cause:  err,
					})
				}
	...
	if all {
		switch v := interface{}(m.GetRuntimeFetchExecError()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, NotificationInfoValidationError{
					field:  "RuntimeFetchExecError",
					reason: "embedded message failed validation",
					cause:  err,
				})
			}
	...
	} else if v, ok := interface{}(m.GetRuntimeFetchExecError()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return NotificationInfoValidationError{
				field:  "RuntimeFetchExecError",
				reason: "embedded message failed validation",
	...
	if all {
		switch v := interface{}(m.GetRuntimeApplyExecError()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, NotificationInfoValidationError{
					field:  "RuntimeApplyExecError",
					reason: "embedded message failed validation",
					cause:  err,
				})
			}
	...
	} else if v, ok := interface{}(m.GetRuntimeApplyExecError()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return NotificationInfoValidationError{
				field:  "RuntimeApplyExecError",
				reason: "embedded message failed validation",
...
func (m *ControlState) validate(all bool) error {
	...
	if all {
		switch v := interface{}(m.GetDeploymentCompletedTimestamp()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, ControlStateValidationError{
					field:  "DeploymentCompletedTimestamp",
					reason: "embedded message failed validation",
					cause:  err,
				})
			}
	...
	} else if v, ok := interface{}(m.GetDeploymentCompletedTimestamp()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return ControlStateValidationError{
				field:  "DeploymentCompletedTimestamp",
				reason: "embedded message failed validation",
...
func (m *DeliveryExtensionState) validate(all bool) error {
	...
	if all {
		switch v := interface{}(m.GetOngoingRun()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, DeliveryExtensionStateValidationError{
					field:  "OngoingRun",
	...
	} else if v, ok := interface{}(m.GetOngoingRun()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return DeliveryExtensionStateValidationError{
				field:  "OngoingRun",
				reason: "embedded message failed validation",
...
func (m *Signal) validate(all bool) error {
	...
	case *Signal_ReleaseChannelBypass_:
		if v == nil {
			err := SignalValidationError{
				field:  "Config",
				reason: "oneof value cannot be a typed-nil",
		...
		if all {
			switch v := interface{}(m.GetReleaseChannelBypass()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, SignalValidationError{
						field:  "ReleaseChannelBypass",
						reason: "embedded message failed validation",
						cause:  err,
					})
				}
		...
		} else if v, ok := interface{}(m.GetReleaseChannelBypass()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return SignalValidationError{
					field:  "ReleaseChannelBypass",
					reason: "embedded message failed validation",
	...
	case *Signal_ForceExecuteTask_:
		...
		if all {
			switch v := interface{}(m.GetForceExecuteTask()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, SignalValidationError{
						field:  "ForceExecuteTask",
						reason: "embedded message failed validation",
						cause:  err,
					})
				}
		...
		} else if v, ok := interface{}(m.GetForceExecuteTask()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return SignalValidationError{
					field:  "ForceExecuteTask",
					reason: "embedded message failed validation",
...
// Validate checks the field values on Condition_ServiceStableCondition with
// the rules defined in the proto definition for this message. If any rules
// are violated, the first error encountered is returned, or nil if there are
// no violations.
func (m *Condition_ServiceStableCondition) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on Condition_ServiceStableCondition with
// the rules defined in the proto definition for this message. If any rules
// are violated, the result is a list of violation errors wrapped in
// Condition_ServiceStableConditionMultiError, or nil if none found.
func (m *Condition_ServiceStableCondition) ValidateAll() error {
	return m.validate(true)
}

func (m *Condition_ServiceStableCondition) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return Condition_ServiceStableConditionMultiError(errors)
	}

	return nil
}

// Condition_ServiceStableConditionMultiError is an error wrapping multiple
// validation errors returned by
// Condition_ServiceStableCondition.ValidateAll() if the designated
// constraints aren't met.
type Condition_ServiceStableConditionMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m Condition_ServiceStableConditionMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m Condition_ServiceStableConditionMultiError) AllErrors() []error { return m }

// Condition_ServiceStableConditionValidationError is the validation error
// returned by Condition_ServiceStableCondition.Validate if the designated
// constraints aren't met.
type Condition_ServiceStableConditionValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e Condition_ServiceStableConditionValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e Condition_ServiceStableConditionValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e Condition_ServiceStableConditionValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e Condition_ServiceStableConditionValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e Condition_ServiceStableConditionValidationError) ErrorName() string {
	return "Condition_ServiceStableConditionValidationError"
}

// Error satisfies the builtin error interface
func (e Condition_ServiceStableConditionValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sCondition_ServiceStableCondition.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = Condition_ServiceStableConditionValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = Condition_ServiceStableConditionValidationError{}
...
// Validate checks the field values on Signal_ReleaseChannelBypass with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
...
// ValidateAll checks the field values on Signal_ReleaseChannelBypass with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// Signal_ReleaseChannelBypassMultiError, or nil if none found.
func (m *Signal_ReleaseChannelBypass) ValidateAll() error {
	return m.validate(true)
}

func (m *Signal_ReleaseChannelBypass) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return Signal_ReleaseChannelBypassMultiError(errors)
	}

	return nil
}

// Signal_ReleaseChannelBypassMultiError is an error wrapping multiple
// validation errors returned by Signal_ReleaseChannelBypass.ValidateAll() if
// the designated constraints aren't met.
type Signal_ReleaseChannelBypassMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m Signal_ReleaseChannelBypassMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m Signal_ReleaseChannelBypassMultiError) AllErrors() []error { return m }

// Signal_ReleaseChannelBypassValidationError is the validation error returned
// by Signal_ReleaseChannelBypass.Validate if the designated constraints
// aren't met.
...
// Field function returns field value.
func (e Signal_ReleaseChannelBypassValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e Signal_ReleaseChannelBypassValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e Signal_ReleaseChannelBypassValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e Signal_ReleaseChannelBypassValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e Signal_ReleaseChannelBypassValidationError) ErrorName() string {
	return "Signal_ReleaseChannelBypassValidationError"
}

// Error satisfies the builtin error interface
func (e Signal_ReleaseChannelBypassValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sSignal_ReleaseChannelBypass.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = Signal_ReleaseChannelBypassValidationError{}
...
// Validate checks the field values on Signal_ForceExecuteTask with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *Signal_ForceExecuteTask) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on Signal_ForceExecuteTask with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// Signal_ForceExecuteTaskMultiError, or nil if none found.
func (m *Signal_ForceExecuteTask) ValidateAll() error {
	return m.validate(true)
}

func (m *Signal_ForceExecuteTask) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return Signal_ForceExecuteTaskMultiError(errors)
	}

	return nil
}

// Signal_ForceExecuteTaskMultiError is an error wrapping multiple validation
// errors returned by Signal_ForceExecuteTask.ValidateAll() if the designated
// constraints aren't met.
type Signal_ForceExecuteTaskMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m Signal_ForceExecuteTaskMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m Signal_ForceExecuteTaskMultiError) AllErrors() []error { return m }

// Signal_ForceExecuteTaskValidationError is the validation error returned by
// Signal_ForceExecuteTask.Validate if the designated constraints aren't met.
type Signal_ForceExecuteTaskValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e Signal_ForceExecuteTaskValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e Signal_ForceExecuteTaskValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e Signal_ForceExecuteTaskValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e Signal_ForceExecuteTaskValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e Signal_ForceExecuteTaskValidationError) ErrorName() string {
	return "Signal_ForceExecuteTaskValidationError"
}

// Error satisfies the builtin error interface
func (e Signal_ForceExecuteTaskValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sSignal_ForceExecuteTask.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = Signal_ForceExecuteTaskValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = Signal_ForceExecuteTaskValidationError{}
