...
var file_prodvana_desired_state_manager_proto_rawDesc = []byte{
	...
	0x65, 0x44, 0x65, 0x6c, 0x69, 0x76, 0x65, 0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x32, 0xd4, 0x0d,
	0x0a, 0x13, 0x44, 0x65, 0x73, 0x69, 0x72, 0x65, 0x64, 0x53, 0x74, 0x61, 0x74, 0x65, 0x4d, 0x61,
	0x6e, 0x61, 0x67, 0x65, 0x72, 0x12, 0x89, 0x01, 0x0a, 0x0f, 0x53, 0x65, 0x74, 0x44, 0x65, 0x73,
	...
	0x73, 0x12, 0x89, 0x02, 0x0a, 0x28, 0x47, 0x65, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	...
	0x76, 0x65, 0x72, 0x79, 0x42, 0x52, 0x5a, 0x50, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
var file_prodvana_desired_state_manager_proto_msgTypes = make([]protoimpl.MessageInfo, 29)
var file_prodvana_desired_state_manager_proto_goTypes = []interface{}{
	...
	nil,                                                  // 21: prodvana.desired_state.DesiredStateSummary.StatusesEntry
	nil,                                                  // 22: prodvana.desired_state.DesiredStateSummary.PreconditionStatusesEntry
	nil,                                                  // 23: prodvana.desired_state.DesiredStateSummary.StatusExplanationsEntry
	nil,                                                  // 24: prodvana.desired_state.DesiredStateSummary.DebugLogsEntry
	nil,                                                  // 25: prodvana.desired_state.DesiredStateSummary.ActionExplanationsEntry
	nil,                                                  // 26: prodvana.desired_state.DesiredStateSummary.LastUpdateTimestampsEntry
	nil,                                                  // 27: prodvana.desired_state.DesiredStateSummary.LastFetchedTimestampsEntry
	nil,                                                  // 28: prodvana.desired_state.DesiredStateSummary.LastAppliedTimestampsEntry
	(*model.State)(nil),                                  // 29: prodvana.desired_state.model.State
	(*service.CompiledServiceInstanceConfig)(nil), // 30: prodvana.service.CompiledServiceInstanceConfig
	(*model.StatusExplanation)(nil),               // 31: prodvana.desired_state.model.StatusExplanation
	(*model.DebugLog)(nil),                        // 32: prodvana.desired_state.model.DebugLog
	(*model.EntityGraph)(nil),                     // 33: prodvana.desired_state.model.EntityGraph
	(*timestamppb.Timestamp)(nil),                 // 34: google.protobuf.Timestamp
	(*model.ServiceInstanceState)(nil),            // 35: prodvana.desired_state.model.ServiceInstanceState
	(model.Status)(0),                             // 36: prodvana.desired_state.model.Status
	(*model.ConditionState)(nil),                  // 37: prodvana.desired_state.model.ConditionState
	(*model.ActionExplanation)(nil),               // 38: prodvana.desired_state.model.ActionExplanation
}
var file_prodvana_desired_state_manager_proto_depIdxs = []int32{
	29, // 0: prodvana.desired_state.SetDesiredStateReq.desired_state:type_name -> prodvana.desired_state.model.State
	29, // 1: prodvana.desired_state.ValidateDesiredStateReq.desired_state:type_name -> prodvana.desired_state.model.State
	30, // 2: prodvana.desired_state.ValidateDesiredStateReq.service_instance_configs:type_name -> prodvana.service.CompiledServiceInstanceConfig
	31, // 3: prodvana.desired_state.StatusExplanations.status_explanations:type_name -> prodvana.desired_state.model.StatusExplanation
	32, // 4: prodvana.desired_state.DebugLogs.debug_logs:type_name -> prodvana.desired_state.model.DebugLog
	33, // 5: prodvana.desired_state.DesiredStateSummary.entity_graph:type_name -> prodvana.desired_state.model.EntityGraph
	29, // 6: prodvana.desired_state.DesiredStateSummary.starting_state:type_name -> prodvana.desired_state.model.State
	29, // 7: prodvana.desired_state.DesiredStateSummary.last_seen_state:type_name -> prodvana.desired_state.model.State
	29, // 8: prodvana.desired_state.DesiredStateSummary.desired_state:type_name -> prodvana.desired_state.model.State
	21, // 9: prodvana.desired_state.DesiredStateSummary.statuses:type_name -> prodvana.desired_state.DesiredStateSummary.StatusesEntry
	34, // 10: prodvana.desired_state.DesiredStateSummary.creation_timestamp:type_name -> google.protobuf.Timestamp
	34, // 11: prodvana.desired_state.DesiredStateSummary.last_update_timestamp:type_name -> google.protobuf.Timestamp
	34, // 12: prodvana.desired_state.DesiredStateSummary.replaced_timestamp:type_name -> google.protobuf.Timestamp
	22, // 13: prodvana.desired_state.DesiredStateSummary.precondition_statuses:type_name -> prodvana.desired_state.DesiredStateSummary.PreconditionStatusesEntry
	23, // 14: prodvana.desired_state.DesiredStateSummary.status_explanations:type_name -> prodvana.desired_state.DesiredStateSummary.StatusExplanationsEntry
	24, // 15: prodvana.desired_state.DesiredStateSummary.debug_logs:type_name -> prodvana.desired_state.DesiredStateSummary.DebugLogsEntry
	25, // 16: prodvana.desired_state.DesiredStateSummary.action_explanations:type_name -> prodvana.desired_state.DesiredStateSummary.ActionExplanationsEntry
	26, // 17: prodvana.desired_state.DesiredStateSummary.last_update_timestamps:type_name -> prodvana.desired_state.DesiredStateSummary.LastUpdateTimestampsEntry
	27, // 18: prodvana.desired_state.DesiredStateSummary.last_fetched_timestamps:type_name -> prodvana.desired_state.DesiredStateSummary.LastFetchedTimestampsEntry
	28, // 19: prodvana.desired_state.DesiredStateSummary.last_applied_timestamps:type_name -> prodvana.desired_state.DesiredStateSummary.LastAppliedTimestampsEntry
	...
	35, // 22: prodvana.desired_state.GetServiceLastConvergedStateResp.service_instance_states:type_name -> prodvana.desired_state.model.ServiceInstanceState
	...
	29, // 24: prodvana.desired_state.GetDesiredStateResp.desired_state:type_name -> prodvana.desired_state.model.State
	29, // 25: prodvana.desired_state.GetDesiredStateResp.compiled_desired_state:type_name -> prodvana.desired_state.model.State
	29, // 26: prodvana.desired_state.ValidateDesiredStateResp.desired_state:type_name -> prodvana.desired_state.model.State
	29, // 27: prodvana.desired_state.ValidateDesiredStateResp.compiled_desired_state:type_name -> prodvana.desired_state.model.State
	36, // 28: prodvana.desired_state.DesiredStateSummary.StatusesEntry.value:type_name -> prodvana.desired_state.model.Status
	37, // 29: prodvana.desired_state.DesiredStateSummary.PreconditionStatusesEntry.value:type_name -> prodvana.desired_state.model.ConditionState
	...
	38, // 32: prodvana.desired_state.DesiredStateSummary.ActionExplanationsEntry.value:type_name -> prodvana.desired_state.model.ActionExplanation
	34, // 33: prodvana.desired_state.DesiredStateSummary.LastUpdateTimestampsEntry.value:type_name -> google.protobuf.Timestamp
	34, // 34: prodvana.desired_state.DesiredStateSummary.LastFetchedTimestampsEntry.value:type_name -> google.protobuf.Timestamp
	34, // 35: prodvana.desired_state.DesiredStateSummary.LastAppliedTimestampsEntry.value:type_name -> google.protobuf.Timestamp
	...
	2,  // 45: prodvana.desired_state.DesiredStateManager.SetDesiredState:output_type -> prodvana.desired_state.SetDesiredStateResp
	9,  // 46: prodvana.desired_state.DesiredStateManager.GetServiceDesiredStateConvergenceSummary:output_type -> prodvana.desired_state.GetServiceDesiredStateConvergenceSummaryResp
	11, // 47: prodvana.desired_state.DesiredStateManager.GetServiceLastConvergedStates:output_type -> prodvana.desired_state.GetServiceLastConvergedStateResp
	13, // 48: prodvana.desired_state.DesiredStateManager.GetServiceDesiredStateHistory:output_type -> prodvana.desired_state.GetServiceDesiredStateHistoryResp
	15, // 49: prodvana.desired_state.DesiredStateManager.GetDesiredState:output_type -> prodvana.desired_state.GetDesiredStateResp
	8,  // 50: prodvana.desired_state.DesiredStateManager.GetDesiredStateConvergenceSummary:output_type -> prodvana.desired_state.GetDesiredStateConvergenceSummaryResp
	16, // 51: prodvana.desired_state.DesiredStateManager.ValidateDesiredState:output_type -> prodvana.desired_state.ValidateDesiredStateResp
	18, // 52: prodvana.desired_state.DesiredStateManager.SetManualApproval:output_type -> prodvana.desired_state.SetManualApprovalResp
	20, // 53: prodvana.desired_state.DesiredStateManager.PromoteDelivery:output_type -> prodvana.desired_state.PromoteDeliveryResp
