...
var file_prodvana_desired_state_manager_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x64, 0x53, 0x74, 0x61, 0x74, 0x65, 0x22, 0xca, 0x06, 0x0a, 0x17, 0x47, 0x65, 0x74,
	...
	0xa1, 0x13, 0x0a, 0x13, 0x44, 0x65, 0x73, 0x69, 0x72, 0x65, 0x64, 0x53, 0x74, 0x61, 0x74, 0x65,
	...
	0x64, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x5f, 0x69, 0x64, 0x12, 0xe0, 0x01, 0x0a, 0x1d, 0x47,
...
var file_prodvana_desired_state_manager_proto_msgTypes = make([]protoimpl.MessageInfo, 40)
var file_prodvana_desired_state_manager_proto_goTypes = []interface{}{
	...
	(*GetDesiredStateGraphReq_DepthOverrideByStatus)(nil), // 39: prodvana.desired_state.GetDesiredStateGraphReq.DepthOverrideByStatus
	(*model.State)(nil),                           // 40: prodvana.desired_state.model.State
	(version.Source)(0),                           // 41: prodvana.version.Source
	(*version.SourceMetadata)(nil),                // 42: prodvana.version.SourceMetadata
	(*service.CompiledServiceInstanceConfig)(nil), // 43: prodvana.service.CompiledServiceInstanceConfig
	(*model.EntityGraph)(nil),                     // 44: prodvana.desired_state.model.EntityGraph
	(*model.StatusExplanation)(nil),               // 45: prodvana.desired_state.model.StatusExplanation
	(*model.DebugLog)(nil),                        // 46: prodvana.desired_state.model.DebugLog
	(async_task.TaskStatus)(0),                    // 47: prodvana.async_task.TaskStatus
	(*async_task.TaskResult)(nil),                 // 48: prodvana.async_task.TaskResult
	(*timestamppb.Timestamp)(nil),                 // 49: google.protobuf.Timestamp
	(model.Status)(0),                             // 50: prodvana.desired_state.model.Status
	(*model.ServiceInstanceState)(nil),            // 51: prodvana.desired_state.model.ServiceInstanceState
	(model.Type)(0),                               // 52: prodvana.desired_state.model.Type
	(*model.Annotations)(nil),                     // 53: prodvana.desired_state.model.Annotations
	(*model.ConditionState)(nil),                  // 54: prodvana.desired_state.model.ConditionState
	(*model.ActionExplanation)(nil),               // 55: prodvana.desired_state.model.ActionExplanation
}
var file_prodvana_desired_state_manager_proto_depIdxs = []int32{
	40, // 0: prodvana.desired_state.SetDesiredStateReq.desired_state:type_name -> prodvana.desired_state.model.State
	41, // 1: prodvana.desired_state.SetDesiredStateReq.source:type_name -> prodvana.version.Source
	42, // 2: prodvana.desired_state.SetDesiredStateReq.source_metadata:type_name -> prodvana.version.SourceMetadata
	40, // 3: prodvana.desired_state.ValidateDesiredStateReq.desired_state:type_name -> prodvana.desired_state.model.State
	43, // 4: prodvana.desired_state.ValidateDesiredStateReq.service_instance_configs:type_name -> prodvana.service.CompiledServiceInstanceConfig
	44, // 5: prodvana.desired_state.PreviewEntityGraphResp.entity_graph:type_name -> prodvana.desired_state.model.EntityGraph
	45, // 6: prodvana.desired_state.StatusExplanations.status_explanations:type_name -> prodvana.desired_state.model.StatusExplanation
	46, // 7: prodvana.desired_state.DebugLogs.debug_logs:type_name -> prodvana.desired_state.model.DebugLog
	40, // 8: prodvana.desired_state.PendingSetDesiredState.compiled_desired_state:type_name -> prodvana.desired_state.model.State
	47, // 9: prodvana.desired_state.PendingSetDesiredState.task_status:type_name -> prodvana.async_task.TaskStatus
	48, // 10: prodvana.desired_state.PendingSetDesiredState.task_result:type_name -> prodvana.async_task.TaskResult
	44, // 11: prodvana.desired_state.DesiredStateSummary.entity_graph:type_name -> prodvana.desired_state.model.EntityGraph
	49, // 12: prodvana.desired_state.DesiredStateSummary.creation_timestamp:type_name -> google.protobuf.Timestamp
	49, // 13: prodvana.desired_state.DesiredStateSummary.last_update_timestamp:type_name -> google.protobuf.Timestamp
	49, // 14: prodvana.desired_state.DesiredStateSummary.replaced_timestamp:type_name -> google.protobuf.Timestamp
	40, // 15: prodvana.desired_state.DesiredStateSummary.input_desired_state:type_name -> prodvana.desired_state.model.State
	40, // 16: prodvana.desired_state.DesiredStateSummary.desired_state:type_name -> prodvana.desired_state.model.State
	40, // 17: prodvana.desired_state.DesiredStateSummary.starting_state:type_name -> prodvana.desired_state.model.State
	40, // 18: prodvana.desired_state.DesiredStateSummary.last_seen_state:type_name -> prodvana.desired_state.model.State
	50, // 19: prodvana.desired_state.DesiredStateSummary.status:type_name -> prodvana.desired_state.model.Status
	41, // 20: prodvana.desired_state.DesiredStateSummary.source:type_name -> prodvana.version.Source
	42, // 21: prodvana.desired_state.DesiredStateSummary.source_metadata:type_name -> prodvana.version.SourceMetadata
	...
	51, // 33: prodvana.desired_state.GetServiceLastConvergedStateResp.service_instance_states:type_name -> prodvana.desired_state.model.ServiceInstanceState
	...
	40, // 35: prodvana.desired_state.GetDesiredStateResp.desired_state:type_name -> prodvana.desired_state.model.State
	40, // 36: prodvana.desired_state.GetDesiredStateResp.compiled_desired_state:type_name -> prodvana.desired_state.model.State
	...
	52, // 38: prodvana.desired_state.GetDesiredStateGraphReq.types:type_name -> prodvana.desired_state.model.Type
	53, // 39: prodvana.desired_state.GetDesiredStateGraphReq.required_annotations:type_name -> prodvana.desired_state.model.Annotations
	39, // 40: prodvana.desired_state.GetDesiredStateGraphReq.depth_overrides_by_status:type_name -> prodvana.desired_state.GetDesiredStateGraphReq.DepthOverrideByStatus
	49, // 41: prodvana.desired_state.DesiredStateTimestamps.creation_timestamp:type_name -> google.protobuf.Timestamp
	49, // 42: prodvana.desired_state.DesiredStateTimestamps.last_update_timestamp:type_name -> google.protobuf.Timestamp
	49, // 43: prodvana.desired_state.DesiredStateTimestamps.replaced_timestamp:type_name -> google.protobuf.Timestamp
	44, // 44: prodvana.desired_state.GetDesiredStateGraphResp.entity_graph:type_name -> prodvana.desired_state.model.EntityGraph
	7,  // 45: prodvana.desired_state.GetDesiredStateGraphResp.pending_set_desired_state:type_name -> prodvana.desired_state.PendingSetDesiredState
	19, // 46: prodvana.desired_state.GetDesiredStateGraphResp.timestamps:type_name -> prodvana.desired_state.DesiredStateTimestamps
	7,  // 47: prodvana.desired_state.GetServiceLatestDesiredStateIdResp.pending_set_desired_state:type_name -> prodvana.desired_state.PendingSetDesiredState
	40, // 48: prodvana.desired_state.ValidateDesiredStateResp.desired_state:type_name -> prodvana.desired_state.model.State
	40, // 49: prodvana.desired_state.ValidateDesiredStateResp.compiled_desired_state:type_name -> prodvana.desired_state.model.State
	50, // 50: prodvana.desired_state.DesiredStateSummary.StatusesEntry.value:type_name -> prodvana.desired_state.model.Status
	54, // 51: prodvana.desired_state.DesiredStateSummary.PreconditionStatusesEntry.value:type_name -> prodvana.desired_state.model.ConditionState
	5,  // 52: prodvana.desired_state.DesiredStateSummary.StatusExplanationsEntry.value:type_name -> prodvana.desired_state.StatusExplanations
	6,  // 53: prodvana.desired_state.DesiredStateSummary.DebugLogsEntry.value:type_name -> prodvana.desired_state.DebugLogs
	55, // 54: prodvana.desired_state.DesiredStateSummary.ActionExplanationsEntry.value:type_name -> prodvana.desired_state.model.ActionExplanation
	49, // 55: prodvana.desired_state.DesiredStateSummary.LastUpdateTimestampsEntry.value:type_name -> google.protobuf.Timestamp
	49, // 56: prodvana.desired_state.DesiredStateSummary.LastFetchedTimestampsEntry.value:type_name -> google.protobuf.Timestamp
	49, // 57: prodvana.desired_state.DesiredStateSummary.LastAppliedTimestampsEntry.value:type_name -> google.protobuf.Timestamp
	50, // 58: prodvana.desired_state.GetDesiredStateGraphReq.DepthOverrideByStatus.status:type_name -> prodvana.desired_state.model.Status
	0,  // 59: prodvana.desired_state.DesiredStateManager.SetDesiredState:input_type -> prodvana.desired_state.SetDesiredStateReq
	0,  // 60: prodvana.desired_state.DesiredStateManager.PreviewEntityGraph:input_type -> prodvana.desired_state.SetDesiredStateReq
	4,  // 61: prodvana.desired_state.DesiredStateManager.GetServiceDesiredStateConvergenceSummary:input_type -> prodvana.desired_state.GetServiceDesiredStateConvergenceSummaryReq
	21, // 62: prodvana.desired_state.DesiredStateManager.GetServiceLatestDesiredStateId:input_type -> prodvana.desired_state.GetServiceLatestDesiredStateIdReq
	12, // 63: prodvana.desired_state.DesiredStateManager.GetServiceLastConvergedStates:input_type -> prodvana.desired_state.GetServiceLastConvergedStateReq
	14, // 64: prodvana.desired_state.DesiredStateManager.GetServiceDesiredStateHistory:input_type -> prodvana.desired_state.GetServiceDesiredStateHistoryReq
	16, // 65: prodvana.desired_state.DesiredStateManager.GetDesiredState:input_type -> prodvana.desired_state.GetDesiredStateReq
	18, // 66: prodvana.desired_state.DesiredStateManager.GetDesiredStateGraph:input_type -> prodvana.desired_state.GetDesiredStateGraphReq
	9,  // 67: prodvana.desired_state.DesiredStateManager.GetDesiredStateConvergenceSummary:input_type -> prodvana.desired_state.GetDesiredStateConvergenceReq
	1,  // 68: prodvana.desired_state.DesiredStateManager.ValidateDesiredState:input_type -> prodvana.desired_state.ValidateDesiredStateReq
	24, // 69: prodvana.desired_state.DesiredStateManager.SetManualApproval:input_type -> prodvana.desired_state.SetManualApprovalReq
	26, // 70: prodvana.desired_state.DesiredStateManager.PromoteDelivery:input_type -> prodvana.desired_state.PromoteDeliveryReq
	28, // 71: prodvana.desired_state.DesiredStateManager.BypassProtection:input_type -> prodvana.desired_state.BypassProtectionReq
	2,  // 72: prodvana.desired_state.DesiredStateManager.SetDesiredState:output_type -> prodvana.desired_state.SetDesiredStateResp
	3,  // 73: prodvana.desired_state.DesiredStateManager.PreviewEntityGraph:output_type -> prodvana.desired_state.PreviewEntityGraphResp
	11, // 74: prodvana.desired_state.DesiredStateManager.GetServiceDesiredStateConvergenceSummary:output_type -> prodvana.desired_state.GetServiceDesiredStateConvergenceSummaryResp
	22, // 75: prodvana.desired_state.DesiredStateManager.GetServiceLatestDesiredStateId:output_type -> prodvana.desired_state.GetServiceLatestDesiredStateIdResp
	13, // 76: prodvana.desired_state.DesiredStateManager.GetServiceLastConvergedStates:output_type -> prodvana.desired_state.GetServiceLastConvergedStateResp
	15, // 77: prodvana.desired_state.DesiredStateManager.GetServiceDesiredStateHistory:output_type -> prodvana.desired_state.GetServiceDesiredStateHistoryResp
	17, // 78: prodvana.desired_state.DesiredStateManager.GetDesiredState:output_type -> prodvana.desired_state.GetDesiredStateResp
	20, // 79: prodvana.desired_state.DesiredStateManager.GetDesiredStateGraph:output_type -> prodvana.desired_state.GetDesiredStateGraphResp
	10, // 80: prodvana.desired_state.DesiredStateManager.GetDesiredStateConvergenceSummary:output_type -> prodvana.desired_state.GetDesiredStateConvergenceSummaryResp
	23, // 81: prodvana.desired_state.DesiredStateManager.ValidateDesiredState:output_type -> prodvana.desired_state.ValidateDesiredStateResp
	25, // 82: prodvana.desired_state.DesiredStateManager.SetManualApproval:output_type -> prodvana.desired_state.SetManualApprovalResp
	27, // 83: prodvana.desired_state.DesiredStateManager.PromoteDelivery:output_type -> prodvana.desired_state.PromoteDeliveryResp
	29, // 84: prodvana.desired_state.DesiredStateManager.BypassProtection:output_type -> prodvana.desired_state.BypassProtectionResp
