...
var file_prodvana_desired_state_manager_proto_rawDesc = []byte{
	...
	0x73, 0x70, 0x32, 0x81, 0x11, 0x0a, 0x13, 0x44, 0x65, 0x73, 0x69, 0x72, 0x65, 0x64, 0x53, 0x74,
	...
	0x3d, 0x2a, 0x7d, 0x2f, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x12, 0xa1, 0x01, 0x0a, 0x14, 0x56,
	...
	0x6c, 0x69, 0x76, 0x65, 0x72, 0x79, 0x42, 0x52, 0x5a, 0x50, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_prodvana_desired_state_manager_proto_depIdxs = []int32{
	...
	1,  // 36: prodvana.desired_state.DesiredStateManager.ValidateDesiredState:input_type -> prodvana.desired_state.ValidateDesiredStateReq
	20, // 37: prodvana.desired_state.DesiredStateManager.SetManualApproval:input_type -> prodvana.desired_state.SetManualApprovalReq
	22, // 38: prodvana.desired_state.DesiredStateManager.PromoteDelivery:input_type -> prodvana.desired_state.PromoteDeliveryReq
	2,  // 39: prodvana.desired_state.DesiredStateManager.SetDesiredState:output_type -> prodvana.desired_state.SetDesiredStateResp
	12, // 40: prodvana.desired_state.DesiredStateManager.GetServiceDesiredStateConvergenceSummary:output_type -> prodvana.desired_state.GetServiceDesiredStateConvergenceSummaryResp
	14, // 41: prodvana.desired_state.DesiredStateManager.GetServiceLastConvergedStates:output_type -> prodvana.desired_state.GetServiceLastConvergedStateResp
	16, // 42: prodvana.desired_state.DesiredStateManager.GetServiceDesiredStateHistory:output_type -> prodvana.desired_state.GetServiceDesiredStateHistoryResp
	18, // 43: prodvana.desired_state.DesiredStateManager.GetDesiredState:output_type -> prodvana.desired_state.GetDesiredStateResp
	10, // 44: prodvana.desired_state.DesiredStateManager.GetDesiredStateConvergenceSummary:output_type -> prodvana.desired_state.GetDesiredStateConvergenceSummaryResp
	11, // 45: prodvana.desired_state.DesiredStateManager.GetDesiredStateConvergenceDetails:output_type -> prodvana.desired_state.GetDesiredStateConvergenceDetailsResp
	9,  // 46: prodvana.desired_state.DesiredStateManager.GetDesiredStateConvergenceEvents:output_type -> prodvana.desired_state.GetDesiredStateConvergenceEventsResp
	19, // 47: prodvana.desired_state.DesiredStateManager.ValidateDesiredState:output_type -> prodvana.desired_state.ValidateDesiredStateResp
	21, // 48: prodvana.desired_state.DesiredStateManager.SetManualApproval:output_type -> prodvana.desired_state.SetManualApprovalResp
	23, // 49: prodvana.desired_state.DesiredStateManager.PromoteDelivery:output_type -> prodvana.desired_state.PromoteDeliveryResp
