...
func request_DesiredStateManager_GetDesiredStateConvergenceDetails_0(ctx context.Context, marshaler runtime.Marshaler, client DesiredStateManagerClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetDesiredStateConvergenceReq
	var metadata runtime.ServerMetadata
	...
	msg, err := client.GetDesiredStateConvergenceDetails(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_DesiredStateManager_GetDesiredStateConvergenceDetails_0(ctx context.Context, marshaler runtime.Marshaler, server DesiredStateManagerServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetDesiredStateConvergenceReq
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetDesiredStateConvergenceDetails(ctx, &protoReq)
	return msg, metadata, err

}

var (
	filter_DesiredStateManager_GetDesiredStateConvergenceEvents_0 = &utilities.DoubleArray{Encoding: map[string]int{"desired_state_id": 0, "desiredStateId": 1}, Base: []int{1, 1, 2, 0, 0}, Check: []int{0, 1, 1, 2, 3}}
)

func request_DesiredStateManager_GetDesiredStateConvergenceEvents_0(ctx context.Context, marshaler runtime.Marshaler, client DesiredStateManagerClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_DesiredStateManager_GetDesiredStateConvergenceEvents_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := client.GetDesiredStateConvergenceEvents(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_DesiredStateManager_GetDesiredStateConvergenceEvents_0(ctx context.Context, marshaler runtime.Marshaler, server DesiredStateManagerServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetDesiredStateConvergenceEventsReq
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetDesiredStateConvergenceEvents(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterDesiredStateManagerHandlerServer(ctx context.Context, mux *runtime.ServeMux, server DesiredStateManagerServer) error {
	...
	mux.Handle("GET", pattern_DesiredStateManager_GetDesiredStateConvergenceDetails_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/prodvana.desired_state.DesiredStateManager/GetDesiredStateConvergenceDetails", runtime.WithHTTPPathPattern("/v1/desired_states/{desired_state_id=*}/details"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_DesiredStateManager_GetDesiredStateConvergenceDetails_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_DesiredStateManager_GetDesiredStateConvergenceDetails_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("GET", pattern_DesiredStateManager_GetDesiredStateConvergenceEvents_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/prodvana.desired_state.DesiredStateManager/GetDesiredStateConvergenceEvents", runtime.WithHTTPPathPattern("/v1/desired_states/{desired_state_id=*}/events"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_DesiredStateManager_GetDesiredStateConvergenceEvents_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_DesiredStateManager_GetDesiredStateConvergenceEvents_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterDesiredStateManagerHandlerClient(ctx context.Context, mux *runtime.ServeMux, client DesiredStateManagerClient) error {
	...
	mux.Handle("GET", pattern_DesiredStateManager_GetDesiredStateConvergenceDetails_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/prodvana.desired_state.DesiredStateManager/GetDesiredStateConvergenceDetails", runtime.WithHTTPPathPattern("/v1/desired_states/{desired_state_id=*}/details"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_DesiredStateManager_GetDesiredStateConvergenceDetails_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_DesiredStateManager_GetDesiredStateConvergenceEvents_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/prodvana.desired_state.DesiredStateManager/GetDesiredStateConvergenceEvents", runtime.WithHTTPPathPattern("/v1/desired_states/{desired_state_id=*}/events"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_DesiredStateManager_GetDesiredStateConvergenceEvents_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_DesiredStateManager_GetDesiredStateConvergenceDetails_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"v1", "desired_states", "desired_state_id", "details"}, ""))
