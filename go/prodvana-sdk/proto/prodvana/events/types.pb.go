...
var file_prodvana_events_types_proto_rawDesc = []byte{
	...
	0x22, 0xef, 0x07, 0x0a, 0x0c, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c,
	...
	0x6e, 0x42, 0x09, 0x0a, 0x07, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x4a, 0x04, 0x08, 0x05,
	0x10, 0x06, 0x2a, 0xab, 0x02, 0x0a, 0x09, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65,
	...
	0x44, 0x45, 0x43, 0x49, 0x53, 0x49, 0x4f, 0x4e, 0x10, 0x0c, 0x22, 0x04, 0x08, 0x05, 0x10, 0x05,
...
var file_prodvana_events_types_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
var file_prodvana_events_types_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_prodvana_events_types_proto_goTypes = []interface{}{
	...
	(*SetDesiredStateEvent)(nil),           // 5: prodvana.events.SetDesiredStateEvent
	(*SetTargetStateEvent)(nil),            // 6: prodvana.events.SetTargetStateEvent
	(*ApplyTargetStateEvent)(nil),          // 7: prodvana.events.ApplyTargetStateEvent
	(*ProgramExitEvent)(nil),               // 8: prodvana.events.ProgramExitEvent
	(*DeliveryProgressEvent)(nil),          // 9: prodvana.events.DeliveryProgressEvent
	(*DeliveryManualPromotionEvent)(nil),   // 10: prodvana.events.DeliveryManualPromotionEvent
	(*ManualApprovalEvent)(nil),            // 11: prodvana.events.ManualApprovalEvent
	(*CustomTaskExecutionEvent)(nil),       // 12: prodvana.events.CustomTaskExecutionEvent
	...
	(*EventDetails)(nil),                   // 17: prodvana.events.EventDetails
	(*model.Identifier)(nil),               // 18: prodvana.desired_state.model.Identifier
	(*model.State)(nil),                    // 19: prodvana.desired_state.model.State
	(model.Status)(0),                      // 20: prodvana.desired_state.model.Status
	(*model.StatusExplanation)(nil),        // 21: prodvana.desired_state.model.StatusExplanation
	(*model.DeliveryState)(nil),            // 22: prodvana.desired_state.model.DeliveryState
	(model.ManualApprovalStatus)(0),        // 23: prodvana.desired_state.model.ManualApprovalStatus
}
var file_prodvana_events_types_proto_depIdxs = []int32{
	18, // 0: prodvana.events.SetDesiredStateEvent.id:type_name -> prodvana.desired_state.model.Identifier
	19, // 1: prodvana.events.SetDesiredStateEvent.desired:type_name -> prodvana.desired_state.model.State
	18, // 2: prodvana.events.SetTargetStateEvent.id:type_name -> prodvana.desired_state.model.Identifier
	19, // 3: prodvana.events.SetTargetStateEvent.target:type_name -> prodvana.desired_state.model.State
	19, // 4: prodvana.events.SetTargetStateEvent.desired:type_name -> prodvana.desired_state.model.State
	19, // 5: prodvana.events.SetTargetStateEvent.current:type_name -> prodvana.desired_state.model.State
	20, // 6: prodvana.events.SetTargetStateEvent.status:type_name -> prodvana.desired_state.model.Status
	21, // 7: prodvana.events.SetTargetStateEvent.status_explanations:type_name -> prodvana.desired_state.model.StatusExplanation
	18, // 8: prodvana.events.ApplyTargetStateEvent.id:type_name -> prodvana.desired_state.model.Identifier
	19, // 9: prodvana.events.ApplyTargetStateEvent.target:type_name -> prodvana.desired_state.model.State
	19, // 10: prodvana.events.ApplyTargetStateEvent.current:type_name -> prodvana.desired_state.model.State
	1,  // 11: prodvana.events.ApplyTargetStateEvent.result:type_name -> prodvana.events.ApplyTargetStateEvent.ApplyResult
	22, // 12: prodvana.events.DeliveryProgressEvent.state:type_name -> prodvana.desired_state.model.DeliveryState
	22, // 13: prodvana.events.DeliveryManualPromotionEvent.state:type_name -> prodvana.desired_state.model.DeliveryState
	23, // 14: prodvana.events.ManualApprovalEvent.status:type_name -> prodvana.desired_state.model.ManualApprovalStatus
	2,  // 15: prodvana.events.RuntimeUpdateEvent.action:type_name -> prodvana.events.RuntimeUpdateEvent.RuntimeAction
	13, // 16: prodvana.events.RuntimeUpdateEvent.object:type_name -> prodvana.events.RuntimeObject
	3,  // 17: prodvana.events.RuntimeUpdateEvent.status:type_name -> prodvana.events.RuntimeUpdateEvent.RuntimeStatus
	18, // 18: prodvana.events.DesiredStateStatusChangeEvent.id:type_name -> prodvana.desired_state.model.Identifier
	20, // 19: prodvana.events.DesiredStateStatusChangeEvent.old_status:type_name -> prodvana.desired_state.model.Status
	20, // 20: prodvana.events.DesiredStateStatusChangeEvent.new_status:type_name -> prodvana.desired_state.model.Status
	19, // 21: prodvana.events.DesiredStateStatusChangeEvent.desired:type_name -> prodvana.desired_state.model.State
	19, // 22: prodvana.events.DesiredStateStatusChangeEvent.target:type_name -> prodvana.desired_state.model.State
	19, // 23: prodvana.events.DesiredStateStatusChangeEvent.old_state:type_name -> prodvana.desired_state.model.State
	19, // 24: prodvana.events.DesiredStateStatusChangeEvent.new_state:type_name -> prodvana.desired_state.model.State
	21, // 25: prodvana.events.DesiredStateStatusChangeEvent.status_explanations:type_name -> prodvana.desired_state.model.StatusExplanation
	18, // 26: prodvana.events.KeyDeliveryDecisionEvent.id:type_name -> prodvana.desired_state.model.Identifier
	4,  // 27: prodvana.events.KeyDeliveryDecisionEvent.decision:type_name -> prodvana.events.KeyDeliveryDecisionEvent.Decision
	20, // 28: prodvana.events.KeyDeliveryDecisionEvent.status:type_name -> prodvana.desired_state.model.Status
	19, // 29: prodvana.events.KeyDeliveryDecisionEvent.desired:type_name -> prodvana.desired_state.model.State
	19, // 30: prodvana.events.KeyDeliveryDecisionEvent.target:type_name -> prodvana.desired_state.model.State
	19, // 31: prodvana.events.KeyDeliveryDecisionEvent.current:type_name -> prodvana.desired_state.model.State
	21, // 32: prodvana.events.KeyDeliveryDecisionEvent.status_explanations:type_name -> prodvana.desired_state.model.StatusExplanation
	5,  // 33: prodvana.events.EventDetails.set_desired_state:type_name -> prodvana.events.SetDesiredStateEvent
	6,  // 34: prodvana.events.EventDetails.set_target_state:type_name -> prodvana.events.SetTargetStateEvent
	8,  // 35: prodvana.events.EventDetails.program_exit:type_name -> prodvana.events.ProgramExitEvent
	7,  // 36: prodvana.events.EventDetails.apply_target_state:type_name -> prodvana.events.ApplyTargetStateEvent
	11, // 37: prodvana.events.EventDetails.manual_approval:type_name -> prodvana.events.ManualApprovalEvent
	12, // 38: prodvana.events.EventDetails.custom_task_execution:type_name -> prodvana.events.CustomTaskExecutionEvent
	14, // 39: prodvana.events.EventDetails.runtime_update:type_name -> prodvana.events.RuntimeUpdateEvent
	9,  // 40: prodvana.events.EventDetails.delivery_progress:type_name -> prodvana.events.DeliveryProgressEvent
	10, // 41: prodvana.events.EventDetails.delivery_promotion:type_name -> prodvana.events.DeliveryManualPromotionEvent
	15, // 42: prodvana.events.EventDetails.desired_state_status_change:type_name -> prodvana.events.DesiredStateStatusChangeEvent
	16, // 43: prodvana.events.EventDetails.key_delivery_decision:type_name -> prodvana.events.KeyDeliveryDecisionEvent
...
func file_prodvana_events_types_proto_init() {
	...
	file_prodvana_events_types_proto_msgTypes[12].OneofWrappers = []interface{}{
