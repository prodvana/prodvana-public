...
var file_prodvana_release_channel_object_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x15, 0x0a, 0x13, 0x52, 0x65, 0x6c, 0x65, 0x61, 0x73, 0x65, 0x43,
	0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x53, 0x74, 0x61, 0x74, 0x65, 0x22, 0xce, 0x01, 0x0a, 0x0e,
	0x52, 0x65, 0x6c, 0x65, 0x61, 0x73, 0x65, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x12, 0x2f,
	...
	0x06, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x43, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65,
	...
	0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x42, 0x54, 0x5a, 0x52,
...
var file_prodvana_release_channel_object_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_prodvana_release_channel_object_proto_goTypes = []interface{}{
	(*ReleaseChannelState)(nil),  // 0: prodvana.release_channel.ReleaseChannelState
	(*ReleaseChannel)(nil),       // 1: prodvana.release_channel.ReleaseChannel
	(*object.ObjectMeta)(nil),    // 2: prodvana.object.ObjectMeta
	(*ReleaseChannelConfig)(nil), // 3: prodvana.release_channel.ReleaseChannelConfig
}
var file_prodvana_release_channel_object_proto_depIdxs = []int32{
	2, // 0: prodvana.release_channel.ReleaseChannel.meta:type_name -> prodvana.object.ObjectMeta
	3, // 1: prodvana.release_channel.ReleaseChannel.config:type_name -> prodvana.release_channel.ReleaseChannelConfig
	0, // 2: prodvana.release_channel.ReleaseChannel.state:type_name -> prodvana.release_channel.ReleaseChannelState
