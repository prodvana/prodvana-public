...
import (
	...
	"prodvana/cmd/pvnctl/cmd/apitokens"
	"prodvana/cmd/pvnctl/cmd/applications"
	"prodvana/cmd/pvnctl/cmd/auth"
	"prodvana/cmd/pvnctl/cmd/blobs"
	"prodvana/cmd/pvnctl/cmd/configs"
	"prodvana/cmd/pvnctl/cmd/deployments"
	"prodvana/cmd/pvnctl/cmd/desiredstates"
	"prodvana/cmd/pvnctl/cmd/healthcheck"
	"prodvana/cmd/pvnctl/cmd/integration"
	"prodvana/cmd/pvnctl/cmd/labels"
	"prodvana/cmd/pvnctl/cmd/organizations"
	"prodvana/cmd/pvnctl/cmd/preflight"
	"prodvana/cmd/pvnctl/cmd/protections"
	"prodvana/cmd/pvnctl/cmd/releasechannels"
	"prodvana/cmd/pvnctl/cmd/runtimes"
	"prodvana/cmd/pvnctl/cmd/secrets"
